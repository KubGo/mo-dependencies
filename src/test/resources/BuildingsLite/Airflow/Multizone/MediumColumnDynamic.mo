...
model MediumColumnDynamic
  ...
  extends BuildingsLite.Fluid.Interfaces.LumpedVolumeDeclarations(
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume vol(
    final nPorts=2,
    redeclare final package Medium = Medium,
  ...
  MediumColumn colTop(
    redeclare final package Medium = Medium,
    final densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromBottom,
    h=h/2)
  ...
  MediumColumn colBot(
    redeclare final package Medium = Medium,
    final densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop,
    h=h/2)
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.MediumColumn\">
BuildingsLite.Airflow.Multizone.MediumColumn</a> instead of this model.
</p>
...
<a href=\"modelica://BuildingsLite.Fluid.Interfaces.LumpedVolumeDeclarations\">
BuildingsLite.Fluid.Interfaces.LumpedVolumeDeclarations</a>.
</li>
