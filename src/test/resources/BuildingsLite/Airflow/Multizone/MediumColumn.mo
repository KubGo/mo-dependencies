within BuildingsLite.Airflow.Multizone;
model MediumColumn
  ...
  replaceable package Medium =
    Modelica.Media.Interfaces.PartialMedium "Medium in the component"
      annotation (choices(
        choice(redeclare package Medium = BuildingsLite.Media.Air "Moist air")));

  parameter Modelica.Units.SI.Length h(min=0) = 3 "Height of shaft";
  parameter BuildingsLite.Airflow.Multizone.Types.densitySelection densitySelection
...
initial equation
  ...
  assert(densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop
     or densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.fromBottom
     or densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.actual,
...
equation
  ...
  if (densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop) then
      Xi = inStream(port_a.Xi_outflow);
      rho = BuildingsLite.Utilities.Psychrometrics.Functions.density_pTX(
        p=Medium.p_default,
        T=Medium.temperature(Medium.setState_phX(port_a.p, inStream(port_a.h_outflow), Xi)),
        X_w=if Medium.nXi == 0 then 0 else Xi[1]);
  elseif (densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.fromBottom) then
  ...
  annotation (
    Icon(graphics={
        ...
        Rectangle(
          visible=densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop,
          extent={{-16,80},{16,0}},
        ...
        Text(
          ...
          textString="%name"),
        Rectangle(
          visible=densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.actual,
          extent={{-16,80},{16,54}},
          fillColor={85,170,255},
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None,
          lineColor={0,0,0}),
        Rectangle(
          visible=densitySelection == BuildingsLite.Airflow.Multizone.Types.densitySelection.fromBottom,
          extent={{-16,0},{16,-80}},
          fillColor={85,170,255},
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None,
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.MediumColumnDynamic\">
BuildingsLite.Airflow.Multizone.MediumColumnDynamic</a> instead of this model.
</p>
</html>",
revisions="<html>
<ul>
...
<a href=\"modelica://BuildingsLite.Utilities.Psychrometrics.Functions.density_pTX\">
BuildingsLite.Utilities.Psychrometrics.Functions.density_pTX</a>
for the density computation
as
<a href=\"modelica://BuildingsLite.Media.Air.density\">
BuildingsLite.Media.Air.density</a>
