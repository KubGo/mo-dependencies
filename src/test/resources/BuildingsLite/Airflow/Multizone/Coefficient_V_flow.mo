...
model Coefficient_V_flow "Power law with coefficient for volume flow rate"
  extends BuildingsLite.Airflow.Multizone.BaseClasses.PartialOneWayFlowElement(
    m_flow = V_flow*rho,
    V_flow = if Modelica.Math.isEqual(m, 0.5, 1E-10) then
   ...
   extends BuildingsLite.Airflow.Multizone.BaseClasses.PowerLawResistanceParameters(
     m = 0.5);
