...
model DoorOperable
  ...
  extends BuildingsLite.Airflow.Multizone.BaseClasses.Door(
...
equation
  ...
  VABpOpeClo_flow[1] = if Modelica.Math.isEqual(mOpe, 0.5, 1E-10)
    then
      BuildingsLite.Airflow.Multizone.BaseClasses.powerLaw05(
        C=CVal[1],
      ...
      BuildingsLite.Airflow.Multizone.BaseClasses.powerLawFixedM(
        C=CVal[1],
        dp=port_a1.p-port_a2.p,
        m=mOpe,
        a=a[1],
  ...
  VABpOpeClo_flow[2] = BuildingsLite.Airflow.Multizone.BaseClasses.powerLawFixedM(
    C=CVal[2],
    dp=port_a1.p-port_a2.p,
    m=mClo,
    a=a[2],
  ...
  mABt_flow = y*BuildingsLite.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
      k=kT,
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.DoorOpen\">
BuildingsLite.Airflow.Multizone.DoorOpen</a>, and for
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.DoorOpen\">
BuildingsLite.Airflow.Multizone.DoorOpen</a>
