...
model ReverseBuoyancy3Zones
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume volEas(
  ...
  BuildingsLite.Airflow.Multizone.MediumColumn colEasInBot(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop)
    "Medium column to compute static pressure of air"
    annotation (Placement(transformation(extent={{10,-70},{30,-50}})));
  BuildingsLite.Airflow.Multizone.MediumColumn colOutBot(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop)
    "Medium column to compute static pressure of air"
    annotation (Placement(transformation(extent={{90,-70},{110,-50}})));
  BuildingsLite.Airflow.Multizone.MediumColumn colWesBot(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromBottom)
    "Medium column to compute static pressure of air"
    annotation (Placement(transformation(extent={{-130,11},{-110,31}})));
  BuildingsLite.Airflow.Multizone.Orifice oriWesTop(
    redeclare package Medium = Medium,
    m=0.5,
    A=0.01,
    dp_turbulent=0.1) "Orifice between west room and top"
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  BuildingsLite.Airflow.Multizone.MediumColumn colWesTop(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop)
    "Medium column to compute static pressure of air"
    annotation (Placement(transformation(extent={{-130,79},{-110,99}})));
  BuildingsLite.Airflow.Multizone.DoorDiscretizedOperable dooOpeClo(
    redeclare package Medium = Medium,
    LClo=20*1E-4,
    wOpe=1,
    hOpe=2.2,
  ...
  BuildingsLite.Airflow.Multizone.MediumColumn col1EasBot(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromBottom)
    "Medium column to compute static pressure of air"
    annotation (Placement(transformation(extent={{-20,11},{0,31}})));
  BuildingsLite.Airflow.Multizone.Orifice oriEasTop(
    redeclare package Medium = Medium,
    m=0.5,
    A=0.01,
    dp_turbulent=0.1) "Orifice between east room and top"
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  BuildingsLite.Airflow.Multizone.MediumColumn colEasTop(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.fromTop)
    "Medium column to compute static pressure of air"
    annotation (Placement(transformation(extent={{-20,79},{0,99}})));
  BuildingsLite.Fluid.MixingVolumes.MixingVolume volTop(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    T_start=273.15 + 20,
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume volWes(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    V=2.5*5*5,
    T_start=273.15 + 22,
...
BuildingsLite.Airflow.Multizone.Validation.ThreeRoomsContam</a>.
