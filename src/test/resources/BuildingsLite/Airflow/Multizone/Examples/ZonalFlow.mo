...
model ZonalFlow "Model with prescribed air exchange between two volumes"
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume rooA(
    V=volA,
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume rooB(
    V=volB,
    redeclare package Medium = Medium,
    X_start={0.01,0.99},
    T_start=293.15,
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.ZonalFlow_m_flow\">BuildingsLite.Airflow.Multizone.ZonalFlow_m_flow</a>.
</li>
<li>
