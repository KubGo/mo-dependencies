...
model ChimneyShaftWithVolume
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume roo(
    V=2.5*5*5,
  ...
  BuildingsLite.Airflow.Multizone.Orifice oriChiTop(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) "Orifice at top"
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  BuildingsLite.Fluid.Sources.MassFlowSource_T boundary(
    redeclare package Medium = Medium,
    use_m_flow_in=true,
    T=293.15,
    nPorts=1) "Mass flow rate boundary condition"
    annotation (Placement(transformation(extent={{-40,-90},{-20,-70}})));
  BuildingsLite.Fluid.Sources.Boundary_pT bou0(
    redeclare package Medium = Medium,
    T=273.15,
    nPorts=2) "Pressure boundary condition"
        ...
        rotation=270,
        origin={90,50})));
  BuildingsLite.Airflow.Multizone.Orifice oriBot(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) "Orifice"
            annotation (Placement(transformation(
  ...
  BuildingsLite.Airflow.Multizone.Orifice oriChiBot(
    m=0.5,
    redeclare package Medium = Medium,
  ...
  BuildingsLite.Airflow.Multizone.MediumColumnDynamic sha(
    redeclare package Medium = Medium,
    V=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Shaft of chimney"
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.Examples.ChimneyShaftNoVolume\">
BuildingsLite.Airflow.Multizone.Examples.ChimneyShaftNoVolume</a>,
