...
model ClosedDoors "Model with three closed doors"
  ...
  BuildingsLite.Airflow.Multizone.DoorDiscretizedOperable dooAB(
    redeclare package Medium = Medium,
    LClo=20*1E-4,
    forceErrorControlOnFlow=true) "Discretized door"
    annotation (Placement(transformation(extent={{10,-30},{30,-10}})));

  BuildingsLite.Fluid.MixingVolumes.MixingVolume volA(
    redeclare package Medium = Medium,
    V=2.5*5*5,
    nPorts=4,
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume volB(
    redeclare package Medium = Medium,
    V=2.5*5*5,
    nPorts=4,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  BuildingsLite.Fluid.MixingVolumes.MixingVolume volC(
    redeclare package Medium = Medium,
    V=2.5*5*5,
    nPorts=4,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  BuildingsLite.Airflow.Multizone.DoorDiscretizedOperable dooAC(
    redeclare package Medium = Medium,
    LClo=20*1E-4,
    forceErrorControlOnFlow=true) "Discretized door"
  ...
  BuildingsLite.Airflow.Multizone.DoorDiscretizedOperable dooBC(
    redeclare package Medium = Medium,
    LClo=20*1E-4,
    forceErrorControlOnFlow=true) "Discretized door"
...
<p>
This model uses
<a href=\"modelica://BuildingsLite.Media.Specialized.Air.PerfectGas\">
BuildingsLite.Media.Specialized.Air.PerfectGas</a>
as the medium because
<a href=\"modelica://BuildingsLite.Media.Air\">
BuildingsLite.Media.Air</a>
