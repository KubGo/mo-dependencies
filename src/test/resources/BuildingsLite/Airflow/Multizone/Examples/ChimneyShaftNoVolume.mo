...
model ChimneyShaftNoVolume
  ...
  BuildingsLite.Airflow.Multizone.MediumColumn sha(redeclare package Medium = Medium,
      densitySelection=BuildingsLite.Airflow.Multizone.Types.densitySelection.actual) "Shaft of chimney"
