...
algorithm
  ...
  if aR < aRDel then
    Cp :=Cp0*BuildingsLite.Utilities.Math.Functions.regStep(
...
<a href=\"modelica://BuildingsLite.Fluid.Sources.Outside_CpLowRise\">
BuildingsLite.Fluid.Sources.Outside_CpLowRise</a>
