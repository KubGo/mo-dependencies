...
algorithm
  ...
  CpAct :=BuildingsLite.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
    x=aR,
    x1=incAngTab[i],
    x2=incAngTab[i + 1],
    y1=CpTab[i],
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.BaseClasses.windPressureLowRise\">
BuildingsLite.Airflow.Multizone.BaseClasses.windPressureLowRise</a>.
</li>
<li>
...
<a href=\"modelica://BuildingsLite.Fluid.Sources.Outside_CpData\">
BuildingsLite.Fluid.Sources.Outside_CpData</a>.
</p>
<h4>References</h4>
<ul>
<li>
