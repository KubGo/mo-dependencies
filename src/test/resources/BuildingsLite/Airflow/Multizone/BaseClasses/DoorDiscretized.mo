...
partial model DoorDiscretized
  ...
  extends BuildingsLite.Airflow.Multizone.BaseClasses.TwoWayFlowElementBuoyancy;
...
equation
  ...
  for i in 1:nCom loop
    ...
    gaiFlo[i] = BuildingsLite.Utilities.Math.Functions.smoothHeaviside(x=dV_flow[i], delta=VZerCom_flow);
