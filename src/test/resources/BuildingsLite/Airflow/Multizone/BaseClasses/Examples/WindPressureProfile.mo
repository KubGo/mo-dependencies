...
protected
  ...
  final parameter Real[n+3] deri=
      BuildingsLite.Utilities.Math.Functions.splineDerivatives(
      x=incAngExt,
      y=CpExt,
...
equation
   ...
   CpAct =BuildingsLite.Airflow.Multizone.BaseClasses.windPressureProfile(
    alpha=alpha,
    incAngTab=incAngExt,
    CpTab=CpExt,
...
<a href=\"modelica://BuildingsLite.Airflow.Multizone.BaseClasses.windPressureProfile\">
BuildingsLite.Airflow.Multizone.BaseClasses.windPressureProfile</a>
function.
</p>
</html>", revisions="<html>
<ul>
