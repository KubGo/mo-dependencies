within BuildingsLite.Airflow.Multizone.BaseClasses.Examples;
...
equation
  dp = 10*(-1+2*time);
  V_flow = BuildingsLite.Airflow.Multizone.BaseClasses.powerLaw(
    dp=dp,
    C=C,
    m=m,
    dp_turbulent=dp_turbulent);
  VFixed_flow = BuildingsLite.Airflow.Multizone.BaseClasses.powerLawFixedM(
    C=C,
    dp=dp,
    m=m,
    a=a,
