within BuildingsLite.Controls.DemandResponse.BaseClasses;
block BaselinePrediction "Predicts the baseline consumption"
  ...
  parameter BuildingsLite.Controls.Predictors.Types.PredictionModel predictionModel
...
protected
  BuildingsLite.Controls.Predictors.ElectricalLoad basLin(
    final nSam=nSam,
    final nPre=nPre,
    final nHis=nHis,
