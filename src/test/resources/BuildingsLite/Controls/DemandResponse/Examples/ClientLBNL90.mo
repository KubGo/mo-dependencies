within BuildingsLite.Controls.DemandResponse.Examples;
model ClientLBNL90
  ...
  Client clientAverage(
    nSam=nSam,
    predictionModel=BuildingsLite.Controls.Predictors.Types.PredictionModel.Average)
  ...
  Client clientWeather(
    nSam=nSam,
    predictionModel=BuildingsLite.Controls.Predictors.Types.PredictionModel.WeatherRegression)
...
equation
  ...
  annotation (
        ...
        "Simulate and plot"),
            experiment(
      Tolerance=1e-6, StopTime=1.728e+06),
