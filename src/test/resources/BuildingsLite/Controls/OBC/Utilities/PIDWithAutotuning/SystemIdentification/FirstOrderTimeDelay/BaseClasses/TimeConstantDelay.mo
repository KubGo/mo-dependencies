within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses;
block TimeConstantDelay
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput rat
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput triFai
    "True when an error occurs in the autotuning process"
    annotation (Placement(transformation(extent={{180,-150},{220,-110}}),
    iconTransformation(extent={{100,-100},{140,-60}})));
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Abs absGai "Absoulte value of the gain"
    annotation (Placement(transformation(extent={{-160,0},{-140,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Exp exp
    "Exponential value of the ratio between time constant and the time delay"
    annotation (Placement(transformation(extent={{-160,-60},{-140,-40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yHigSig(
    final k=yHig)
    "Higher value for the output"
    annotation (Placement(transformation(extent={{-160,60},{-140,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yLowSig(
    final k=yLow)
    "Lower value for the output"
    annotation (Placement(transformation(extent={{-100,60},{-80,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant relDeaBan(
    final k=deaBan)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div2
    "Blocks that calculates input 1 divided by input 2"
    annotation (Placement(transformation(extent={{120,-80},{140,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div3
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Log log
    "Natural logarithm of the input"
    annotation (Placement(transformation(extent={{-40,-90},{-20,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater gre1(final h=1e-6)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con(final k=1e-6)
    "Constant"
    annotation (Placement(transformation(extent={{-160,-110},{-140,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai(k=-1)
