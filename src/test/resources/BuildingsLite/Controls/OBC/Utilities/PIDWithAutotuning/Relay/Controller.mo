...
block Controller
  ...
  parameter Real r(min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps) = 1
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yOn
    "Relay switch output, true when control output switches to the higher value"
    annotation (Placement(transformation(extent={{100,-80},{140,-40}}),
        iconTransformation(extent={{100,-80},{140,-40}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yDif
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant higVal(
    final k=yHig)
    "Higher value for the output"
    annotation (Placement(transformation(extent={{-80,60},{-60,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant lowVal(
    final k=yLow)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract revActErr if reverseActing
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract dirActErr if not reverseActing
    "Control error when direct acting, measurement - setpoint"
    annotation (Placement(transformation(extent={{-20,-80},{0,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract meaSetDif
    "Inputs difference, (measurement - setpoint)"
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gaiYDif(
    final k=1/r)
    "Gain to normalized control error by r"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gaiRevActErr(
    final k=1/r) if reverseActing
    "Gain to normalized control error by r"
    annotation (Placement(transformation(extent={{20,-40},{40,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gaiDirActErr(
