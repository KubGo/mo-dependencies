...
model DirectActingPIWithFirstOrderAMIGO
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.FirstOrderAMIGO PIWitTun(
     controllerType=BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PI,
     yHig=1,
     yLow=0,
     deaBan=0.1,
     yRef=0.8,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset PI(
...
equation
  ...
  connect(sub2.y, PIWitTun.u_m) annotation (Line(points={{182,-10},{190,-10},{
          190,-40},{-10,-40},{-10,-32}}, color={0,0,127}));
...
<p>
This example is similar as <a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Validation.ReverseActingPIWithFirstOrderAMIGO\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Validation.ReverseActingPIWithFirstOrderAMIGO</a>.
