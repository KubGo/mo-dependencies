...
model Controller "Test model for a relay controller"
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller relCon(
    yHig=1,
    yLow=0.5,
    deaBan=0.4)
    "A relay controller"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin(freqHz=2)
    "Measured value"
    annotation (Placement(transformation(extent={{-60,-90},{-40,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con(k=0)
    "Setpoint"
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse enaSig(
    width=0.5,
    period=1,
    shift=-0.5)
    "Enable signal"
