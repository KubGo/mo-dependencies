...
model HalfPeriodRatio "Test model for calculating the half period ratio"
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.HalfPeriodRatio
    halPerRat
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.SampleTrigger samTri(period=1, shift=0.9)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.Validation.TuningMonitor\">
