...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant thr(final k=lowLim)
    "Threshold"
    annotation (Placement(transformation(extent={{-80,-38},{-60,-18}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler yRec(
    final y_start=y_reset)
    "Record the input when sampling is triggered"
    annotation (Placement(transformation(extent={{60,40},{80,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant reset(
    final k=y_reset)
    "Reset value"
    annotation (Placement(transformation(origin={0,148}, extent={{-80,-90},{-60,-70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or samTri "Sampling trigger"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edgRes(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edgThr(
    final pre_u_start=false)
