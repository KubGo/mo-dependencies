...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Add Iu
    "Integral of the relay output"
    annotation (Placement(transformation(extent={{-40,-50},{-20,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset Iy(
    final k=1, final y_start=1E-3)
    "Integral of the process output"
    annotation (Placement(transformation(extent={{-10,60},{10,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant refRelOut(
    final k=0) "Reference value of the relay control output"
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide divIyIu "Calculate the gain"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar(final p=1E-3)
    "Block that avoids a divide-by-zero error"
    annotation (Placement(transformation(extent={{20,-50},{40,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gaiOnyHig(
    final k=yHig)
    "Product of tOn and yHig"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gaiOffyLow(
    final k=-yLow)
...
<p>
where <i>u(t)</i> is the relay output at <i>t</i> (see details in <a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller\">
