within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay;
block ControlProcessModel
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput tOn(
    final quantity="Time",
    final unit="s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput tOff(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput tau(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput u
    "Output of a relay controller"
    annotation (Placement(transformation(extent={{-200,60},{-160,100}}),
        iconTransformation(extent={{-140,60},{-100,100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput triSta
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput triEnd
    ...
    annotation (Placement(transformation(extent={{-20,-20},{20,20}}, rotation=90, origin={130,-120}),
        iconTransformation(extent={{-20,-20},{20,20}}, rotation=90, origin={60,-120})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput k
    "Gain"
    annotation (Placement(transformation(extent={{160,60},{200,100}}),
        iconTransformation(extent={{100,60},{140,100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput T(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
    "Time constant"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput L(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
    "Time delay"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput tunSta
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div
    "The output of samtau divided by that of addPar"
    annotation (Placement(transformation(extent={{0,-50},{20,-30}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses.Gain
    gain(final yHig=yHig, final yLow=yLow) "Block that calculates the gain"
    annotation (Placement(transformation(extent={{-120,10},{-100,30}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses.TimeConstantDelay
    timConDel(
    final yHig=yHig,
    final yLow=yLow,
    final deaBan=deaBan)
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler samL(
    final y_start=1)
    "Block that samples the time delay when the tuning period ends"
    annotation (Placement(transformation(extent={{100,-40},{120,-20}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler samtOn(
    final y_start=1)
    "Block that samples the length of the on period when the tuning period ends"
    annotation (Placement(transformation(extent={{-100,50},{-80,70}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler samT(
    final y_start=1)
    "Block that samples the time constant when the tuning period ends"
    annotation (Placement(transformation(extent={{120,10},{140,30}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler samTau(
    final y_start=0.5)
  ...
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assTunFai(
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses.Gain\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses.Gain</a>
and
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses.TimeConstantDelay\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.BaseClasses.TimeConstantDelay</a>
...
<p>
Refer to <a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller</a> for detailed explanation
