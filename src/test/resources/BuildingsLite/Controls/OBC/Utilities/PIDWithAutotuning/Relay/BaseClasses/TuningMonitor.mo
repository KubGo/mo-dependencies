within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses;
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minLen(
    final k=eps)
    "Minimum value for the horizon length"
    annotation (Placement(transformation(extent={{-140,90},{-120,110}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler samAddtOntOff
    "Sample the minimum period when the minimum period is greater than 0"
    annotation (Placement(transformation(extent={{-40,-20},{-20,0}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater tInc(
    u1(unit="s"),
    u2(unit="s"))
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add addtOntOff
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Greater tDec(
    u1(unit="s"),
    u2(unit="s"))
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or tCha
    "Block that checks if the length for the on period or the length for the off period changes"
    annotation (Placement(transformation(extent={{80,-10},{100,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edgTunSta
   "Detect if the tuning process starts"
    annotation (Placement(transformation(extent={{120,50},{140,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edgTunEnd
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Min tMin
   "Minimum value of the length for the on and Off period"
    annotation (Placement(transformation(extent={{-130,-90},{-110,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greThr1
    "Check if both the length for the on period and the length for the off period are larger than 0"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub "Find the input difference"
    annotation (Placement(transformation(extent={{0,20},{20,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub1 "Find the input difference"
