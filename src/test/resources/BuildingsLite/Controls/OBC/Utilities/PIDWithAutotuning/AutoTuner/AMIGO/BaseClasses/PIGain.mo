within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO.BaseClasses;
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant const1(final k=0.35)
    "Constant value"
    annotation (Placement(transformation(extent={{0,-90},{20,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant const2(final k=0.15)
    "Constant value"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul4
    "Block that calculates the product of the two inputs"
