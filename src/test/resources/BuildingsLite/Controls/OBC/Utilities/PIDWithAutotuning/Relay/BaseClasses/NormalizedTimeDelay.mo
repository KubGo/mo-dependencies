...
block NormalizedTimeDelay
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput rho
    "Half period ratio"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant asyLev(
    final k=gamma)
    "Asymmetry level of the relay controller"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract subGamRho
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not and1
    "Disable the assert when the tuning is not ongoing"
    annotation (Placement(transformation(extent={{20,-90},{40,-70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tunEndDel(
