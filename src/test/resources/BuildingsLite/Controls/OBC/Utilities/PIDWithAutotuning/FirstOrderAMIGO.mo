within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning;
block FirstOrderAMIGO
  "Autotuning PID controller with an AMIGO tuner that employs a first-order system model"

  parameter BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController controllerType=
    BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PI
    "Type of controller";
  parameter Real k_start(
    final min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=1
  ...
  parameter Real Td_start(unit="s")=0.1
    ...
    annotation (Dialog(group="Initial control gains, used prior to first tuning",
      enable=controllerType == BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PID));
  parameter Real r(
    final min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=1
  ...
  parameter Real yMin = 0
    ...
    annotation (Dialog(group="Limits"));
  parameter Real Ni(
    final min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=0.9
    "Ni*Ti is time constant of anti-windup compensation"
    annotation (Dialog(tab="Advanced",group="Integrator anti-windup"));
  parameter Real Nd(
    final min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=10
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput u_s
    "Connector of set point input signal"
    annotation (Placement(transformation(extent={{-320,-20},{-280,20}}),
      iconTransformation(extent={{-140,-20},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput u_m
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput triRes
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO.PID PIDPar
    if with_D "Autotuner of gains for a PID controller"
    annotation (Placement(transformation(extent={{160,-50},{180,-30}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO.PI PIPar
    if not with_D "Autotuner of gains for a PI controller"
    annotation (Placement(transformation(extent={{160,0},{180,20}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller rel(
    final r=r,
    final yHig=yHig,
    final yLow=yLow,
    final deaBan=deaBan,
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.ResponseProcess resPro(
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.ControlProcessModel
    conProMod(
    final yHig=yHig - yRef,
    final yLow=yRef - yLow,
    final deaBan=deaBan)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch inTunPro
...
protected
  final parameter Boolean with_D=controllerType == BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PID
    "Boolean flag to enable derivative action"
    annotation (Evaluate=true,HideResult=true);
  final parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController conTyp=
    if controllerType==BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PI
      then BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
      else BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID
    "Type of controller";
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.CivilTime modTim
    "Simulation time"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con1(final k=yHig)
    "Higher value for the relay output"
    annotation (Placement(transformation(extent={{-160,250},{-140,270}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con2(final k=yRef)
    "Reference value for the relay output"
    annotation (Placement(transformation(extent={{-160,210},{-140,230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con3(final k=yLow)
    "Lower value for the relay output"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs1
    "Absolute value"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con4(final k=1e-3)
    "Threshold for checking if the input is larger than 0"
    annotation (Placement(transformation(extent={{40,170},{60,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter yRel(
    final k=yMax - yMin)
    "Relay output multiplied by the possible range of the output"
    annotation (Placement(transformation(extent={{0,50},{20,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Nand nand
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edgReq
    "True only when a new request is received"
    annotation (Placement(transformation(extent={{120,-250},{140,-230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tunStaDel(
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler sam_u_s(final y_start=0)
    "Recording the set point. Not that y_start does not influence the tuning."
    annotation (Placement(transformation(extent={{-140,120},{-120,140}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Nand nand1
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs2
...
equation
  connect(con.u_s, u_s) annotation (Line(points={{-52,-220},{-88,-220},{-88,-30},
          {-260,-30},{-260,0},{-300,0}}, color={0,0,127}));
  ...
  connect(con.Ti, samTi.y) annotation (Line(points={{-52,-216},{-100,-216},{-100,
          -230},{-158,-230}}, color={0,0,127}));
  connect(samTd.y,con. Td) annotation (Line(points={{-198,-260},{-80,-260},{-80,
          -224},{-52,-224}}, color={0,0,127}));
  connect(resPro.on, rel.yOn) annotation (Line(points={{-22,-50},{-40,-50},{-40,
          -36},{-58,-36}}, color={255,0,255}));
  connect(modTim.y, resPro.tim) annotation (Line(points={{-58,10},{-30,10},{-30,
  ...
  connect(PIDPar.Ti, samTi.u) annotation (Line(points={{182,-40},{240,-40},{240,
          -110},{-230,-110},{-230,-230},{-182,-230}}, color={0,0,127}));
  ...
  connect(PIPar.Ti, samTi.u) annotation (Line(points={{182,4},{240,4},{240,-110},
          {-230,-110},{-230,-230},{-182,-230}}, color={0,0,127}));
  ...
  connect(inTunPro.u, triTun) annotation (Line(points={{58,-140},{40,-140},{40,-240},
          {100,-240},{100,-300}}, color={255,0,255}));
  connect(rel.trigger, triTun) annotation (Line(points={{-78,-42},{-78,-170},{40,
          -170},{40,-240},{100,-240},{100,-300}}, color={255,0,255}));
  connect(resPro.trigger, triTun)
    annotation (Line(points={{-22,-56},{-40,-56},{-40,-170},{40,-170},{40,-240},
        {100,-240},{100,-300}}, color={255,0,255}));
  ...
  connect(PIDPar.k, samk.u) annotation (Line(points={{182,-33},{230,-33},{230,-80},
          {-160,-80},{-160,-200},{-142,-200}}, color={0,0,127}));
  connect(PIDPar.Td, samTd.u) annotation (Line(points={{182,-47},{210,-47},{210,
          -70},{-260,-70},{-260,-260},{-222,-260}}, color={0,0,127}));
  connect(conProMod.tunSta, and2.u2) annotation (Line(points={{82,2},{104,2},{104,
          -180},{-220,-180},{-220,-148},{-202,-148}}, color={255,0,255}));
  connect(and2.y, samk.trigger) annotation (Line(points={{-178,-140},{-170,-140},
          {-170,-170},{-130,-170},{-130,-188}}, color={255,0,255}));
  connect(samTi.trigger, and2.y) annotation (Line(points={{-170,-218},{-170,-140},
          {-178,-140}}, color={255,0,255}));
  connect(samTd.trigger, and2.y) annotation (Line(points={{-210,-248},{-210,-170},
          {-170,-170},{-170,-140},{-178,-140}}, color={255,0,255}));
  connect(and2.u1, nand1.y) annotation (Line(points={{-202,-140},{-240,-140},{-240,
          80},{120,80},{120,110},{102,110}}, color={255,0,255}));
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller</a>.
</li>
</ul>
<p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification</a>).
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO</a>).
</li>
</ul>
<p>
This block is implemented using
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithInputGains\">
BuildingsLite.Controls.OBC.Utilities.PIDWithInputGains</a>
...
(see <a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Controller</a>).
The PID tuning process ends automatically
(see details in
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.TuningMonitor\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.BaseClasses.Relay.TunMonitor</a>),
...
<li>
<code>yHig</code> must be greater than <code>yRef</code> but cannot be greater than 1.
</li>
<li>
...
Icon(coordinateSystem(extent={{-100,-100},{100,100}}),
     graphics={
        ...
        Text(
          extent={{-56,96},{36,66}},
          textString= if controllerType == BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PID then "PID" else "PI"),
        Polygon(
        ...
        Text(
          ...
          textString=DynamicSelect(
            ...
            significantDigits=3))),
        Text(
          visible = controllerType == BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Types.SimpleController.PID,
          extent={{24,-34},{-74,-70}},
          textColor={0,0,0},
          textString=DynamicSelect(
            "Td = " + String(Td_start,
