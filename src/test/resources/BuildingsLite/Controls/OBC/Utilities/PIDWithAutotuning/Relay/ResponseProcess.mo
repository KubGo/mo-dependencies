within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay;
block ResponseProcess
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput on
    "Relay switch. True: tuning on perid, False: tuning off period"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}}),
        iconTransformation(extent={{-140,-20},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput tim(
    final quantity="Time",
    final unit="s")
    "Simulation time"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput inTun
    "Check if a tuning is ongoing"
    annotation (Placement(transformation(extent={{-20,-20},{20,20}},
        rotation=90, origin={0,-120})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput tOn(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
    "Length of the on period"
    annotation (Placement(transformation(extent={{100,60},{140,100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput tOff(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
    "Length of the off period"
    annotation (Placement(transformation(extent={{100,20},{140,60}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput triSta
    "True: the tuning starts"
    annotation (Placement(transformation(extent={{100,-60},{140,-20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput triEnd
    "True: the tuning ends"
    annotation (Placement(transformation(extent={{100,-100},{140,-60}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput tau
    "Normalized time delay"
    annotation (Placement(transformation(extent={{100,-20},{140,20}}),
        iconTransformation(extent={{100,-20},{140,20}})));

protected
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.OnOffPeriod onOffPer
    "Block that calculates the length of the on period and the off period"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.HalfPeriodRatio halPerRatio
    "Block that calculates the half period ratio"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.NormalizedTimeDelay norTimDel(
     final gamma=max(yHig, yLow)/min(yLow, yHig))
    "Block that calculates the normalized time delay"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.TuningMonitor
...
<ul>
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.HalfPeriodRatio\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.HalfPeriodRatio</a>,
</li>
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.NormalizedTimeDelay\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.NormalizedTimeDelay</a>,
</li>
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.OnOffPeriod\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.OnOffPeriod</a>.
</li>
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.TuningMonitor\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.Relay.BaseClasses.TuningMonitor</a>.
</li>
</ul>
</html>"));
end ResponseProcess;
