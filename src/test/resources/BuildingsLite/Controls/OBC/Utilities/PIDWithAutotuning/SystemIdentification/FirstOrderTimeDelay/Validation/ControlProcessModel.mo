within BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.Validation;
model ControlProcessModel
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse tunEnd(
    width=0.1,
    period=1,
    shift=0.9)
    "The signal for the tuning period ends"
    annotation (Placement(transformation(extent={{-80,-88},{-60,-68}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse ratioLT(
    amplitude=-0.1,
    width=0.4,
    period=0.8,
    offset=0.4)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.ControlProcessModel\">
BuildingsLite.Controls.OBC.Utilities.PIDWithAutotuning.SystemIdentification.FirstOrderTimeDelay.ControlProcessModel</a>.
</p>
<p>
