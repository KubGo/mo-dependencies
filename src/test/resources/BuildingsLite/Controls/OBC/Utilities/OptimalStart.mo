...
block OptimalStart
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSetZonHea(
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSetZonCoo(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optHea(
  ...
  BuildingsLite.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optCoo(
    final tOptMax=tOptMax,
    final thrOptOn=thrOptOn,
    final nDay=nDay,
    final uLow=uLow,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold hysSta(
    t=60,
    h=60)
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Max max
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract dTHea if computeHeating
    "Temperature difference between heating setpoint and zone temperature"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract dTCoo if computeCooling
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant con3(
...
The base class
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation\">
BuildingsLite.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation</a> is used
for the calculation.
</p>
<h4>Algorithm</h4>
<p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean\">
BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean</a> for details about
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.Validation\">
BuildingsLite.Controls.OBC.Utilities.Validation</a>.
</p>
</html>",
      revisions="<html>
<ul>
