...
block PIDWithEnable
  ...
  parameter Real k(
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=1
    "Gain of controller"
    annotation (Dialog(group="Control gains"));
  parameter Real Ti(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=0.5
    "Time constant of integrator block"
    annotation (
      Dialog(
        group="Control gains",
        enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or
          controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real Td(
    final quantity="Time",
    final unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=0.1
    "Time constant of derivative block"
    annotation (
      Dialog(
        group="Control gains",
        enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or
          controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  parameter Real yMin=0
    ...
    annotation (Dialog(group="Limits"));
  parameter Real Ni(
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=0.9
    "Ni*Ti is time constant of anti-windup compensation"
    annotation (
      Dialog(
      tab="Advanced",
      group="Integrator anti-windup",
      enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real Nd(
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)=10
    "The higher Nd, the more ideal the derivative block"
    annotation (
      Dialog(tab="Advanced",
      group="Derivative block",
      enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput uEna
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiInp
    "Switch to select input signal"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiOut
    "Switch to select output signal"
    annotation (Placement(transformation(extent={{72,-10},{92,10}})));
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant valDis(
    final k=y_neutral)
    "Value when disabled"
...
Moved to <code>BuildingsLite.Controls.OBC.Utilities.PIDWithEnable</code> as there were
identical implementations in <code>BuildingsLite.DHC</code> and in <code>BuildingsLite.Templates</code>.
</li>
<li>
