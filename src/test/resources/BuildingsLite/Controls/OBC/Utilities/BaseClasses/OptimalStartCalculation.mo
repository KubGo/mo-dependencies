within BuildingsLite.Controls.OBC.Utilities.BaseClasses;
block OptimalStartCalculation
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TDif(
    final quantity="TemperatureDifference",
    final unit="K")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput staCal
    "Start calculation"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput tOpt(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput optOn
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean samTemSloAve(
    final n=nDay)
    "Calculate the averaged temperature slope over the past n days"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler dTCalOn
    "Get the sampled temperature difference at the same time each day"
    annotation (Placement(transformation(extent={{-40,70},{-20,90}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler dTHVACOn
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant timReaMin(
    final k=tReaMin)
    "Minimum time to reach set point (used to avoid division by zero)"
    annotation (Placement(transformation(extent={{-80,-42},{-60,-22}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant defTemSlo(
    final k=temSloDef)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysOpt(
    final pre_y_start=false,
    final uHigh=0,
    final uLow=-60)
    "Hysteresis to activate the optimal start"
    annotation (Placement(transformation(extent={{320,-90},{340,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxStaTim(
    final k=tOptMax)
    "Maximum optimal start time"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide temSlo
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Min min
    "Get the final optimal start time"
    annotation (Placement(transformation(extent={{240,-16},{260,4}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler triSam
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler triSam1
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide tOptCal
    "Calculate optimal start time using the averaged previous temperature slope"
    annotation (Placement(transformation(extent={{160,-10},{180,10}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler samTimOpt
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Max timRea
    "Time required to reach the set point"
    annotation (Placement(transformation(extent={{-40,-16},{-20,4}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max temSloAve
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch dTUse
    "dT used in the calculations (to avoid negative dT)"
    annotation (Placement(transformation(extent={{80,70},{100,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold reqStaUp(
    final t=0,
    final h=0)
    "Output true if optimal startup is needed"
    annotation (Placement(transformation(extent={{10,70},{30,90}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And triAve
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.OptimalStart\">
BuildingsLite.Controls.OBC.Utilities.OptimalStart</a>.
</p>
</html>",
      revisions="<html>
<ul>
