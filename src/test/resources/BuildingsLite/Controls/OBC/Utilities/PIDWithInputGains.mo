within BuildingsLite.Controls.OBC.Utilities;
block PIDWithInputGains
  "P, PI, PD, and PID controller with output reset and input gains"
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
    "Type of controller";
  parameter Real r(
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput k(
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput Ti(
    quantity="Time",
    unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
    if with_I
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput Td(
    quantity="Time",
    unit="s",
    min=100*BuildingsLite.Controls.OBC.CDL.Constants.eps)
    if with_D
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput trigger
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract controlError
    "Control error (set point - measurement)"
    annotation (Placement(transformation(extent={{-200,-16},{-180,4}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply P
    "Proportional action"
    annotation (Placement(transformation(extent={{-50,130},{-30,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset I(
    final k=1,
    final y_start=xi_start) if with_I
    "Integral term"
    annotation (Placement(transformation(extent={{-50,-10},{-30,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Derivative D(
    final y_start=yd_start) if with_D
    "Derivative term"
    annotation (Placement(transformation(extent={{-50,60},{-30,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract errP
    "P error"
    annotation (Placement(transformation(extent={{-140,130},{-120,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract errD if with_D
    "D error"
    annotation (Placement(transformation(extent={{-140,60},{-120,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract errI1 if with_I
    "I error (before anti-windup compensation)"
    annotation (Placement(transformation(extent={{-140,-4},{-120,16}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract errI2 if with_I
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide antWinGai2 if with_I
    "Outputs of anti-windup compensation"
    annotation (Placement(transformation(extent={{100,-30},{80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide gaiI if with_I "Gain of the integral term"
    annotation (Placement(transformation(extent={{-200,116},{-180,136}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply errIWithGai if with_I
    "I error (after multiplying with the gain of the integral term)"
    annotation (Placement(transformation(extent={{-84,28},{-64,48}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mulkTd if with_D
    "Product of k and Td"
    annotation (Placement(transformation(extent={{-200,150},{-180,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThrkTd(
    t=1E-6,
    h=1E-6/2)
    if with_D
...
protected
  ...
  final parameter Boolean with_I=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID
    "Boolean flag to enable integral action"
    annotation (Evaluate=true,HideResult=true);
  final parameter Boolean with_D=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID
    "Boolean flag to enable derivative action"
    annotation (Evaluate=true,HideResult=true);
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant Dzero(
    final k=0) if not with_D
    "Zero input signal"
    annotation (Evaluate=true,HideResult=true,Placement(transformation(extent={{-50,90},
            {-30,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant Izero(
    final k=0) if not with_I
    "Zero input signal"
    annotation (Placement(transformation(extent={{-50,20},{-30,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter uS_revAct(
    final k=revAct/r) "Set point multiplied by reverse action sign"
    annotation (Placement(transformation(extent={{-200,30},{-180,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter uMea_revAct(
    final k=revAct/r)
    "Set point multiplied by reverse action sign"
    annotation (Placement(transformation(extent={{-200,-50},{-180,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add addPD
    "Outputs P and D gains added"
    annotation (Placement(transformation(extent={{20,124},{40,144}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add addPID
    "Outputs P, I and D gains added"
    annotation (Placement(transformation(extent={{80,80},{100,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract antWinErr if with_I
    "Error for anti-windup compensation"
    annotation (Placement(transformation(extent={{160,50},{180,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter antWinGai1(k=1/Ni)
    if with_I "Gain for anti-windup compensation without the proportional gain"
    annotation (Placement(transformation(extent={{180,-30},{160,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yResSig(
    final k=y_reset) if with_I
    "Signal for y_reset"
    annotation (Placement(transformation(extent={{-140,-84},{-120,-64}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract addRes if with_I
    "Adder for integrator reset"
    annotation (Placement(transformation(extent={{-100,-90},{-80,-70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant cheYMinMax(
    final k=yMin < yMax) "Check for values of yMin and yMax"
    annotation (Placement(transformation(extent={{140,120},{160,140}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMesYMinMax(
  ...
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMeskTd(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gaiT(final k=1/Nd) if with_D
    ...
    Icon(
      ...
      graphics={
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.Solid),
        Text(
          visible=(controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.P),
          extent={{-32,-22},{68,-62}},
          textColor={0,0,0},
          textString="P"),
        Text(
          visible=(controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI),
          extent={{-26,-22},{74,-62}},
          textColor={0,0,0},
          textString="PI"),
        Text(
          visible=(controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD),
          extent={{-16,-22},{88,-62}},
          textColor={0,0,0},
          textString="P D"),
        Text(
          visible=(controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID),
          extent={{-14,-22},{86,-62}},
          textColor={0,0,0},
          textString="PID"),
        Polygon(
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset\">
BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset</a>,
