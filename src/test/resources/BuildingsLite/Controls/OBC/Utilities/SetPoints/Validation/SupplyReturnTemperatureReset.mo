within BuildingsLite.Controls.OBC.Utilities.SetPoints.Validation;
model SupplyReturnTemperatureReset
  "Test model for the heating curve"
  BuildingsLite.Controls.OBC.Utilities.SetPoints.SupplyReturnTemperatureReset heaCur(
    m=1,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
    TOut_nominal=263.15)
  ...
  BuildingsLite.Controls.OBC.Utilities.SetPoints.SupplyReturnTemperatureReset heaCur1(
    m=1,
    dTOutHeaBal=15,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse TRoo1(
    offset=273.15+20,
    shift=0.5,
    amplitude=-5,
    period=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TOut1(
    k=273.15-10,
    y(unit="K"))
    "Constant outdoor air temperature"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TRoo(
    k=273.15+20,
    y(unit="K"))
...
equation
  connect(TOut1.y,heaCur1.TOut)
    annotation (Line(points={{-38,-20},{-38,-20},{0,-20},{0,-34},{18,-34}},color={0,0,127}));
  ...
  connect(TRoo1.y,heaCur1.TSetZon)
    annotation (Line(points={{-38,-60},{0,-60},{0,-46},{18,-46}},color={0,0,127}));
  annotation (
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/SetPoints/Validation/SupplyReturnTemperatureReset.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
