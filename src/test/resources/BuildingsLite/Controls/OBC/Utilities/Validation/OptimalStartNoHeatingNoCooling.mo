within BuildingsLite.Controls.OBC.Utilities.Validation;
model OptimalStartNoHeatingNoCooling
  ...
  BuildingsLite.Controls.OBC.Utilities.OptimalStart optSta(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin TOutBase(
    amplitude=5,
    freqHz=1/86400,
    offset=15+273.15,
    startTime(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=25)
    "Overall heat loss coefficient"
    annotation (Placement(transformation(extent={{-100,0},{-80,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract dT
    "Temperature difference between zone and outdoor"
    annotation (Placement(transformation(extent={{-140,0},{-120,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter QCoo(k=-4000)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID conPID1(
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI,
    Ti=3,
    reverseActing=false)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID conPID(
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI,
    Ti=3)
    "PI control for space heating"
    annotation (Placement(transformation(extent={{180,40},{200,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter QHea(k=2000)
    "Heat injection in the zone"
    annotation (Placement(transformation(extent={{-100,-110},{-80,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add TOut
    "Outdoor dry bulb temperature"
    annotation (Placement(transformation(extent={{-174,50},{-154,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse pul(
    shift(
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal TSetHea(
    realTrue=273.15+21,
    realFalse=273.15+15,
    y(final unit="K",
      displayUnit="degC"))
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal TSetCoo(
    realTrue=273.15+24,
    realFalse=273.15+30,
    y(final unit="K",
      displayUnit="degC"))
...
equation
  ...
  connect(TRoo.y,conPID1.u_m)
    annotation (Line(points={{1,10},{6,10},{6,-12},{190,-12},{190,-2}},color={0,0,127}));
  ...
  connect(conPID.y,QHea.u)
    annotation (Line(points={{202,50},{212,50},{212,-120},{-108,-120},{-108,-100},{-102,-100}},color={0,0,127}));
  ...
  connect(booToRea2.y,add2.u1)
    annotation (Line(points={{102,50},{126,50},{126,56},{138,56}},color={0,0,127}));
  connect(booToRea1.y,add1.u1)
    annotation (Line(points={{102,10},{120,10},{120,16},{138,16}},color={0,0,127}));
  connect(TRoo.y, conPID.u_m) annotation (Line(points={{1,10},{10,10},{10,34},{190,
          34},{190,38}}, color={0,0,127}));
  connect(TOut.y, dT.u1) annotation (Line(points={{-152,60},{-146,60},{-146,16},
          {-142,16}}, color={0,0,127}));
  connect(TRoo.y, dT.u2) annotation (Line(points={{1,10},{6,10},{6,-12},{-146,-12},
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartNoHeatingNoCooling.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This models validates the block
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.OptimalStart\">
BuildingsLite.Controls.OBC.Utilities.OptimalStart</a> for the case when the optimal start
