...
model OptimalStartCoolingPositiveStartTime
  ...
  BuildingsLite.Controls.OBC.Utilities.OptimalStart optStaCoo(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=100)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add dTdt
    "Temperature derivative"
    annotation (Placement(transformation(extent={{-80,0},{-60,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter QCoo(k=-2000)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add
...
equation
  ...
  connect(TSetCoo.y,add.u2)
    annotation (Line(points={{82,-50},{100,-50},{100,4},{118,4}},color={0,0,127}));
  connect(booToRea.y,add.u1)
    annotation (Line(points={{82,10},{100,10},{100,16},{118,16}},color={0,0,127}));
  connect(TRoo.y, dT.u2) annotation (Line(points={{-19,10},{-14,10},{-14,-20},{-166,
          -20},{-166,4},{-162,4}}, color={0,0,127}));
...
BuildingsLite.Controls.OBC.Utilities.OptimalStart</a> for space cooling system
