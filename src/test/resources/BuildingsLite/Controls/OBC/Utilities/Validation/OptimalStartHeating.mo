...
model OptimalStartHeating
  ...
  BuildingsLite.Controls.OBC.Utilities.OptimalStart optStaHea(
    computeHeating=true,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=10)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter QHea(k=500)
...
BuildingsLite.Controls.OBC.Utilities.OptimalStart</a> for space heating system.
</p>
<p>
