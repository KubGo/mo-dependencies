...
model OptimalStartHeatingCooling
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TSetCooOcc(
    k=24+273.15)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TSetHeaOcc(
    k=21+273.15)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartHeatingCooling.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
