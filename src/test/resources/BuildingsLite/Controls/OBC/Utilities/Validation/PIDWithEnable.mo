...
model PIDWithEnable
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithEnable limPID(
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithEnable limPI(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  BuildingsLite.Controls.OBC.Utilities.PIDWithEnable limPD(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD)
    "PD controller"
    annotation (Placement(transformation(extent={{-30,-20},{-10,0}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithEnable limP(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.P)
    "P controller"
    annotation (Placement(transformation(extent={{-30,-50},{-10,-30}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithEnable noLimPID(
    Ti=1,
    Td=1,
    yMax=1e15,
    yMin=-1e15,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.Utilities.Validation.PIDWithEnable\">
BuildingsLite.Controls.OBC.Utilities.Validation.PIDWithEnable</a>.
