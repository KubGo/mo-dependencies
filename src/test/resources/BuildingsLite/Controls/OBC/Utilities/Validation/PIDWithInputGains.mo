...
model PIDWithInputGains
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse pulse(
    period=0.25)
    "Setpoint"
    annotation (Placement(transformation(extent={{-30,14},{-10,34}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant const(
    k=0.5)
    "Measured value"
    annotation (Placement(transformation(extent={{-30,-22},{-10,-2}})));
  BuildingsLite.Controls.OBC.Utilities.PIDWithInputGains PIDWitInpGai(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse resSig(period=1)
    "Reset signal"
    annotation (Placement(transformation(extent={{-80,40},{-60,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse k(
    amplitude=0.2,
    width=0.4,
    period=1,
    shift=0.6,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse Ti(
    amplitude=0.2,
    width=0.4,
    period=1,
    shift=0.6,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse Td(
    amplitude=0.1,
    width=0.4,
    period=1,
    shift=0.6,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr(t=1E-5, h=1E-4)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr(t=0.59)
