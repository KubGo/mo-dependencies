...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.From_degC from_degC
  "Unit converter from degree Celsius to kelvin "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.From_degC from_degC1
  "Unit converter from degree Celsius to kelvin "
