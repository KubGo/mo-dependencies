...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_psi to_psi
  "Unit converter from pascal to pound-force per square inch "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_psi to_psi1
  "Unit converter from pascal to pound-force per square inch "
