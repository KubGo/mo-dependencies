...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_hp to_hp
  "Unit converter from watt to horsepower "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_hp to_hp1
  "Unit converter from watt to horsepower "
