...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_quad to_quad
  "Unit converter from joule to quads "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_quad to_quad1
  "Unit converter from joule to quads "
