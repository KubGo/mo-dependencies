...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_inH2O to_inH2O
  "Unit converter from pascal to inch of water gauge (at 60 degF) "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_inH2O to_inH2O1
  "Unit converter from pascal to inch of water gauge (at 60 degF) "
