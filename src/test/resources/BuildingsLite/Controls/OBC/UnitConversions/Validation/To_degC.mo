...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_degC to_degC
  "Unit converter from kelvin to degree Celsius "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_degC to_degC1
  "Unit converter from kelvin to degree Celsius "
