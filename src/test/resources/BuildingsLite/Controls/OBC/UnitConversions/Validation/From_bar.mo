...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.From_bar from_bar
  "Unit converter from bar to pascal "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.From_bar from_bar1
  "Unit converter from bar to pascal "
