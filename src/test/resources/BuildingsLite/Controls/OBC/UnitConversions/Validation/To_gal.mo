...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_gal to_gal
  "Unit converter from cubic meter to gallon "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_gal to_gal1
  "Unit converter from cubic meter to gallon "
