...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.From_inH2O from_inH2O
  "Unit converter from inch of water gauge (at 60 degF) to pascal "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.From_inH2O from_inH2O1
  "Unit converter from inch of water gauge (at 60 degF) to pascal "
