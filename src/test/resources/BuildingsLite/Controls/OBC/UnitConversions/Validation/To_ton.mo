...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_ton to_ton
  "Unit converter from watt to ton of refrigeration "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_ton to_ton1
  "Unit converter from watt to ton of refrigeration "
