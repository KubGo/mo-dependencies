...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_cfm to_cfm
  "Unit converter from cubic meters per second to cubic feet per minute "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_cfm to_cfm1
  "Unit converter from cubic meters per second to cubic feet per minute "
