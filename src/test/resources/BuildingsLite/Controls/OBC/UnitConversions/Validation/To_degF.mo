...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.To_degF to_degF
  "Unit converter from kelvin to degree Fahrenheit "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.To_degF to_degF1
  "Unit converter from kelvin to degree Fahrenheit "
