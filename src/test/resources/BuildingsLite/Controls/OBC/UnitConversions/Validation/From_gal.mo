...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.From_gal from_gal
  "Unit converter from gallon to cubic meter "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.From_gal from_gal1
  "Unit converter from gallon to cubic meter "
