...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.From_hp from_hp
  "Unit converter from horsepower to watt "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.From_hp from_hp1
  "Unit converter from horsepower to watt "
