within BuildingsLite.Controls.OBC.UnitConversions.Validation;
...
protected
  ...
  BuildingsLite.Controls.OBC.UnitConversions.From_BtuPerHour from_BtuPerHour
  "Unit converter from British thermal units per hour to watt "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  BuildingsLite.Controls.OBC.UnitConversions.From_BtuPerHour from_BtuPerHour1
  "Unit converter from British thermal units per hour to watt "
    annotation (Placement(transformation(extent={{-20,-40},{0,-20}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant value(
    final k=kin)
    "Value to convert"
    annotation (Placement(transformation(extent={{-60,40},{-40,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant value1(
    final k=kin1)
    "Value to convert"
    annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant result(
    final k=kout)
    "Expected converted value"
    annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant result1(
    final k=kout1)
    "Expected converted value"
...
equation
  ...
  connect(from_BtuPerHour1.y, sub1.u1)
    annotation (Line(points={{2,-30},{8,-30},{8,-24},{18,-24}}, color={0,0,127}));
  connect(from_BtuPerHour.y, sub.u1)
