within BuildingsLite.Controls.OBC.UnitConversions;
block To_quad "Block that converts energy from joule to quads"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter conv(
