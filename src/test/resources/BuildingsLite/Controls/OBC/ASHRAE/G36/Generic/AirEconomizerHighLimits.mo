within BuildingsLite.Controls.OBC.ASHRAE.G36.Generic;
block AirEconomizerHighLimits "Specify the economizer high liimits"
  ...
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer ecoHigLimCon
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TRet(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput hRet(
    final unit="J/kg",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput TCut(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput hCut(
    final quantity="SpecificEnergy",
    final unit="J/kg")
...
protected
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fixDryBul(
    final k=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedDryBulb)
    "Fixed dry bulb"
    annotation (Placement(transformation(extent={{-520,1000},{-500,1020}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant difDryBul(
    final k=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialDryBulb)
    "Differential dry bulb"
    annotation (Placement(transformation(extent={{-520,960},{-500,980}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fixEntFixDryBul(
    final k=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb)
    "Fixed enthalpy with fixed dry bulb"
    annotation (Placement(transformation(extent={{-520,920},{-500,940}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant difEntFixDryBul(
    final k=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb)
    "Differential enthalpy with fixed dry bulb"
    annotation (Placement(transformation(extent={{-520,840},{-500,860}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash1A(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_1A)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 1A"
    annotation (Placement(transformation(extent={{-460,1220},{-440,1240}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash1B(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_1B)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 1B"
    annotation (Placement(transformation(extent={{-380,1220},{-360,1240}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash2A(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_2A)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 2A"
    annotation (Placement(transformation(extent={{-300,1220},{-280,1240}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash2B(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_2B)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 2B"
    annotation (Placement(transformation(extent={{-220,1220},{-200,1240}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash3A(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_3A)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 3A"
    annotation (Placement(transformation(extent={{-140,1220},{-120,1240}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash3B(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_3B)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 3B"
    annotation (Placement(transformation(extent={{-460,1160},{-440,1180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash3C(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_3C)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 3C"
    annotation (Placement(transformation(extent={{-380,1160},{-360,1180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash4A(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_4A)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 4A"
    annotation (Placement(transformation(extent={{-300,1160},{-280,1180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash4B(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_4B)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 4B"
    annotation (Placement(transformation(extent={{-220,1160},{-200,1180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash4C(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_4C)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 4C"
    annotation (Placement(transformation(extent={{-140,1160},{-120,1180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash5A(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_5A)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 5A"
    annotation (Placement(transformation(extent={{-460,1100},{-440,1120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash5B(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_5B)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 5B"
    annotation (Placement(transformation(extent={{-380,1100},{-360,1120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash5C(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_5C)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 5C"
    annotation (Placement(transformation(extent={{-300,1100},{-280,1120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash6A(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_6A)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 6A"
    annotation (Placement(transformation(extent={{-220,1100},{-200,1120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash6B(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_6B)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 6B"
    annotation (Placement(transformation(extent={{-140,1100},{-120,1120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash7(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_7)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 7"
    annotation (Placement(transformation(extent={{-460,1040},{-440,1060}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant ash8(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_8)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "ASHRAE zone 8"
    annotation (Placement(transformation(extent={{-380,1040},{-360,1060}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or23
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Zone 1b, 2b or 3b"
    annotation (Placement(transformation(extent={{-20,860},{0,880}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or1
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Zone 3c, 4b or 4c"
    annotation (Placement(transformation(extent={{-20,810},{0,830}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or2
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Zone 5b, 5c or 6b"
    annotation (Placement(transformation(extent={{-20,760},{0,780}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or4
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical or"
    annotation (Placement(transformation(extent={{40,800},{60,820}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or6
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Zone 7 or 8"
    annotation (Placement(transformation(extent={{-20,720},{0,740}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or7
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical or"
    annotation (Placement(transformation(extent={{80,800},{100,820}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or5
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Zone 5a or 6a"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and3
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,400},{240,420}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi1
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Cut off outdoor air temperature"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not1
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi4
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon1(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_1)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 1"
    annotation (Placement(transformation(extent={{-460,-60},{-440,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon2(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_2)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 2"
    annotation (Placement(transformation(extent={{-380,-60},{-360,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon3(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_3)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 3"
    annotation (Placement(transformation(extent={{-300,-60},{-280,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon4(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_4)
 if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 4"
    annotation (Placement(transformation(extent={{-220,-60},{-200,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon5(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_5)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 5"
    annotation (Placement(transformation(extent={{-460,-120},{-440,-100}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon6(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_6)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 6"
    annotation (Placement(transformation(extent={{-380,-120},{-360,-100}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon8(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_8)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 8"
    annotation (Placement(transformation(extent={{-220,-120},{-200,-100}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon9(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_9)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 9"
    annotation (Placement(transformation(extent={{-460,-180},{-440,-160}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon10(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_10)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 10"
    annotation (Placement(transformation(extent={{-380,-180},{-360,-160}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon11(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_11)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 11"
    annotation (Placement(transformation(extent={{-300,-180},{-280,-160}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon12(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_12)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 12"
    annotation (Placement(transformation(extent={{-220,-180},{-200,-160}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon13(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_13)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 13"
    annotation (Placement(transformation(extent={{-460,-240},{-440,-220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon14(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_14)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 14"
    annotation (Placement(transformation(extent={{-380,-240},{-360,-220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon15(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_15)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 15"
    annotation (Placement(transformation(extent={{-300,-240},{-280,-220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titZon16(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Zone_16)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Title 24, zone 16"
    annotation (Placement(transformation(extent={{-220,-240},{-200,-220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or16
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Zone 1, 3"
    annotation (Placement(transformation(extent={{-140,-280},{-120,-260}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or35
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Zone 11, 12"
    annotation (Placement(transformation(extent={{-140,-330},{-120,-310}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or36
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Zone 14, 15"
    annotation (Placement(transformation(extent={{-140,-380},{-120,-360}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or20
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Zone 1, 3, 5, or 11 to 16"
    annotation (Placement(transformation(extent={{20,-340},{40,-320}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and5
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-340},{220,-320}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi5
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{480,-340},{500,-320}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con5(
    final k=273.15 + 24)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{200,-300},{220,-280}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or19
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Zone 2, 4 or 10"
    annotation (Placement(transformation(extent={{-40,-430},{-20,-410}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and6
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-430},{220,-410}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi6
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{440,-430},{460,-410}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con6(
    final k=273.15 + 23)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{200,-390},{220,-370}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or21
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Zone 6, 8 or 9"
    annotation (Placement(transformation(extent={{-40,-510},{-20,-490}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and7
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-510},{220,-490}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con7(
    final k=273.15 + 22)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{200,-470},{220,-450}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi7
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{400,-510},{420,-490}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con8(
    final k=273.15 + 21)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{200,-550},{220,-530}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi8
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{360,-590},{380,-570}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and8
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-660},{220,-640}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi9
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{480,-640},{500,-620}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and9
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-740},{220,-720}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi10
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{440,-740},{460,-720}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar(
    final p=-1) if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{280,-700},{300,-680}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi11
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{400,-820},{420,-800}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and10
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-820},{220,-800}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar1(
    final p=-2)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{280,-780},{300,-760}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi12
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{360,-900},{380,-880}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar2(
    final p=-3)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{280,-860},{300,-840}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con9(
    final k=273.15 + 24)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off temperature"
    annotation (Placement(transformation(extent={{200,-1240},{220,-1220}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(
    final realTrue=66000)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Outdoor air enthalpy cutoff"
    annotation (Placement(transformation(extent={{220,-20},{240,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant titEngSta(
    final k=eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Check if Title 24 energy standard is used"
    annotation (Placement(transformation(extent={{-460,-720},{-440,-700}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and11
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
  ...
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes1(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not2
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical not"
    annotation (Placement(transformation(extent={{-320,-680},{-300,-660}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con10(
    final k=0)
    if (eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
     and not ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb)
    "Constant 0"
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con11(
    final k=0)
    if not (ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialDryBulb
     or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedDryBulbWithDifferentialDryBulb)
    "Constant 0"
    annotation (Placement(transformation(extent={{-220,600},{-200,620}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fixDryBulDifDryBul(
    final k=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedDryBulbWithDifferentialDryBulb)
    "Fixed dry bulb with differential dry bulb"
    annotation (Placement(transformation(extent={{-520,880},{-500,900}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and12
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,270},{240,290}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min1
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Smaller input"
    annotation (Placement(transformation(extent={{220,310},{240,330}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi13
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{300,270},{320,290}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and13
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,180},{240,200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min2
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Smaller input"
    annotation (Placement(transformation(extent={{220,220},{240,240}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con12(
    final k=273.15 + 21)
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Cut off temperature"
    annotation (Placement(transformation(extent={{20,250},{40,270}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi14
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{260,180},{280,200}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and14
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,120},{240,140}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not3
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical not"
    annotation (Placement(transformation(extent={{300,120},{320,140}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes2(
 ...
 if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and15
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-990},{220,-970}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi15
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{480,-990},{500,-970}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min3
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Smaller input"
    annotation (Placement(transformation(extent={{360,-960},{380,-940}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and16
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-1060},{220,-1040}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min4
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Smaller input"
    annotation (Placement(transformation(extent={{360,-1030},{380,-1010}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi16
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{440,-1060},{460,-1040}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and17
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-1130},{220,-1110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi17
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{440,-1130},{460,-1110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min5
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Smaller input"
    annotation (Placement(transformation(extent={{360,-1100},{380,-1080}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi18
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{440,-1200},{460,-1180}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min6
    if eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Smaller input"
    annotation (Placement(transformation(extent={{360,-1170},{380,-1150}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant noAshCli(
    final k=ashCliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Not_Specified)
    "No ASHRAE climate zone"
    annotation (Placement(transformation(extent={{320,940},{340,960}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant noTit24Cli(
    final k=tit24CliZon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Not_Specified)
    "No Title 24 climate zone"
    annotation (Placement(transformation(extent={{320,900},{340,920}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And noCli
    "Climate zone is not specified"
    annotation (Placement(transformation(extent={{360,940},{380,960}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not4
    "Logical not"
    annotation (Placement(transformation(extent={{400,940},{420,960}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes3(
