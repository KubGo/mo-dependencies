...
block SupplyAirTemperature
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin5(
    amplitude=0.5,
    freqHz=1/100,
    offset=0.5)
    "Cooling loop signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin6(
    amplitude=20,
    freqHz=1/50,
    offset=273.15 + 23)
    "Supply air temperature signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin8(
    amplitude=0.5,
    freqHz=1/100,
    offset=0.5)
    "Heating loop signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin4(
    amplitude=20,
    freqHz=1/50,
    offset=273.15 + 23)
    "Supply air temperature signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant con10(
    k=true)
    "Boolean fale signal"
