within BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.Title24;
block Setpoints
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uOpeMod if have_CO2Sen
    "Zone operation mode"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonOccOAMin(
    final k=VOccMin_flow)
    "Zone minimum outdoor airflow for occupants"
    annotation (Placement(transformation(extent={{-280,320},{-260,340}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonAreOAMin(
    final k=VAreMin_flow)
    "Zone minimum outdoor airflow for building area"
    annotation (Placement(transformation(extent={{-280,270},{-260,290}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonAbsMin
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not notOcc
    "Not occupied"
    annotation (Placement(transformation(extent={{-180,200},{-160,220}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonAbsMin1
    "Zone absolute outdoor air minimum flow"
    annotation (Placement(transformation(extent={{-20,200},{0,220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant havCO2Sen(
    final k=have_CO2Sen)
    "Check if the zone has CO2 sensor"
    annotation (Placement(transformation(extent={{-260,160},{-240,180}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonAbsMin2
    "Zone absolute outdoor air minimum flow"
    annotation (Placement(transformation(extent={{-80,160},{-60,180}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonDesMin
    "Zone design outdoor air minimum flow"
    annotation (Placement(transformation(extent={{40,120},{60,140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonDesMin1
    "Zone design outdoor air minimum flow"
    annotation (Placement(transformation(extent={{-20,100},{0,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonOccMin if not have_SZVAV
    "Zone occupied minimum flow"
    annotation (Placement(transformation(extent={{240,50},{260,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch zonOccMin1 if not have_SZVAV
    "Zone occupied minimum flow"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal inOccMod if have_CO2Sen
    "Check if it is in occupied mode"
    annotation (Placement(transformation(extent={{-220,10},{-200,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar(final p=-200)
    if have_CO2Sen
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer(final k=0)
    "Constant zero"
    annotation (Placement(transformation(extent={{-280,-110},{-260,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant one(final k=1)
    "Constant one"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line zonOccMin2
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line zonOccMin4 if have_SZVAV
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant one2(final k=1)
    if not have_CO2Sen "Constant one"
    annotation (Placement(transformation(extent={{-80,-270},{-60,-250}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer3(final k=0)
    if not have_CO2Sen
    "Constant zero"
