...
model TimeSuppressionPositiveStartTime
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupCooReq
    "Time suppression for generating cooling request"
    annotation (Placement(transformation(extent={{40,70},{60,90}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupAla(
    final chaRat=1080,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp cooSet(
    final height=5,
    final duration=600,
    final offset=295.15,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
