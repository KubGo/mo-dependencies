...
block SystemRequests
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uVal(
    final min=0,
    final max=1,
    final unit="1") if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
...
equation
  ...
  connect(booToInt2.y, intSwi3.u3) annotation (Line(points={{22,-220},{80,-220},
          {80,-188},{98,-188}}, color={255,127,0}));
  connect(uVal, greThr6.u) annotation (Line(points={{-200,-220},{-160,-220},
