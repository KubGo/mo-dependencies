...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yFanMinSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yFanMaxSig(
    final k=supFanSpe_max) "Maximum supply fan speed"
    annotation (Placement(transformation(extent={{-140,80},{-120,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yDam_VOutMin_minSpeSig(
    final k=outDamMinFloMinSpe)
    "OA damper position to supply minimum outdoor airflow at minimum fan speed"
    annotation (Placement(transformation(extent={{-140,120},{-120,140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yDam_VOutDes_minSpeSig(
    final k=outDamDesFloMinSpe)
    "OA damper position to supply design outdoor airflow at minimum fan speed"
    annotation (Placement(transformation(extent={{-140,-30},{-120,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yDam_VOutMin_maxSpeSig(
    final k=outDamMinFloMaxSpe)
    "OA damper position to supply minimum outdoor airflow at maximum fan speed"
    annotation (Placement(transformation(extent={{-140,150},{-120,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yDam_VOutDes_maxSpeSig(
    final k=outDamDesFloMaxSpe)
    "OA damper position to supply design outdoor airflow at maximum fan speed"
    annotation (Placement(transformation(extent={{-140,10},{-120,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minVOutSig(
    final k=VOutMin_flow) "Minimum outdoor airflow rate"
    annotation (Placement(transformation(extent={{20,170},{40,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant desVOutSig(
    final k=VOutDes_flow) "Design outdoor airflow rate"
    annotation (Placement(transformation(extent={{40,90},{60,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line yDam_VOutMin_curSpe(
    final limitBelow=true,
    final limitAbove=true)
    "Calculates OA damper position required to supply minimum outdoor airflow at current fan speed"
    annotation (Placement(transformation(extent={{40,130},{60,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line yDam_VOutDes_curSpe(
    final limitBelow=true,
    final limitAbove=true)
    "Calculates OA damper position required to supply design outdoor airflow at current fan speed"
    annotation (Placement(transformation(extent={{40,40},{60,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line minVOutSetCurFanSpePos(
    final limitBelow=true,
    final limitAbove=true)
    "Calculates OA damper position required to supply minimum outdoor airflow setpoint at current fan speed"
    annotation (Placement(transformation(extent={{100,110},{120,130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch enaDis
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch enaDis1
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage1)
    "Freeze protection stage 1"
    annotation (Placement(transformation(extent={{-140,-120},{-120,-100}})));
  BuildingsLite.Controls.OBC.CDL.Integers.LessEqual intLesEqu
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu1 "Check if operation mode is occupied"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch enaDis2
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold noZerMin(
    final t=floHys,
