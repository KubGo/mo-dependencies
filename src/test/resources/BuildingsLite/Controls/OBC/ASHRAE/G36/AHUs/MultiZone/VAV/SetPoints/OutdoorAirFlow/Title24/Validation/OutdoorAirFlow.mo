within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.Validation;
model OutdoorAirFlow
  "Validate the sequences of setting AHU level minimum outdoor airflow rate"

  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU
    ahu(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone zonToAhu(
    final nZon=nZon,
    final nGro=nGro,
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonAbsMinFlo[nZon](
      final k={0.1,0.12,0.2,0.15}) "Zone absolute minimum flow"
    annotation (Placement(transformation(extent={{-80,10},{-60,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonDesMinFlo[nZon](
      final k={0.15,0.2,0.25,0.3}) "Adjusted area component flow"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant co2Loo[nZon](
...
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone</a>,
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU\">
