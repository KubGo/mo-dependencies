within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations;
block ReturnFan
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant damMinLimSig(
    final k=uMin)
    "Minimal control loop signal for the relief and return air damper position"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant damMaxLimSig(
    final k=uMax)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line relDamPos(
    final limitBelow=true,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits</a>.
