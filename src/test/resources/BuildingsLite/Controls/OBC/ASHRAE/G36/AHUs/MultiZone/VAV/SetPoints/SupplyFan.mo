...
block SupplyFan  "Block to control multi zone VAV AHU supply fan"
  ...
  parameter Real maxRes(
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(group="Trim and respond for pressure setpoint"));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI "Type of controller"
    annotation (__cdl(ValueInReference=false),
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond staPreSetRes(
    final iniSet=iniSet,
    final minSet=minSet,
    final maxSet=maxSet,
    final delTim=delTim,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conSpe(
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zerSpe(k=0)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or or2 if have_perZonRehBox
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.coolDown)
    "Cool down mode"
    annotation (Placement(transformation(extent={{-120,120},{-100,140}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt4(
    k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.warmUp)
    "Warm-up mode"
    annotation (Placement(transformation(extent={{-120,0},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.setUp)
    "Set up mode"
    annotation (Placement(transformation(extent={{-120,90},{-100,110}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied)
    "Occupied mode"
    annotation (Placement(transformation(extent={{-120,60},{-100,80}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt3(
    k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.setBack)
    "Set back mode"
