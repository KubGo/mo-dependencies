within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Subsequences;
block SystemRequests
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VDis_flow_Set(
    final min=0,
    final unit="m3/s",
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr13(
    final t=looHys,
    final h=0.5*looHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulInt2
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulInt1
