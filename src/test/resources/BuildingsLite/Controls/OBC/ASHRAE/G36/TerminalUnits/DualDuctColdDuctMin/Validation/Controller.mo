within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Validation;
model Controller
  "Validation of model that controls dual-duct unit with minimum cold duct control"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Controller duaDucCon(
...
equation
  ...
  connect(occ.y, duaDucCon.u1Occ) annotation (Line(points={{-98,140},{44,140},{44,
          69},{98,69}},    color={255,0,255}));
  ...
  connect(reaToInt3.y, duaDucCon.oveCooDamPos) annotation (Line(points={{-18,-140},
          {68,-140},{68,43},{98,43}}, color={255,127,0}));
  ...
  connect(reaToInt4.y, duaDucCon.oveHeaDamPos) annotation (Line(points={{-18,-170},
          {72,-170},{72,41},{98,41}}, color={255,127,0}));
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
