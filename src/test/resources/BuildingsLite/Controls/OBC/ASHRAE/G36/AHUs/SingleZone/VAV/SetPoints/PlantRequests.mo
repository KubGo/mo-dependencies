...
block PlantRequests
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSupCoo(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSupHeaEco(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
...
equation
  ...
  connect(cooSupTemDif.y, greThr.u)
    annotation (Line(points={{-138,200},{-82,200}}, color={0,0,127}));
