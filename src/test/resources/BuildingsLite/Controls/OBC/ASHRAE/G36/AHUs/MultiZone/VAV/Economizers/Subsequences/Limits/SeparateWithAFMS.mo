...
block SeparateWithAFMS
  ...
  parameter Real TiMinOA(
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Minimum OA control",
      enable=minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or
             minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdMinOA(
    final unit="s",
    final quantity="Time")=0.1 "Time constant of derivative block"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Minimum OA control",
      enable=minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or
             minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conMinOA(
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And enaMinCon
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line minOutDamPos(
    final limitBelow=true,
    final limitAbove=true)
    "Minimum outdoor air damper position"
    annotation (Placement(transformation(extent={{160,230},{180,250}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minOutDamPhyPosMinSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minOutDamPhyPosMaxSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not cloMinDam
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line maxRetDamPos(
    final limitBelow=true,
    final limitAbove=true)
