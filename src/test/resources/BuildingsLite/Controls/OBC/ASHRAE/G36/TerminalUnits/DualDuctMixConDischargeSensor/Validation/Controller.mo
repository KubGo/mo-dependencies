within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Validation;
model Controller
  "Validation of model that controls dual-duct unit using mixing control with discharge flow sensor"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Controller duaDucCon(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin VDis_flow(
    final offset=1.2,
    final amplitude=0.6,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
