...
block ActiveAirFlow
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VOccMin_flow(
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    "Occupied minimum airflow setpoint"
    annotation (Placement(transformation(extent={{-240,20},{-200,60}}),
        iconTransformation(extent={{-140,-80},{-100,-40}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VActCooMax_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VActCooMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VActMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VActHeaMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VActHeaMax_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant setUpMod(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.setUp)
    "Setup mode"
    annotation (Placement(transformation(extent={{-160,0},{-140,20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or3
    "Check if it is in occupied, cooldown, or setup mode"
    annotation (Placement(transformation(extent={{-20,160},{0,180}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal actCooMax(
    final realTrue=VCooMax_flow)
    "Active cooling maximum flow"
    annotation (Placement(transformation(extent={{140,160},{160,180}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal occModInd(
    final realTrue=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal heaMinFlo(
    final realTrue=VHeaMin_flow)
    "Heating minimum flow when input is true"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal heaMaxFlo(
    final realTrue=VHeaMax_flow)
    "Heating maximum flow when input is true"
    annotation (Placement(transformation(extent={{40,-50},{60,-30}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal cooMaxFlo(
    final realTrue=VCooMax_flow)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal heaMaxFlo1(
    final realTrue=VHeaMax_flow)
    "Heating maximum flow when input is true"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant setBacMod(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.setBack)
    "Setback mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal ifOcc
    "Check if current operation mode is occupied mode"
    annotation (Placement(transformation(extent={{-120,180},{-100,200}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal ifCooDow
    "Check if current operation mode is cooldown mode"
    annotation (Placement(transformation(extent={{-120,80},{-100,100}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal ifSetUp
    "Check if current operation mode is setup mode"
    annotation (Placement(transformation(extent={{-120,0},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal ifWarUp
    "Check if current operation mode is warm-up mode"
    annotation (Placement(transformation(extent={{-120,-90},{-100,-70}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal ifSetBac
    "Check if current operation mode is setback mode"
    annotation (Placement(transformation(extent={{-120,-200},{-100,-180}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaMaxAir(
    final k=VHeaMax_flow)
    "Heating maximum airflow"
    annotation (Placement(transformation(extent={{-100,-160},{-80,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaMinAir(
