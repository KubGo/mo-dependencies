...
block Alarms "Zone level alarms"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1ResSet
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not notSupTemAla
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal levThrHig
    "Check if generating level 3 high temperature alarm"
    annotation (Placement(transformation(extent={{120,210},{140,230}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant levTwo(
    final k=2) "Level 2 alarm"
    annotation (Placement(transformation(extent={{0,-70},{20,-50}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant levThr(
    final k=3) "Level 3 alarm"
    annotation (Placement(transformation(extent={{0,-30},{20,-10}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert higTemAla2(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal levTwoHig
    "Check if generating level 2 high temperature alarm"
    annotation (Placement(transformation(extent={{120,170},{140,190}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert lowTemAla3(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal levThrLow
    "Check if generating level 3 low temperature alarm"
    annotation (Placement(transformation(extent={{120,90},{140,110}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert lowTemAla2(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal levTwoLow
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and5 if have_CO2Sen
    "Check if it has been in unoccupied mode for long time and CO2 concentration exceeds threshold"
    annotation (Placement(transformation(extent={{-40,-130},{-20,-110}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert lowTemAla4(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not5 if have_CO2Sen "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not6 if have_CO2Sen "Logical not"
    annotation (Placement(transformation(extent={{0,-230},{20,-210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and6 if have_CO2Sen
    "Check if it has been in unoccupied mode for long time and CO2 concentration exceeds threshold"
  ...
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert lowTemAla5(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Add temAla
    "Zone temperature alarm"
    annotation (Placement(transformation(extent={{140,130},{160,150}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add co2Ala if have_CO2Sen
    "CO2 concentration alarm"
    annotation (Placement(transformation(extent={{140,-190},{160,-170}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tenMinDur(
    final delayTime=timChe)
    "Check if it has been over threshold time"
    annotation (Placement(transformation(extent={{-40,90},{-20,110}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tenMinDur1(
    final delayTime=timChe)
    "Check if it has been over threshold time"
    annotation (Placement(transformation(extent={{-40,50},{-20,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tenMinDur2(
    final delayTime=timChe)
    "Check if it has been over threshold time"
    annotation (Placement(transformation(extent={{-40,210},{-20,230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tenMinDur3(
    final delayTime=timChe)
    "Check if it has been over threshold time"
    annotation (Placement(transformation(extent={{-40,170},{-20,190}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant cooDowMod(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.coolDown)
    "Cool down mode"
    annotation (Placement(transformation(extent={{-180,-30},{-160,-10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant warUpMod(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu1 if have_CO2Sen
    "Check if current operation mode is warmup mode"
    annotation (Placement(transformation(extent={{-120,-130},{-100,-110}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant unoMod(
