...
equation
  ...
  connect(oveDamPos, intEqu3.u1)
    annotation (Line(points={{-160,150},{-82,150}}, color={255,127,0}));
  connect(oveDamPos, intEqu4.u1) annotation (Line(points={{-160,150},{-130,150},
          {-130,110},{-82,110}}, color={255,127,0}));
  ...
  connect(or2.y, swi1.u2)
    annotation (Line(points={{22,90},{78,90}}, color={255,0,255}));
  connect(uDam, swi1.u3) annotation (Line(points={{-160,60},{60,60},{60,82},{78,
          82}}, color={0,0,127}));
  connect(swi1.y, yDam)
    annotation (Line(points={{102,90},{160,90}}, color={0,0,127}));
