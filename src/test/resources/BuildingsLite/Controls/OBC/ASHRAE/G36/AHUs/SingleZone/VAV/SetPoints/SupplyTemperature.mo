...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Average aveZonSet
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line heaSupTemDif
    "Supply air temperature difference when it is in heating state"
    annotation (Placement(transformation(extent={{60,70},{80,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant temOnePoi(
    final k=temPoiOne)
    "Temperature control point one in x-axis of control map"
    annotation (Placement(transformation(extent={{-140,30},{-120,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxSupTem(
    final k=TSup_max)
    "Highest heating supply air temperature"
    annotation (Placement(transformation(extent={{-100,30},{-80,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant temTwoPoi(
    final k=temPoiTwo)
    "Temperature control point two in x-axis of control map"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line cooSupTem
    "Supply air temperature when it is in cooling state"
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant supCooTem(
    final k=TSup_min)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line cooSupTem1
    "Supply air temperature when it is in cooling state"
    annotation (Placement(transformation(extent={{60,-120},{80,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant temThrPoi(
    final k=temPoiThr)
    "Temperature control point three in x-axis of control map"
    annotation (Placement(transformation(extent={{-60,-100},{-40,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant temFouPoi(
    final k=temPoiFou)
    "Temperature control point four in x-axis of control map"
    annotation (Placement(transformation(extent={{-60,-150},{-40,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max cooSet
    "Cooling setpoint temperature"
    annotation (Placement(transformation(extent={{120,-100},{140,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add heaEcoSet
