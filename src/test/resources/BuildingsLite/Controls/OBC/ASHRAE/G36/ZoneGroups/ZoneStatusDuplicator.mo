...
block ZoneStatusDuplicator "Duplicate zone status output"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput zonOcc[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1Occ[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput tNexOcc[nZon](
    final unit=fill("s", nZon),
    final quantity=fill("Time", nZon))
    "Time to next occupied period"
    annotation (Placement(transformation(extent={{-80,-20},{-40,20}}),
      iconTransformation(extent={{-140,130},{-100,170}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCooTim[nZon](
    final unit=fill("s", nZon),
    final quantity=fill("Time", nZon))
    "Cool down time"
    annotation (Placement(transformation(extent={{-80,-60},{-40,-20}}),
      iconTransformation(extent={{-140,90},{-100,130}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uWarTim[nZon](
    final unit=fill("s", nZon),
    final quantity=fill("Time", nZon))
    "Warm-up time"
    annotation (Placement(transformation(extent={{-80,-100},{-40,-60}}),
      iconTransformation(extent={{-140,70},{-100,110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1OccHeaHig[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HigOccCoo[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1UnoHeaHig[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput THeaSetOff[nZon](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1EndSetBac[nZon]
    "True when the zone could end the setback mode"
    annotation (Placement(transformation(extent={{-80,-300},{-40,-260}}),
        iconTransformation(extent={{-140,-70},{-100,-30}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HigUnoCoo[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TCooSetOff[nZon](
    final unit=fill("K", nZon),
    displayUnit=fill("degC", nZon),
    final quantity=fill("ThermodynamicTemperature", nZon))
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1EndSetUp[nZon]
    "True when the zone could end the setup mode"
    annotation (Placement(transformation(extent={{-80,-420},{-40,-380}}),
        iconTransformation(extent={{-140,-150},{-100,-110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TZon[nZon](
    final unit=fill("K", nZon),
    displayUnit=fill("degC", nZon),
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1Win[nZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1ZonOcc[nZonGro,nZon]
    "True when the zone is set to be occupied due to the override"
    annotation (Placement(transformation(extent={{40,60},{80,100}}),
        iconTransformation(extent={{100,170},{140,210}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1Occ[nZonGro,nZon]
    "True when the zone is occupied according to the occupancy schedule"
    annotation (Placement(transformation(extent={{40,20},{80,60}}),
        iconTransformation(extent={{100,150},{140,190}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput ytNexOcc[nZonGro, nZon](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yCooTim[nZonGro,nZon](
    final unit=fill("s", nZonGro, nZon),
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yWarTim[nZonGro,nZon](
    final unit=fill("s", nZonGro, nZon),
    final quantity=fill("Time", nZonGro, nZon)) "Warm-up time"
    annotation (Placement(transformation(extent={{40,-100},{80,-60}}),
      iconTransformation(extent={{100,70},{140,110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1OccHeaHig[nZonGro,nZon]
    "True when the zone temperature is lower than the occupied heating setpoint"
    annotation (Placement(transformation(extent={{40,-140},{80,-100}}),
        iconTransformation(extent={{100,30},{140,70}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1HigOccCoo[nZonGro,nZon]
    "True when the zone temperature is higher than the occupied cooling setpoint"
    annotation (Placement(transformation(extent={{40,-180},{80,-140}}),
        iconTransformation(extent={{100,10},{140,50}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1UnoHeaHig[nZonGro,nZon]
    "True when the zone temperature is lower than the unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{40,-220},{80,-180}}),
        iconTransformation(extent={{100,-30},{140,10}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yTHeaSetOff[nZonGro, nZon](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1EndSetBac[nZonGro,nZon]
    "True when the zone could end the setback mode"
    annotation (Placement(transformation(extent={{40,-300},{80,-260}}),
        iconTransformation(extent={{100,-70},{140,-30}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1HigUnoCoo[nZonGro,nZon]
    "True when the zone temperature is higher than its unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{40,-330},{80,-290}}),
        iconTransformation(extent={{100,-110},{140,-70}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yTCooSetOff[nZonGro, nZon](
    final unit=fill("K", nZonGro, nZon),
    displayUnit=fill("degC", nZonGro, nZon),
    final quantity=fill("ThermodynamicTemperature", nZonGro, nZon))
    "Zone unoccupied cooling setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1EndSetUp[nZonGro,nZon]
    "True when the zone could end the setup mode"
    annotation (Placement(transformation(extent={{40,-420},{80,-380}}),
        iconTransformation(extent={{100,-150},{140,-110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yTZon[nZonGro, nZon](
    final unit=fill("K", nZonGro, nZon),
    displayUnit=fill("degC", nZonGro, nZon),
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1Win[nZonGro,nZon]
...
protected
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator zonOccDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,70},{10,90}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uOccDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorReplicator tNexOccDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorReplicator uCooTimDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-50},{10,-30}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorReplicator uWarTimDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-90},{10,-70}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uOccHeaHigDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-130},{10,-110}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uHigOccCooDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-170},{10,-150}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uUnoHeaHigDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-210},{10,-190}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorReplicator THeaSetOffDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-250},{10,-230}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uEndSetBacDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-290},{10,-270}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uHigUnoCooDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-320},{10,-300}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorReplicator TCooSetOffDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-380},{10,-360}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uEndSetUpDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
    annotation (Placement(transformation(extent={{-10,-410},{10,-390}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorReplicator TZonDup(
    final nin=nZon,
    final nout=nZonGro) "Duplicator"
    annotation (Placement(transformation(extent={{-10,-450},{10,-430}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator uWinDup(
    final nin=nZon,
    final nout=nZonGro)
    "Duplicator"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.GroupStatus\">
BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.GroupStatus</a>.
</p>
</html>"));
