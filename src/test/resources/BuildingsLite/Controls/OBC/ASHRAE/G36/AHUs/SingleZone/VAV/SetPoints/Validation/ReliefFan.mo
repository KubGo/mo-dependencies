...
model ReliefFan "Validate model for controlling relief fan"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.ReliefFan
    relFanCon(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse supFan(final width=0.8,
      final period=3600)
    "Supply fan status"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant supFan1(
    final k=true)
    "Supply fan status"
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp dpBui2(
    final height=3,
    final offset=11,
    final duration=1800)
    "Building static presure"
...
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.ReliefFan</a>
