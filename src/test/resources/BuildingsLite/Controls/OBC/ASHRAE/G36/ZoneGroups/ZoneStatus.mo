...
block ZoneStatus "Block that outputs zone temperature status"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yUnoHeaHig
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yHigUnoCoo
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea "Convert Boolean to Real number"
