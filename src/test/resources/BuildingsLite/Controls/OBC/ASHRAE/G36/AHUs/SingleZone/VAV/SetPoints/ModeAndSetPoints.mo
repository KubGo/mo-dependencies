...
block ModeAndSetPoints
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yOpeMod "Operation mode"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.OperationMode opeModSel(
    final nZon=1,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.Setpoints TZonSet(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatus zonSta(
    final bouLim=bouLim,
    final have_winSen=have_winSen,
    final uLow=uLow,
    final uHigh=uHigh) "Zone temperature status"
    annotation (Placement(transformation(extent={{-80,80},{-60,108}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger colZon
    "Check if the zone is cold"
    annotation (Placement(transformation(extent={{-40,-70},{-20,-50}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger hotZon
    "Check if the zone is hot"
    annotation (Placement(transformation(extent={{-40,-100},{-20,-80}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant winSta(
    final k=true)
    if not have_winSen
    "Assume window is closed when there is no windows status sensor"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant occSta(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not winOpe "Window is open"
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.OperationMode\">
BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.OperationMode</a>.
</p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.Setpoints\">
BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.Setpoints</a>.
</p>
<h4>Usage</h4>
<p>
