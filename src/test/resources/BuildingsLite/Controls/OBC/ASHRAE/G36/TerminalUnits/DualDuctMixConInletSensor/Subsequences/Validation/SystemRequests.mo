within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Validation;
model SystemRequests
  "Validation of model that generates system requests"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests sysReq(
    final floHys=0.01,
    final looHys=0.01,
    final damPosHys=0.01) "Block outputs system requests"
    annotation (Placement(transformation(extent={{60,-22},{80,18}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sine(
    final freqHz=1/7200,
    final offset=296.15)
    "Generate data for setpoint"
    annotation (Placement(transformation(extent={{-60,100},{-40,120}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.UnitDelay TZonCooSet(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp colDucAirSet(
    final height=0.9,
    final duration=7200,
    final offset=0.1) "Cold-duct airflow rate setpoint"
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp colDucAirRate(
    final duration=7200,
    final offset=0.1,
    final height=0.3) "Cold duct airflow rate"
    annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp colDamPos(
    final duration=3000,
    final height=-0.7,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sine1(
    final freqHz=1/7200,
    final offset=293.15)
    "Generate data for setpoint"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.UnitDelay TZonHeaSet(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp hotDucAirSet(
    final height=0.9,
    final duration=7200,
    final offset=0.1)
    "Hot-duct airflow rate setpoint"
    annotation (Placement(transformation(extent={{-60,-120},{-40,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp hotDucAirRate(
    final duration=7200,
    final offset=0.1,
    final height=0.3)
    "Hot duct airflow rate"
    annotation (Placement(transformation(extent={{-20,-140},{0,-120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp hotDamPos(
    final duration=3600,
    final height=0.7,
    startTime=3600)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnits/DualDuctMixConInletSensor/Subsequences/Validation/SystemRequests.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests\">
