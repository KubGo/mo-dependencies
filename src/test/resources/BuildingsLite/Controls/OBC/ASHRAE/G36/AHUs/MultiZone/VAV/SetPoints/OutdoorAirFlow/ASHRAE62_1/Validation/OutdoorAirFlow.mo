within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.Validation;
model OutdoorAirFlow
  "Validate the sequences of setting AHU level minimum outdoor airflow rate"

  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU
    ahu(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.SumZone zonToAhu(
    final nZon=nZon,
    final nGro=nGro,
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant opeMod[nGro](
    final k={BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied,
             BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.unoccupied})
    "AHU operation mode is Occupied"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant adjPopFlo[nZon](
    final k={0.1,0.12,0.2,0.15})
    "Adjusted population component flow"
    annotation (Placement(transformation(extent={{-80,30},{-60,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant adjAreFlo[nZon](
    final k={0.08,0.1,0.15,0.1})
    "Adjusted area component flow"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant priFlo[nZon](
    final k={0.3,0.25,0.4,0.5})
    "Measured zone primary airflow"
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minOAFlo[nZon](
    final k={0.2,0.21,0.35,0.25})
    "Minimum outdoor airflow"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outAirFlo(final k=1)
    "Adjusted area component flow"
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU\">
