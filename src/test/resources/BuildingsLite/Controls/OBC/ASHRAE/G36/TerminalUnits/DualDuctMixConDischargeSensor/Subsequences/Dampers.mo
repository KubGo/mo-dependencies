...
block Dampers
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VDis_flow_Set(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VColDucDis_flow_Set(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul3
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conCooDam(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch cooDamPos
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide VDisSet_flowNor1
    "Normalized setpoint for discharge volume flow rate"
    annotation (Placement(transformation(extent={{120,-180},{140,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conHeaDam(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide VDis_flowNor1
    "Normalized discharge volume flow rate"
    annotation (Placement(transformation(extent={{120,-220},{140,-200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch heaDamPos
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conZer1(
    final k=0)
    "Constant zero"
    annotation (Placement(transformation(extent={{-200,-180},{-180,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conOne1(
    final k=1)
    "Constant one"
    annotation (Placement(transformation(extent={{-120,-180},{-100,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line lin1
...
equation
  ...
  connect(lin.y, swi5.u3)
    annotation (Line(points={{-138,250},{10,250},{10,262},{18,262}},
      color={0,0,127}));
  ...
  connect(TZon, sub2.u2) annotation (Line(points={{-340,-60},{-280,-60},{-280,164},
          {-162,164}},      color={0,0,127}));
  connect(VActMin_flow, swi5.u1) annotation (Line(points={{-340,-20},{-20,-20},{
  ...
  connect(VActMin_flow, swi1.u1) annotation (Line(points={{-340,-20},{-20,-20},{
          -20,118},{18,118}}, color={0,0,127}));
  connect(swi1.y, swi.u3) annotation (Line(points={{42,110},{60,110},{60,232},{78,
          232}}, color={0,0,127}));
  connect(TZon, sub1.u1) annotation (Line(points={{-340,-60},{-280,-60},{-280,-124},
          {-202,-124}},       color={0,0,127}));
  connect(THotSup, sub1.u2) annotation (Line(points={{-340,-100},{-300,-100},{-300,
  ...
  connect(max1.y, mul3.u2) annotation (Line(points={{202,-20},{220,-20},{220,20},
  ...
  connect(VDis_flow, VDis_flowNor.u1) annotation (Line(points={{-340,140},{80,140},
          {80,156},{138,156}}, color={0,0,127}));
  connect(VDis_flowNor.y, conCooDam.u_m)
    annotation (Line(points={{162,150},{230,150},{230,188}}, color={0,0,127}));
  connect(u1CooAHU, conCooDam.trigger) annotation (Line(points={{-340,80},{224,
          80},{224,188}}, color={255,0,255}));
...
<code>uCoo</code> shall reset the supply airflow setpoint from the minimum <code>VActMin_flow</code> to
