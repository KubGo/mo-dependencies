...
model OperationMode "Validate block for selecting operation mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TZonHeaSetUno(
    final k=285.15)  "Unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{-120,-40},{-100,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TZonCooSetUno(
    final k=303.15)  "Unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-120,-110},{-100,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TZonHeaSetOcc(
    final k=293.15)  "Occupied heating setpoint"
    annotation (Placement(transformation(extent={{-160,70},{-140,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TZonCooSetOcc(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant cloWin(
    final k=0) "No window is open"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-150,0})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater lowThaHeaSet
    "True when the zone temperature is lower than the occupied heating setpoint"
    annotation (Placement(transformation(extent={{0,70},{20,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater higThaCooSet
    "True when the zone temperature is higher than the occupied cooling setpoint"
    annotation (Placement(transformation(extent={{0,20},{20,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greEqu2
    "True when the zone temperature is lower than unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{0,-40},{20,-20}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt "Convert boolean to integer"
    annotation (Placement(transformation(extent={{40,-40},{60,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greEqu3
    "True when the zone temperature is lower than unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{0,-110},{20,-90}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1 "Convert boolean to integer"
    annotation (Placement(transformation(extent={{40,-110},{60,-90}})));
  BuildingsLite.Controls.SetPoints.OccupancySchedule occSch "Occupancy schedule"
    annotation (Placement(transformation(extent={{-120,140},{-100,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract dif2
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract dif1
