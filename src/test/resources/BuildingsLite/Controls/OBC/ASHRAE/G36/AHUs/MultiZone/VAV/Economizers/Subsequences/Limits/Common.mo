...
block Common
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset damLimCon(
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minSigLim(
    final k=yMin)
    "Equals minimum controller output signal"
    annotation (Placement(transformation(extent={{-100,200},{-80,220}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxSigLim(
    final k=yMax)
    "Equals maximum controller output signal"
    annotation (Placement(transformation(extent={{-20,200},{0,220}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant sigFraForOutDam(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and3 "Logical and"
...
the AHU operation mode <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes</a> equals <code>occupied</code>.
