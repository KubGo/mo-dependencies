...
block ReliefFanGroup
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1SupFan[nSupFan]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uRelFanAla[nRelFan]
    "Relief fan current alarm index"
    annotation (Placement(transformation(extent={{-560,50},{-520,90}}),
        iconTransformation(extent={{-140,-50},{-100,-10}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1RelFan[nRelFan]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRelFan[nRelFan](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yDam[nRelFan](
    final unit=fill("1",nRelFan),
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat "Enable damper"
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanScalarReplicator booRep(
    final nout=nRelFan)
    "Boolean replicator"
    annotation (Placement(transformation(extent={{-160,140},{-140,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr1[nRelFan](
    final t=fill(0.5, nRelFan))
    "Check if a relief fan should be enabled"
    annotation (Placement(transformation(extent={{-160,170},{-140,190}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And enaDam[nRelFan]
    "Enable damper"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Timer upTim(
    final t=420)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre(
    final pre_u_start=true)
    "Break algebraic loop"
    annotation (Placement(transformation(extent={{-80,-140},{-60,-120}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea2[nRelFan]
    "Convert boolean to real"
    annotation (Placement(transformation(extent={{-460,-16},{-440,4}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub2[nRelFan]
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro1[nRelFan]
    "List of standby fans, along with their staging order"
    annotation (Placement(transformation(extent={{-320,10},{-300,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMin mulMin(nin=nRelFan)
    "Identify current order of staging"
    annotation (Placement(transformation(extent={{-120,-70},{-100,-50}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealScalarReplicator reaRep(
    final nout=nRelFan)
    "Replicate real number"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub1[nRelFan]
    "Identify next operating fan"
    annotation (Placement(transformation(extent={{-40,10},{-20,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr1[nRelFan](
    final t=fill(0.5, nRelFan))
    "Check if the input is less than threshold"
    annotation (Placement(transformation(extent={{-260,-20},{-240,0}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar[nRelFan](
    final p=fill(nRelFan + 1, nRelFan))
    "Add value to the input"
    annotation (Placement(transformation(extent={{-260,10},{-240,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi[nRelFan]
    "Switch input values"
    annotation (Placement(transformation(extent={{-220,-20},{-200,0}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs1[nRelFan]
    "Find absolute value"
    annotation (Placement(transformation(extent={{0,10},{20,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr2[nRelFan](
    final t=fill(0.5, nRelFan))
    "Identify next operating fan"
    annotation (Placement(transformation(extent={{40,10},{60,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or2[nRelFan]
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr3(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Timer dowTim(
    final t=300)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre1(
    final pre_u_start=true)
    "Break algebraic loop"
    annotation (Placement(transformation(extent={{0,-338},{20,-318}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro2[nRelFan]
    "List of operating fans, along with their staging order"
    annotation (Placement(transformation(extent={{-320,-220},{-300,-200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar1[nRelFan](
    final p=fill(nRelFan + 1, nRelFan))
    "Add value to the input"
    annotation (Placement(transformation(extent={{-260,-220},{-240,-200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr4[nRelFan](
    final t=fill(0.5, nRelFan))
    "Check if the input is less than threshold"
    annotation (Placement(transformation(extent={{-260,-250},{-240,-230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi1[nRelFan]
    "Switch input values"
    annotation (Placement(transformation(extent={{-220,-250},{-200,-230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMin mulMin1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub3[nRelFan]
    "Identify next operating fan"
    annotation (Placement(transformation(extent={{-40,-220},{-20,-200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs2[nRelFan]
    "Find absolute value"
    annotation (Placement(transformation(extent={{0,-220},{20,-200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr5[nRelFan](
    final t=fill(0.5, nRelFan))
    "Identify next fan to be off"
    annotation (Placement(transformation(extent={{40,-220},{60,-200}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealScalarReplicator reaRep1(
    final nout=nRelFan)
    "Replicate real number"
    annotation (Placement(transformation(extent={{-80,-250},{-60,-230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Xor xor[nRelFan]
    "Vector of relief fan after one fan being turned off"
    annotation (Placement(transformation(extent={{80,-220},{100,-200}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt[nRelFan]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{120,-30},{140,-10}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1[nRelFan]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{120,-70},{140,-50}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt2[nRelFan]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{120,-258},{140,-238}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu[nRelFan]
    "Check if newly started fan has become proven on"
    annotation (Placement(transformation(extent={{160,-30},{180,-10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd mulAnd(
    final nin=nRelFan)
    "Check if newly started fan has become proven on"
    annotation (Placement(transformation(extent={{200,-30},{220,-10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu1[nRelFan]
    "Check if newly turned off fan has become off"
    annotation (Placement(transformation(extent={{160,-250},{180,-230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd mulAnd2(
    final nin=nRelFan)
    "Check if newly turned off fan has become off"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.MultiOr mulOr(nin=nRelFan)
    "Check if there is any relief fan enabled, but may not be running"
    annotation (Placement(transformation(extent={{80,226},{100,246}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea4[nRelFan]
    "Convert boolean to real"
