...
block Reliefs
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uTSup(final unit="1")
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outDamMaxLimSig(
    final k=uOutDamMax) "Maximum control loop signal for the outdoor air damper"
    annotation (Placement(transformation(extent={{-100,-60},{-80,-40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retDamConMinLimSig(
    final k=uRetDamMin)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Min min "Overwrite due to freeze protection"
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max max "Overwrite due to freeze protection"
