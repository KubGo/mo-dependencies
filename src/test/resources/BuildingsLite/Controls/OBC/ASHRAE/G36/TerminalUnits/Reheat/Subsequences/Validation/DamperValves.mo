within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences.Validation;
model DamperValves
  "Validate model for controlling damper and valve position"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences.DamperValves damValFan1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VActCooMin_flow(
    final k=0.015) "Active cooling minimum flow"
    annotation (Placement(transformation(extent={{-60,120},{-40,140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VActHeaMin_flow(
    final k=0.015)
    "Active heating minimum flow"
    annotation (Placement(transformation(extent={{-100,-100},{-80,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VActHeaMax_flow(
    final k=0.06)
...
equation
  connect(VActMin_flow.y, damValFan1.VActMin_flow) annotation (Line(points={{-38,50},
          {44,50},{44,-86},{78,-86}}, color={0,0,127}));
  ...
  connect(VActCooMax_flow.y, damValFan1.VActCooMax_flow) annotation (Line(
        points={{-38,90},{56,90},{56,-81},{78,-81}},   color={0,0,127}));
  connect(uCoo.y, damValFan1.uCoo) annotation (Line(points={{-78,110},{60,110},{
          60,-79},{78,-79}}, color={0,0,127}));
  ...
  connect(VActCooMin_flow.y, damValFan1.VActCooMin_flow) annotation (Line(
        points={{-38,130},{64,130},{64,-76},{78,-76}}, color={0,0,127}));
  ...
  connect(booPul.y, damValFan1.u1Fan) annotation (Line(points={{42,-150},{60,
          -150},{60,-89},{78,-89}}, color={255,0,255}));
annotation (
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences.DamperValves\">
BBuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences.DamperValves</a>
