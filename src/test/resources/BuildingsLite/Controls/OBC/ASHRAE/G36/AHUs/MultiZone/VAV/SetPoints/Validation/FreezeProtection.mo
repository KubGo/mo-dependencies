within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.Validation;
model FreezeProtection
  "Validate model for implementing freeze protection"

  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.FreezeProtection
    frePro(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp heaCoiPos(
    final height=0.46,
    final offset=0.5,
    final duration=3600) "Heating coil position"
    annotation (Placement(transformation(extent={{-80,50},{-60,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minOutDamPos(
    final k=0.15)
    "Minimum outdoor air damper position"
    annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp retDamPos(
    final height=0.2,
    final offset=0.7,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp cooCoiPos(
    final height=0.2,
    final offset=0.5,
    final duration=3600) "Cooling coil position"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTem(
    final height=-4,
