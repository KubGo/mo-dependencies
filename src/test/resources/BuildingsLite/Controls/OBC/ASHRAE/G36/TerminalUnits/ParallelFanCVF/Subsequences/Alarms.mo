within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences;
block Alarms "Generate alarms of parallel fan-powered terminal unit with constant-volume fan"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HotPla
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not6
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch lowTemAla
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not7
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply proInt1
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Low discharge air temperature alarms"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaValAla2
    "Check if generating leak valve alarms, one of two stacked And blocks"
...
equation
  ...
  connect(and2.y, and14.u1)
    annotation (Line(points={{-18,410},{-2,410}}, color={255,0,255}));
  ...
  connect(u1TerFan, and10.u1) annotation (Line(points={{-260,20},{-42,20}},
                         color={255,0,255}));
  ...
  connect(and11.y, and17.u1)
    annotation (Line(points={{-18,90},{-2,90}}, color={255,0,255}));
  connect(and17.y, fanStaAla.u2)
    annotation (Line(points={{22,90},{138,90}}, color={255,0,255}));
  connect(and16.y, booToInt7.u)
    annotation (Line(points={{22,20},{78,20}}, color={255,0,255}));
  connect(and17.y, not10.u) annotation (Line(points={{22,90},{60,90},{60,60},{78,
          60}}, color={255,0,255}));
  connect(and16.y, not11.u) annotation (Line(points={{22,20},{60,20},{60,-10},{78,
          -10}}, color={255,0,255}));
  connect(and10.y, and16.u1)
    annotation (Line(points={{-18,20},{-2,20}}, color={255,0,255}));
  connect(truDel8.y, and16.u2) annotation (Line(points={{-98,-10},{-10,-10},{-10,
          12},{-2,12}}, color={255,0,255}));
  connect(truDel7.y, and17.u2) annotation (Line(points={{-138,60},{-10,60},{-10,
  ...
  connect(u1Fan, leaValAla1.u2) annotation (Line(points={{-260,140},{-220,140},
          {-220,-188},{-102,-188}}, color={255,0,255}));
  connect(cloVal.y, leaValAla1.u1) annotation (Line(points={{-178,-160},{-120,
          -160},{-120,-180},{-102,-180}}, color={255,0,255}));
  connect(gre2.y, leaValAla2.u2) annotation (Line(points={{-118,-210},{-40,-210},
          {-40,-188},{-22,-188}}, color={255,0,255}));
...
<p>
This block outputs alarms of parallel fan-powered terminal unit with constant volume fan.
The implementation is according to the Section 5.7.6 of ASHRAE Guideline 36, May 2020.
</p>
<h4>Low airflow</h4>
<ol>
<li>
