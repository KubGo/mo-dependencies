...
block Overrides "Software switches to override setpoints"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCooDam(
    final min=0,
    final unit="1") "Cooling damper commanded position"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uHeaDam(
    final min=0,
    final unit="1") "Heating damper commanded position"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal forZerFlo "Check if forcing zone airflow setpoint to zero"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add3 "Add up inputs"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal cloDam1(
    final realTrue=0)
    "Full closed damper position"
    annotation (Placement(transformation(extent={{-40,-150},{-20,-130}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal opeDam1(
    final realTrue=1)
    "Full open damper position"
    annotation (Placement(transformation(extent={{-40,-190},{-20,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add5
    "Add up inputs"
...
equation
  ...
  connect(uCooDam, swi1.u3) annotation (Line(points={{-160,-110},{60,-110},{60,
  ...
  connect(uHeaDam, swi2.u3) annotation (Line(points={{-160,-230},{60,-230},{60,
