...
block SystemRequests "Output system requests for parallel fan-powered terminal unit with constant-volume fan"
  ...
  parameter Real durTimDisAir(unit="s")=300
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(group="Duration times", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  parameter Real valPosHys(unit="1")
    ...
    annotation (Dialog(tab="Advanced", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput uAftSup
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VSet_flow(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uVal(
    final min=0,
    final max=1,
    final unit="1") if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased "Hot water valve position"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHeaValResReq if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Hot water reset requests"
    annotation (Placement(transformation(extent={{180,-160},{220,-120}}),
        iconTransformation(extent={{100,-50},{140,-10}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotWatPlaReq if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr4(
    final t=floHys,
    final h=0.5*floHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant thrCooResReq(
    final k=3)
    "Constant 3"
    annotation (Placement(transformation(extent={{100,270},{120,290}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant twoCooResReq(
    final k=2) "Constant 2"
    annotation (Placement(transformation(extent={{40,270},{60,290}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant thrPreResReq(
    final k=3)
    "Constant 3"
    annotation (Placement(transformation(extent={{100,70},{120,90}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant twoPreResReq(
    final k=2)
    "Constant 2"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi1
    "Output 2 or other request "
    annotation (Placement(transformation(extent={{100,170},{120,190}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch swi4
    "Output 3 or other request "
    annotation (Placement(transformation(extent={{140,50},{160,70}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch swi5
    "Output 2 or other request "
    annotation (Placement(transformation(extent={{100,-20},{120,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim1(
    final delayTime=durTimTem) "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{-20,210},{0,230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim2(
    final delayTime=durTimTem) "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{-20,170},{0,190}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim3(
    final delayTime=durTimFlo) "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greEqu(final h=floHys)
    "Check if discharge airflow is less than 50% of setpoint"
    annotation (Placement(transformation(extent={{-60,40},{-40,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greEqu1(final h=floHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar(
    final p=thrTDis_1) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Discharge temperature plus threshold"
    annotation (Placement(transformation(extent={{-140,-150},{-120,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar1(
    final p=thrTDis_2) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Discharge temperature plus threshold"
    annotation (Placement(transformation(extent={{-140,-190},{-120,-170}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant thrHeaResReq(
    final k=3) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Constant 3"
    annotation (Placement(transformation(extent={{100,-120},{120,-100}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant twoHeaResReq(
    final k=2) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Constant 2"
    annotation (Placement(transformation(extent={{40,-120},{60,-100}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi2
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi3
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Output 2 or other request "
    annotation (Placement(transformation(extent={{100,-190},{120,-170}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim4(
    final delayTime=durTimDisAir) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{0,-150},{20,-130}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim5(
    final delayTime=durTimDisAir) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{0,-190},{20,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr5(
    final t=0.95,
    final h=valPosHys) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr6(
    final t=0.95,
    final h=0.85) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if valve position is greater than 0.95"
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler sampler(
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler sampler1(
    final samplePeriod=samplePeriod)
    "Sample input signal, as the output signal will go to the trim and respond which also samples at samplePeriod"
    annotation (Placement(transformation(extent={{-160,-20},{-140,0}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler sampler2(
    final samplePeriod=samplePeriod)
    "Sample input signal, as the output signal will go to the trim and respond which also samples at samplePeriod"
    annotation (Placement(transformation(extent={{-160,70},{-140,90}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler sampler3(
    final samplePeriod=samplePeriod)
    "Sample input signal, as the output signal will go to the trim and respond which also samples at samplePeriod"
...
equation
  ...
  connect(greThr3.y, tim3.u) annotation (Line(points={{-98,-50},{-80,-50},{-80,
  ...
  connect(sampler2.y, gai1.u) annotation (Line(points={{-138,80},{-120,80},{
          -120,50},{-102,50}}, color={0,0,127}));
  connect(sampler2.y, gai2.u) annotation (Line(points={{-138,80},{-120,80},{
          -120,10},{-102,10}}, color={0,0,127}));
