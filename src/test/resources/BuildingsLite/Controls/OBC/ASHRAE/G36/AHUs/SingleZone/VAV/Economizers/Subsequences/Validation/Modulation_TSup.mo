...
model Modulation_TSup
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outDamPosMin(final k=0.1)
    "Minimum outdoor air damper position"
    annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outDamPosMax(final k=0.9)
    "Maximum outdoor air damper position"
    annotation (Placement(transformation(extent={{-80,10},{-60,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant RetDamPosMin(final k=0.1)
    "Minimum return air damper position"
    annotation (Placement(transformation(extent={{-80,-80},{-60,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant RetDamPosMax(final k=0.9)
    "Maximum return air damper position"
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));

  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanStatus(k=true)
    "Fan is on"
