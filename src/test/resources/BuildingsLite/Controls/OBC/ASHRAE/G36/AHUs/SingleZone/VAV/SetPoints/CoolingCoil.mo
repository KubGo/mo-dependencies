...
block CoolingCoil "Controller for cooling coil valve"
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController controllerTypeCooCoi=
  ...
  parameter Real TiCooCoi(final unit="s")=900
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Cooling coil loop signal",
    enable=controllerTypeCooCoi == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
        or controllerTypeCooCoi == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdCooCoi(final unit="s")=0.1
    "Time constant of derivative block for cooling coil control loop signal"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Cooling coil loop signal",
      enable=controllerTypeCooCoi == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or controllerTypeCooCoi == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));

  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSupCooSet(
    final unit="K",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uZonSta "Zone state"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conCoi(
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch switch "Switch to assign cooling coil control signal"
    annotation (Placement(transformation(extent={{72,-10},{92,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant const(k=0) "Cooling off mode"
    annotation (Placement(transformation(extent={{20,-50},{40,-30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and2 "Conditions for cooling state"
