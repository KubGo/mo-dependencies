...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHUs/MultiZone/VAV/SetPoints/Validation/FreezeProtection_Disable.mos"
        "Simulate and plot"),
...
for air handling unit serving multiple zones, when disabling the freeze protection.
</p>
</html>", revisions="<html>
<ul>
<li>
