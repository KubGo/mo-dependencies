within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Subsequences.Validation;
model SystemRequests
  "Validation of model that generates system requests"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Subsequences.SystemRequests sysReq(
    final floHys=0.01,
    final looHys=0.01,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp disAirRate(
    final duration=7200,
    final offset=0.1,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Subsequences.SystemRequests\">
