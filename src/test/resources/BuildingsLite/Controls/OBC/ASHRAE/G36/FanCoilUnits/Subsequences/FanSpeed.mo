...
block FanSpeed
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1FanPro
    "Fan proven on signal"
    annotation (Placement(transformation(extent={{-240,100},{-200,140}}),
      iconTransformation(extent={{-140,0},{-100,40}})));

  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput opeMod
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not notUno
    "Enable only if zone is not in unoccupied mode"
    annotation (Placement(transformation(extent={{-80,160},{-60,180}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiFanPro
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line linHeaFanSpe if have_heaCoi
    "Heating fan speed signal"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Line linCooFanSpe if have_cooCoi
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mulFanSpe
    "Multiply fan speed signal by fan enable signal"
    annotation (Placement(transformation(extent={{100,-150},{120,-130}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mulDeaSpe
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant concooSpe_max(
    final k=cooSpe_max) if have_cooCoi
    "Maximum cooling fan speed limit signal"
    annotation (Placement(transformation(extent={{-120,-100},{-100,-80}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conheaSpe_max(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conDeaFanSpe(
    final k=deaSpe)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conheaSpe_min(
    final k=heaSpe_min) if have_heaCoi
    "Minimum heating fan speed limit signal"
    annotation (Placement(transformation(extent={{-180,50},{-160,70}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant concooSpe_min(
