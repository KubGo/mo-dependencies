within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences;
block Enable "Multi zone VAV AHU economizer enable/disable switch"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TOutCut(
    final unit="K",
    final displayUnit="degC",
    final quantity = "ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput hOutCut(
    final unit="J/kg",
    final quantity="SpecificEnergy") if use_enthalpy
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uRetDamPhy_max(
    final unit="1",
    final min=0,
    final max=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uFreProSta "Freeze protection stage status signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And andEnaDis
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysOutTem(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysOutEnt(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch outDamSwitch
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retDamSwitch "Set minimum RA damper position to maximum at disable"
    annotation (Placement(transformation(extent={{-20,-176},{0,-156}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch maxRetDamSwitch
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch minRetDamSwitch
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not2 "Logical not that starts the timer at disable signal "
    annotation (Placement(transformation(extent={{-60,-58},{-40,-38}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And  and2 "Logical and"
    annotation (Placement(transformation(extent={{160,-100},{180,-80}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and1 "Check supply fan status"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay delOutDamOsc(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay delRetDam(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage0)
    "Integer constant, stage 0"
    annotation (Placement(transformation(extent={{-118,12},{-98,32}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant entSubst1(
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages</a>
