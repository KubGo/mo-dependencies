...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zerDam(
    final k=0) "Close damper when disabled"
    annotation (Placement(transformation(extent={{-20,-110},{0,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minRel(
    final k=relDam_min)
    "Minimum relief damper position"
    annotation (Placement(transformation(extent={{-100,70},{-80,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxRel(
    final k=relDam_max)
    "Maximum relief damper position"
    annotation (Placement(transformation(extent={{-40,10},{-20,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant fulOpe(
    final k=1)
    "Fully open relief damper"
    annotation (Placement(transformation(extent={{-100,10},{-80,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line relDam(
