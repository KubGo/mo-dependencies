...
block SupplyAirTemperature
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController cooCoiConTyp=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController heaCoiConTyp=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TZonHeaSet(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TZonCooSet(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiDeaCoo
    "Switch for turning on cooling mode from deadband mode"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiCooCoi if have_cooCoi
    "Switch cooling coil signal to zero in deadband mode"
    annotation (Placement(transformation(extent={{140,-150},{160,-130}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiHeaCoi if have_heaCoi
    "Switch heating coil signal to zero in deadband mode"
    annotation (Placement(transformation(extent={{140,80},{160,100}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Line linTHeaSupAir if have_heaCoi
    "Convert heating loop signal to supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-80,50},{-60,70}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Line linTCooSupAir if have_cooCoi
    "Convert cooling loop signal to supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-80,-120},{-60,-100}})));

  BuildingsLite.Controls.OBC.CDL.Reals.PID conPIDHea(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID conPIDCoo(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysDeaHea(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiDeaHea if have_heaCoi
    "Switch for turning on heating mode from deadband mode"
    annotation (Placement(transformation(extent={{-20,50},{0,70}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysDeaCoo(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul2 if have_heaCoi
    "Output heating coil signal only when fan is proven on"
    annotation (Placement(transformation(extent={{200,100},{220,120}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul3 if have_cooCoi
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conUHea_max(
    final k=uHea_max) if have_heaCoi
    "Maximum heating loop signal support point"
    annotation (Placement(transformation(extent={{-200,10},{-180,30}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conUCoo_max(
