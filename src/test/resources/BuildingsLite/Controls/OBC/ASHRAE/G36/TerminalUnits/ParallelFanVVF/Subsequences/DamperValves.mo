...
block DamperValves
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VOAMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conZer3(final k=0)
    "Constant zero"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minFan(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Max max1 "Ensure positive value"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or cooHea "Cooling or heating state"
    annotation (Placement(transformation(extent={{-60,-310},{-40,-290}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not1 "In deadband state"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conHal1(
    final k=0.5)
    "Constant real value"
    annotation (Placement(transformation(extent={{-60,-390},{-40,-370}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conHal2(
    final k=1)
    "Constant real value"
    annotation (Placement(transformation(extent={{-180,-450},{-160,-430}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxFan(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul2
    "Ensure zero rate when it is not in heating state"
    annotation (Placement(transformation(extent={{160,-380},{180,-360}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant uno(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr3(
    final t=floHys,
    final h=floHys/2)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal zerFlo(
    final realTrue=0)
