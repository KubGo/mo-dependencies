within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Validation;
model Controller_UnspecifiedClimate
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Controller conAHU(
    ...
    final ashCliZon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Not_Specified,

    final minOADes=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow,

    final buiPreCon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin TOut(
    final amplitude=5,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin ducStaPre(
    final offset=200,
    final amplitude=150,
    final freqHz=1/3600) "Duct static pressure"
    annotation (Placement(transformation(extent={{-200,200},{-180,220}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sine2(
    final offset=3,
    final amplitude=2,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sine3(
    final amplitude=6,
    final freqHz=1/9600)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs3
    "Block generates absolute value of input"
    annotation (Placement(transformation(extent={{-160,220},{-140,240}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round3(n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-120,150},{-100,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round4(n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-120,220},{-100,240}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger ducPreResReq
    "Convert real to integer"
    annotation (Placement(transformation(extent={{-80,220},{-60,240}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger maxSupResReq
    "Convert real to integer"
    annotation (Placement(transformation(extent={{-80,150},{-60,170}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant opeMod(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse uOutAirFra_max(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp dpBui(
    final height=40,
    final offset=0,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Controller</a> for generating
