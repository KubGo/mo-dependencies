...
block SystemRequests "Output system requests for VAV terminal unit with reheat"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput uAftSupCoo
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VColDuc_flow_Set(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1CooDam
    if not have_duaSen
    "Cold duct damper proven on"
    annotation (Placement(transformation(extent={{-240,20},{-200,60}}),
        iconTransformation(extent={{-140,-20},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput uAftSupHea
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VHotDuc_flow_Set(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HeaDam
    if not have_duaSen
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr7(
    final t=thrTemDif,
    final h=dTHys)
    "Check if zone temperature is less than heating setpoint by threshold"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr8(
    final t=twoTemDif,
    final h=dTHys)
    "Check if zone temperature is less than heating setpoint by threshold"
    annotation (Placement(transformation(extent={{-80,-110},{-60,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr9(
    final t=0.95,
    final h=damPosHys)
    "Check if damper position is greater than 0.95"
    annotation (Placement(transformation(extent={{-180,-340},{-160,-320}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr10(
    final t=0.95,
    final h=looHys) "Check if heating loop signal is greater than 0.95"
    annotation (Placement(transformation(extent={{-80,-160},{-60,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr11(
    final t=floHys,
    final h=0.5*floHys)
    "Check if discharge airflow setpoint is greater than 0"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant thrCooResReq1(
    final k=3)
    "Constant 3"
    annotation (Placement(transformation(extent={{80,-10},{100,10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant twoCooResReq1(
    final k=2)
    "Constant 2"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant thrPreResReq1(
    final k=3)
    "Constant 3"
    annotation (Placement(transformation(extent={{80,-210},{100,-190}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant twoPreResReq1(
    final k=2)
    "Constant 2"
    annotation (Placement(transformation(extent={{20,-270},{40,-250}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi4
    "Output 3 or other request "
    annotation (Placement(transformation(extent={{162,-50},{182,-30}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi5
    "Output 2 or other request "
    annotation (Placement(transformation(extent={{80,-110},{100,-90}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch swi1
    "Output 3 or other request "
    annotation (Placement(transformation(extent={{120,-230},{140,-210}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch swi2
    "Output 2 or other request "
    annotation (Placement(transformation(extent={{80,-300},{100,-280}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim6(
    final delayTime=durTimTem)
    "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{-40,-70},{-20,-50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim7(
    final delayTime=durTimTem)
    "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{-40,-110},{-20,-90}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim8(
    final delayTime=durTimFlo)
    "Check if it is more than threshold time"
    annotation (Placement(transformation(extent={{-80,-320},{-60,-300}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greEqu2(final h=floHys)
    "Check if discharge airflow is less than 50% of setpoint"
    annotation (Placement(transformation(extent={{-80,-240},{-60,-220}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater greEqu3(final h=floHys)
    "Check if discharge airflow is less than 70% of setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr12(
    final t=0.15,
    final h=looHys)
    "Check if heating loop signal is greater than 0.15"
    annotation (Placement(transformation(extent={{-80,-400},{-60,-380}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat "Hold the true input"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conOne(
    final k=1) if have_duaSen
    "Constant 1"
    annotation (Placement(transformation(extent={{80,60},{100,80}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conOne1(
    final k=1) if have_duaSen
    "Constant 1"
    annotation (Placement(transformation(extent={{80,-340},{100,-320}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt2 if not have_duaSen
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulInt if not have_duaSen
    "Ensure zero request when the damper is not opening"
    annotation (Placement(transformation(extent={{160,50},{180,70}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulInt1 if have_duaSen
    "Two inputs product"
    annotation (Placement(transformation(extent={{160,90},{180,110}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt3 if not have_duaSen
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{20,-370},{40,-350}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulInt2 if not have_duaSen
    "Ensure zero request when the damper is not opening"
    annotation (Placement(transformation(extent={{160,-350},{180,-330}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulInt3 if have_duaSen
    "Two inputs product"
