...
block TrimAndRespond "Block to inplement trim and respond logic"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay tim(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch netRes "Net setpoint reset value"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro1 "Product of trim and respond amount"
    annotation (Placement(transformation(extent={{-160,-150},{-140,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro2 "Product of respond and maximum amount"
    annotation (Placement(transformation(extent={{-160,-220},{-140,-200}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.UnitDelay uniDel(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi3 "Logical switch"
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant iniSetCon(final k=iniSet)
    "Initial setpoint"
    annotation (Placement(transformation(extent={{-90,220},{-70,240}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant numIgnReqCon(final k=numIgnReq)
    "Number of ignored requests"
    annotation (Placement(transformation(extent={{-160,-98},{-140,-78}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant triAmoCon(final k=triAmo)
    "Trim amount constant"
    annotation (Placement(transformation(extent={{-200,-130},{-180,-110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxResCon(final k=maxRes)
    "Maximum response per time interval"
    annotation (Placement(transformation(extent={{-200,-250},{-180,-230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxSetCon(final k=maxSet)
    "Maximum setpoint constant"
    annotation (Placement(transformation(extent={{-28,100},{-8,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zerTri(final k=0)
    "Zero reset amount during time range from (device ON) to (device ON + delTim + timSet)"
    annotation (Placement(transformation(extent={{60,-60},{80,-40}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.IntegerToReal intToRea
    "Convert integer input to real output"
    annotation (Placement(transformation(extent={{-200,-60},{-180,-40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract difReqIgnReq
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add2 "Net reset value"
    annotation (Placement(transformation(extent={{120,-136},{140,-116}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min minInp
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minSetCon(k=minSet)
    "Minimum setpoint constant"
    annotation (Placement(transformation(extent={{12,100},{32,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max maxInp
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs "Absolute value of real input"
    annotation (Placement(transformation(extent={{-120,-180},{-100,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs1 "Absolute value of real input"
    annotation (Placement(transformation(extent={{-120,-250},{-100,-230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer(final k=0) "Constant"
    annotation (Placement(transformation(extent={{-90,50},{-70,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fal(final k=false) if not
    have_hol "Constant – Placeholder value if there is no hold signal"
    annotation (Placement(transformation(extent={{-210,50},{-190,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swiHol
    "Switch to zero reset until hold is released and sampler clock ticks"
    annotation (Placement(transformation(extent={{-50,30},{-30,50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not notHol "Return true if hold is released"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And notHolAndTic
    "Return true if hold is released and sampler clock ticks"
    annotation (Placement(transformation(extent={{-130,30},{-110,50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.SampleTrigger samTri(
