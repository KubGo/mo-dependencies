within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.Validation;
model Dampers
  "Validate model for controlling damper position of cooling  only terminal unit"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.Dampers dam1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp zonSta(
    final offset=3,
    final height=-2,
    final duration=1000,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Round round3(final n=0)
    "Round real number to given digits"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.Dampers\">
BBuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.Dampers</a>
