within BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1.Validation;
model Setpoints "Validate the outdoor airflow setpoint according to the ASHRAE 62.1"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin zonTem(
    final amplitude=8,
    final freqHz=1/7200,
    final offset=273.15 + 15) "Zone temperature"
    annotation (Placement(transformation(extent={{-80,60},{-60,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin disTem(
    final amplitude=-5,
    final freqHz=1/7200,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp co2Con(
    final height=300,
    final duration=7200,
