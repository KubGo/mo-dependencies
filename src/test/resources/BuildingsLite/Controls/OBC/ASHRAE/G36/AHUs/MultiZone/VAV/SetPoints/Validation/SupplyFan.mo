...
model SupplyFan "Validate SupplyFan"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyFan conSupFan1(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyFan conSupFan2(
    final Td=1,
    final controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI,
    final maxSet=400,
    final k=0.001,
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Round round1(n=0)
    "Round real number to given digits"
