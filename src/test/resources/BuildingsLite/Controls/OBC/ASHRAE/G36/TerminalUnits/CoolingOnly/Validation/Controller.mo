within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Validation;
model Controller
  "Validation of model that controls cooling only unit"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Controller cooBoxCon(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supAirTem(
    final height=2,
    final duration=43200,
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse supFanSta(
    final width=0.9,
    final period=73200,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
