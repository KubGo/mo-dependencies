within BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Validation;
model Controller
    "Validation of the top-level controller"

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Controller conFCU(
    cooCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased,
    heaCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased,
    have_winSen=false,
    kHea=1,
    cooConTyp=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.P,
    heaConTyp=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.P,
    have_occSen=true,
    TSupSet_max=297.15,
    TSupSet_min=285.15,
    heaSpe_max=0.6,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Controller conFCU1(
    cooCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased,
    heaCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased,
    have_winSen=true,
    kCoo=1,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Controller conFCU2(
    cooCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased,
    heaCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased,
    have_winSen=false,
    kCoo=1,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Controller conFCU3(
    cooCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased,
    heaCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased,
    have_winSen=true,
    kCoo=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TOccHeaSet(
    k=293.15)
    "Occupied heating setpoint temperature"
    annotation (Placement(transformation(extent={{-160,130},{-140,150}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TOccCooSet(
    k=297.15)
    "Occupied cooling setpoint temperature"
    annotation (Placement(transformation(extent={{-120,130},{-100,150}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TUnoHeaSet(
    k=285.15)
    "Unoccupied heating setpoint temperature"
    annotation (Placement(transformation(extent={{-80,130},{-60,150}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TUnoCooSet(
    k=303.15)
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant nOcc(
    k=2)
    "Number of occupants"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TZon1(
    duration=86400,
    height=-3,
    offset=273.15 + 26,
    y(unit="K"))
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TSup1(
    height=-3,
    duration=86400,
    offset=273.15 + 24,
    y(unit="K"))
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant demLim(
    k=0)
    "Cooling and heating demand imit level"
    annotation (Placement(transformation(extent={{-180,-110},{-160,-90}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooWarTim(
    k=0)
    "Cooldown and warm-up time"
    annotation (Placement(transformation(extent={{-120,-30},{-100,-10}})));

  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant win1(
    k=false)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Controller</a>.
</p>
<p>
