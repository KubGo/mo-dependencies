within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Validation;
model Controller
  "Validation of model that controls series-fan powered unit with variable volume fan"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Controller serFanCon(
    ...
    final maxRat=2,
    final controllerTypeVal=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI,
    final staPreMul=1,
    final hotWatRes=1,
    final floHys=0.01,
    final looHys=0.01,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin parFanFlo(
    final offset=1.2,
    final amplitude=0.6,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp oveDam(
    final height=2,
    final duration=5000,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp oveTerFan(
    final height=2,
    final duration=5000,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin TSup(
    final offset=273.15 + 13,
    final amplitude=1,
    final freqHz=1/28800) "Supply air temperature from air handling unit"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse heaOff(
    final width=0.75,
    final period=3600)
    "Close heating valve"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant terFan(
    final k=true)
    "Terminal fan status"
    annotation (Placement(transformation(extent={{-120,-230},{-100,-210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse hotPla(
    final width=0.9,
    final period=7500)
    "Hot water plant status"
    annotation (Placement(transformation(extent={{-80,-250},{-60,-230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse supFan(
    final width=0.75,
    final period=7500)
    "AHU supply fan status"
    annotation (Placement(transformation(extent={{-80,-210},{-60,-190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TSupSet(
    final k=273.15 + 13)
    "AHU supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-120,-30},{-100,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin disFlo(
    final offset=1.3,
    final amplitude=0.6,
    final freqHz=1/28800) "Discharge airflow rate"
    annotation (Placement(transformation(extent={{-120,10},{-100,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant CO2Set(final k=894)
...
equation
  ...
  connect(CO2.y,serFanCon. ppmCO2) annotation (Line(points={{-58,80},{32,80},{
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
