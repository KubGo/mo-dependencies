within BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1;
block Setpoints
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uZonSta
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VOccZonMin_flow(
    final quantity="VolumeFlowRate",
...
protected
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal airDisEff(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line lin if have_CO2Sen
    "CO2 control loop"
    annotation (Placement(transformation(extent={{-160,-70},{-140,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal inOccMod
    "Check if it is in occupied mode"
    annotation (Placement(transformation(extent={{-220,20},{-200,40}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea if have_CO2Sen
    "Convert boolean to real"
    annotation (Placement(transformation(extent={{-160,20},{-140,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply co2Con if have_CO2Sen
    "Corrected CO2 control loop output"
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line occMinAirSet if have_CO2Sen and not have_SZVAV
    "Modified occupied minimum airflow setpoint"
    annotation (Placement(transformation(extent={{-20,-130},{0,-110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonMinFlo(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonCooMaxFlo(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line popBreOutAir if have_CO2Sen
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal inCooSta if have_CO2Sen and have_parFanPowUni
    "Check if it is in cooling state"
    annotation (Placement(transformation(extent={{-220,-230},{-200,-210}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch maxFloCO2 if have_CO2Sen and have_parFanPowUni
    "Maximum airflow set point for CO2"
    annotation (Placement(transformation(extent={{-160,-230},{-140,-210}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract difCooMax if have_CO2Sen and have_parFanPowUni
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not notOccMod "Not in occupied mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant perOccSta(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply unPopAreBreAir if have_occSen
    "Area component of the required breathing zone outdoor airflow when it is unpopulated"
    annotation (Placement(transformation(extent={{-80,100},{-60,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply unpMinZonFlo if have_occSen and not have_SZVAV
    "Minimum zone airflow when it is unpopulated"
    annotation (Placement(transformation(extent={{-80,60},{-60,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch unpAreBreAir
    "Area component of the required breathing zone outdoor airflow when it is unpopulated"
    annotation (Placement(transformation(extent={{80,130},{100,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch unpMinZonAir if not have_SZVAV
    "Minimum zone airflow when it is unpopulated"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add reqBreAir
    "Required breathing zone outdoor airflow"
    annotation (Placement(transformation(extent={{220,260},{240,280}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide minOA "Minimum outdoor airflow setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant cooSta(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ZoneStates.cooling)
    if have_CO2Sen and have_parFanPowUni
    "Cooling state"
    annotation (Placement(transformation(extent={{-280,-250},{-260,-230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer2(
    final k=0) if not have_occSen
    "Constant zero"
    annotation (Placement(transformation(extent={{-80,140},{-60,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer3(
    final k=0) if not have_occSen or have_SZVAV
    "Constant zero"
    annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater cooSup(
    final h=dTHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant desAreAir(
    final k=VAreBreZon_flow)
    "Design area component of the breathing zone outdoor airflow"
    annotation (Placement(transformation(extent={{-180,250},{-160,270}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant desPopAir(
