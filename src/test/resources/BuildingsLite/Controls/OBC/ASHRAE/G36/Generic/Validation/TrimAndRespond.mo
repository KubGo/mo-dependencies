...
model TrimAndRespond "Model validates the trim and respond block"
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond trimRespondLogic(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond trimRespondLogic1(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond trimRespondLogic2(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi "Switch between two Real signals"
    annotation (Placement(transformation(extent={{-50,-70},{-30,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con1(final k=0)
    "Zero request when device is OFF"
    annotation (Placement(transformation(extent={{-90,-70},{-70,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round2(final n=0)
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond trimRespondLogicHold(
    have_hol=true,
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
