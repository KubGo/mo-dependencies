...
model Supply_T
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.Supply
    setPoiVAV(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant uHea(k=0)
    "Heating control signal"
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant uCoo(k=0.6)
    "Cooling control signal"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TOut(
    final duration=3600,
    final height=18,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TZonCooSet(
    final k=273.15 + 24)
