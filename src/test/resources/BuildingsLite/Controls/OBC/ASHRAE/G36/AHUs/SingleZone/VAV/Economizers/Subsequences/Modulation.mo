within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences;
block Modulation "Outdoor and return air damper position modulation sequence for single zone VAV AHU"
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController controllerType=
  ...
  parameter Real Ti(
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(
      enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
          or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real Td(
    final unit="s",
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(
      enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSupHeaEcoSet(
    ...
    "Supply air temperature heating setpoint" annotation (Placement(
        transformation(extent={{-160,60},{-120,100}}), iconTransformation(
          extent={{-140,40},{-100,80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1SupFan
    "Supply fan status" annotation (Placement(transformation(extent={{-160,-130},
            {-120,-90}}), iconTransformation(extent={{-140,-110},{-100,-70}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uOutDam_min(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uOutDam_max(
    final min=0,
    final max=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uRetDam_min(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uRetDam_max(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yHeaCoi(
    final min=0,
    final max=1,
    final unit="1") if have_heaCoi "Heating coil commanded valve position"
    annotation (Placement(transformation(extent={{120,30},{140,50}}),
      iconTransformation(extent={{100,40},{140,80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yOutDam(
    final min=0,
    final max=1,
    final unit="1") "Economizer damper commanded position" annotation (
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset uTSup(
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outDamMinLimSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retDamMaxLimSig(
    final k=uMax) "Maximal control loop signal for the return air damper"
    annotation (Placement(transformation(extent={{-60,-34},{-40,-14}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Line outDamPos(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line retDamPos(
    final limitBelow=true,
    final limitAbove=true)
    "Damper position is linearly proportional to the control signal between signal limits"
    annotation (Placement(transformation(extent={{22,-10},{42,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line HeaCoi(
    final limitBelow=true,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaCoiMaxLimSig(
    final k=1) if have_heaCoi
    "Maximal control loop signal for the heating coil"
    annotation (Placement(transformation(extent={{-60,50},{-40,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaCoiMinLimSig(
    final k=0) if have_heaCoi
    "Minimum control loop signal for the heating coil"
    annotation (Placement(transformation(extent={{-60,10},{-40,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant uMaxHeaCoi(
    final k=1)
    "Maximal control loop signal for the heating coil"
    annotation (Placement(transformation(extent={{-60,90},{-40,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch enaDis if have_heaCoi
    "Enable or disable the heating coil"
    annotation (Placement(transformation(extent={{76,30},{96,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant Off(
    final k=0) if have_heaCoi
...
equation
  ...
  connect(uOutDam_min, outDamPos.f2) annotation (Line(points={{-140,-70},{-92,-70},
          {-92,-48},{22,-48}}, color={0,0,127}));
  connect(uRetDam_min, retDamPos.f1)
    annotation (Line(points={{-140,0},{-2,0},{-2,4},{20,4}}, color={0,0,127}));
  connect(uRetDam_max, retDamPos.f2) annotation (Line(points={{-140,40},{-92,40},
          {-92,-8},{20,-8}}, color={0,0,127}));
  connect(Off.y, enaDis.u3) annotation (Line(points={{28,-80},{62,-80},{62,32},
          {74,32}}, color={0,0,127}));
  connect(u1SupFan, enaDis.u2) annotation (Line(points={{-140,-110},{56,-110},{
  ...
  connect(uOutDam_max, outDamPos.f1) annotation (Line(points={{-140,-40},{-2,-40},
          {-2,-36},{22,-36}}, color={0,0,127}));
  ...
  connect(u1SupFan, uTSup.trigger) annotation (Line(points={{-140,-110},{-96,-110},
...
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Limits</a> and
