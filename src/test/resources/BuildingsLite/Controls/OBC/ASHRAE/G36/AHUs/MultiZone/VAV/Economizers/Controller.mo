within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers;
block Controller
  "Multi zone VAV AHU economizer control sequence"

  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection minOADes
  ...
  parameter Real minSpe(unit="1")=0.1
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
           or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure));
  ...
  parameter Real TdMinOA(unit="s")=0.1
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
           ...
           or minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Types.VentilationStandard venStd=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController dpConTyp=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VOutMinSet_flow_normalized(
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VOut_flow_normalized(
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uSupFan(final unit="1")
    if (minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
     or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure)
    "Commanded supply fan speed"
    annotation (Placement(transformation(extent={{-280,110},{-240,150}}),
        iconTransformation(extent={{-140,100},{-100,140}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput effAbsOutAir_normalized(
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput effDesOutAir_normalized(
    final unit="1")
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
     and venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uTSup(
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uFreProSta
    "Freeze protection status"
    annotation (Placement(transformation(extent={{-280,-270},{-240,-230}}),
        iconTransformation(extent={{-140,-210},{-100,-170}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yOutDam_min(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yEnaMinOut
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithAFMS
    sepAFMS(
    final minSpe=minSpe,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP
    sepDp(
    final venStd=venStd,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Common
    damLim(
    ...
    final outDamPhy_max=outDamPhy_max,
    final outDamPhy_min=outDamPhy_min)
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper
    "Damper position limits for units with common damper"
    annotation (Placement(transformation(extent={{-140,20},{-120,40}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable enaDis(
    final use_enthalpy=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
                       or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan
    modRet(
    final have_dirCon=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp,

    final uMin=uHeaMax,
    final uMax=uCooMin) if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.Reliefs modRel(
    final uMin=uHeaMax,
    final uMax=uCooMin,
    final uOutDamMax=uOutDamMax,
    final uRetDamMin=uRetDamMin) if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.BarometricRelief)
    "Modulate economizer dampers position for buildings with relief damper or fan controlling pressure"
    annotation (Placement(transformation(extent={{100,-40},{120,-20}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.AirEconomizerHighLimits ecoHigLim(
    final eneStd=eneStd,
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithAFMS\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithAFMS</a>
for a description.
</li>
<li>
separate minimum outdoor air damper, with differential pressure measurement. 
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP</a>
for a description.
</li>
<li>
single common minimum outdoor air and economizer damper. 
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Common\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Common</a>
for a description.
</li>
</ol>
</li>
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable</a>
for a description.
</li>
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.Reliefs\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.Reliefs</a>
for a description.
</li>
<li>
return fan control with airflow tracking, or with direct building pressure control. 
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan</a>
for a description.
</li>
</ol>
</li>
