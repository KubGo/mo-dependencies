within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints;
block FreezeProtection
  ...
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl buiPreCon=
      BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
  ...
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat freSta=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
    "Type of freeze stat"
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=have_frePro));
  ...
  parameter Integer minHotWatReq=2
    ...
    annotation(__cdl(ValueInReference=true),
                Dialog(enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController heaCoiCon=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
    "Heating coil controller"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Heating coil controller",
                enable=(heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
                        or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and have_frePro));
  ...
  parameter Real Ti(unit="s")=0.5
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Heating coil controller",
                       enable=(heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
                               or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and have_frePro and
                              (heaCoiCon==BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or
                              heaCoiCon==BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real Td(unit="s")=0.1
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Heating coil controller",
                       enable=(heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
                               or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and have_frePro and
                              (heaCoiCon==BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or
                              heaCoiCon==BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uOutDamPosMin(
    final min=0,
    final max=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uOutDam(
    final min=0,
    final max=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uHeaCoi(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uMinOutDam(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1MinOutDam
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uRetDam(
    final min=0,
    final max=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1FreSta if freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS and
    have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uSupFan(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1RetFan if (buiPreCon ==
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uRetFan(
    final min=0,
    final max=1,
    final unit="1") if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uRelFan(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCooCoi(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yFreProSta
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr(
    final t=273.15 + 4.4,
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Timer tim(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatPlaReq if heaCoi ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and
    have_frePro
    "Hot water plant request in stage 1 mode"
    annotation (Placement(transformation(extent={{60,802},{80,822}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    final k=minHotWatReq)
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
    "Minimum hot-water plant requests"
    annotation (Placement(transformation(extent={{-20,830},{0,850}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch minVen if have_frePro
    "Minimum ventilation when in stage 1 mode"
    annotation (Placement(transformation(extent={{60,730},{80,750}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PID heaCoiCon1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch outDam2 if have_frePro
    "Outdoor air damper position"
    annotation (Placement(transformation(extent={{120,590},{140,610}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con(
    final k=0) if have_frePro
    "Fully closed damper position"
    annotation (Placement(transformation(extent={{40,610},{60,630}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch minOutDam2 if minOADes ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
     and have_frePro
    "Minimum outdoor air damper position"
    annotation (Placement(transformation(extent={{120,540},{140,560}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retDam2 if have_frePro
    "Return air damper position"
    annotation (Placement(transformation(extent={{120,408},{140,428}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con1(
    final k=1) if have_frePro
    "Fully open damper or valve position"
    annotation (Placement(transformation(extent={{-140,310},{-120,330}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi1 if have_frePro
    "Alarm when it is in stage 2 mode"
    annotation (Placement(transformation(extent={{120,310},{140,330}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    final k=3) if have_frePro
    "Level 3 alarm"
    annotation (Placement(transformation(extent={{40,340},{60,360}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=0) if heaCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
     and have_frePro
    "Zero request"
    annotation (Placement(transformation(extent={{-20,780},{0,800}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Timer tim3(
    final t=900) if have_frePro
    "Check if the supply air temperature has been lower than threshold value for sufficient long time"
    annotation (Placement(transformation(extent={{-320,240},{-300,260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr2(
    final t=273.15 + 1,
    final h=THys) if have_frePro
    "Check if supply air temperature is less than threshold"
    annotation (Placement(transformation(extent={{-360,200},{-340,220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Timer tim4(
    final t=300) if have_frePro
    "Check if the supply air temperature has been lower than threshold value for sufficient long time"
    annotation (Placement(transformation(extent={{-320,200},{-300,220}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or8 if have_frePro
    "Check if it should be in stage 3 mode"
    annotation (Placement(transformation(extent={{-220,190},{-200,210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant con2(
    final k=false) if not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
    "Constant false"
    annotation (Placement(transformation(extent={{-320,50},{-300,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat1 if have_frePro
    "Stay in stage 3 freeze protection mode"
    annotation (Placement(transformation(extent={{-140,150},{-120,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch supFan if (not freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Supply fan speed"
    annotation (Placement(transformation(extent={{120,-230},{140,-210}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retFan
     if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Return fan speed"
    annotation (Placement(transformation(extent={{120,-370},{140,-350}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch relFan if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     and (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Relief fan speed"
    annotation (Placement(transformation(extent={{120,-510},{140,-490}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con3(
    final k=0) if have_frePro
    "Zero constant"
    annotation (Placement(transformation(extent={{-140,48},{-120,68}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch outDam if (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Outdoor air damper"
    annotation (Placement(transformation(extent={{320,70},{340,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch cooCoiVal if (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro and (cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
     or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)
    "Cooling coil position"
    annotation (Placement(transformation(extent={{120,-590},{140,-570}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatPlaReq3
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
    "Hot water plant request in stage 3 mode"
    annotation (Placement(transformation(extent={{320,-790},{340,-770}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt3(
    final k=minHotWatReq) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
    "Minimum hot-water plant requests"
    annotation (Placement(transformation(extent={{-140,-782},{-120,-762}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max max1
    if (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
       or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and have_frePro
    "Higher of supply air and mixed air temperature"
    annotation (Placement(transformation(extent={{-300,-700},{-280,-680}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PID heaCoiMod(
    final controllerType=heaCoiCon,
    final k=k,
    final Ti=Ti,
    final Td=Td,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con4(
    final k=273.15 + 27)
    if (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
        or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and have_frePro
    "Setpoint temperature"
    annotation (Placement(transformation(extent={{-140,-670},{-120,-650}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch heaCoiPos
    if (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
        or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and (
           not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
        and have_frePro
    "Heating coil position"
    annotation (Placement(transformation(extent={{320,-710},{340,-690}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi3 if have_frePro
    "Alarm level"
    annotation (Placement(transformation(extent={{320,-850},{340,-830}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt4(
    final k=2) if have_frePro
    "Level 2 alarm"
    annotation (Placement(transformation(extent={{-140,-842},{-120,-822}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert shuDowWar(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not1 if have_frePro
    "Logical not"
    annotation (Placement(transformation(extent={{120,210},{140,230}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert disMinVenWar(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not2 if have_frePro
    "Logical not"
    annotation (Placement(transformation(extent={{120,452},{140,472}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Timer tim5(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch minOutDam if minOADes ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
     and (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Minimum outdoor air damper position"
    annotation (Placement(transformation(extent={{320,-10},{340,10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt5(
    final k=0) if have_frePro
    "Level 0 alarm"
    annotation (Placement(transformation(extent={{40,278},{60,298}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat2 if have_frePro
    "Stay in stage 2 freeze protection mode"
    annotation (Placement(transformation(extent={{-180,452},{-160,472}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Edge endStaTwo if have_frePro
    "Clear the latch to end the stage 2 freeze protection"
    annotation (Placement(transformation(extent={{-220,412},{-200,432}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or2 if have_frePro
    "Start stage 1 freeze protection mode"
    annotation (Placement(transformation(extent={{-160,802},{-140,822}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retDam
    if (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
        and have_frePro
    "Return air damper position"
    annotation (Placement(transformation(extent={{320,150},{340,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant supTemSet(
    final k=273.15+ 6)
    if (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
        or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric) and have_frePro
    "Supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-380,680},{-360,700}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi2 if have_frePro
    "Alarm level"
    annotation (Placement(transformation(extent={{380,310},{400,330}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi4 if have_frePro
    "Alarm level"
    annotation (Placement(transformation(extent={{320,570},{340,590}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt6(
    final k=2) if have_frePro
    "Stage 2 freeze protection"
    annotation (Placement(transformation(extent={{160,620},{180,640}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi5 if have_frePro
    "Alarm level"
    annotation (Placement(transformation(extent={{260,760},{280,780}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt7(
    final k=1) if have_frePro
    "Stage 1 freeze protection"
    annotation (Placement(transformation(extent={{140,830},{160,850}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt8(
    final k=0) if have_frePro
    "Stage 0 freeze protection"
    annotation (Placement(transformation(extent={{140,730},{160,750}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Switch minOutDam3
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
     and have_frePro
    "Minimum outdoor air damper command on position"
    annotation (Placement(transformation(extent={{120,510},{140,530}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant con5(
    final k=false)
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
       and have_frePro
    "False"
    annotation (Placement(transformation(extent={{-40,530},{-20,550}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Switch minOutDam1 if (minOADes ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
     and not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Minimum outdoor air damper command on position"
    annotation (Placement(transformation(extent={{320,-80},{340,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not norFal
    if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
    "The output is normally false"
    annotation (Placement(transformation(extent={{-360,120},{-340,140}})));
  BuildingsLite.Controls.OBC.CDL.Logical.FallingEdge falEdg if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and1
    if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not norSta3
    if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{160,-310},{180,-290}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not norSta1 if have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{160,-170},{180,-150}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and2
    if (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Disable supply fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-150},{340,-130}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not norSta2 if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan)
     and have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{160,-450},{180,-430}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and3 if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     and (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Disable relief fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-430},{340,-410}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai(
    final k=1)
    if ((heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
      or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric)
      and freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai1(
    final k=1) if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro and (cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
     or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-620},{140,-600}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai2(
    final k=1) if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     and freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-540},{140,-520}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or1 if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     and (not ((not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro))
    "Dummy block for enabling and disabling conditional connection"
    annotation (Placement(transformation(extent={{320,-470},{340,-450}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai3(
    final k=1) if ((buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-400},{140,-380}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or4 if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and not ((not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro)
    "Dummy block for enabling and disabling conditional connection"
    annotation (Placement(transformation(extent={{320,-330},{340,-310}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai4(
    final k=1) if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{320,120},{340,140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai5(
    final k=1) if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{320,40},{340,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai6(
    final k=1) if (minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
     and freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{320,-40},{340,-20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or5 if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
     and (not (not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro))
    "Dummy block for enabling and disabling conditional connection"
    annotation (Placement(transformation(extent={{320,-110},{340,-90}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or6 if not ((not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro)
    "Dummy block for enabling and disabling conditional connection"
    annotation (Placement(transformation(extent={{320,-190},{340,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai7(
    final k=1) if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-260},{140,-240}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai8(final k=1)
    if not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-240,-60},{-220,-40}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt9(final k=0)
    if not have_frePro "Dummy constant"
    annotation (Placement(transformation(extent={{380,360},{400,380}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai9(final k=1)
    if not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-240,-90},{-220,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai10(final k=1) if (not
    have_frePro) and minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-240,-120},{-220,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai11(final k=1)
    if not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-260,-280},{-240,-260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai12(final k=1) if (not
    have_frePro) and (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-260,-420},{-240,-400}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai13(final k=1) if (not
    have_frePro) and buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-260,-560},{-240,-540}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai14(final k=1) if (not
    have_frePro) and (cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
     or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-260,-640},{-240,-620}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai15(final k=1)
    if (not have_frePro) and (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
                              or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric)
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-260,-740},{-240,-720}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt10(final k=0)
    if (not have_frePro) and heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Dummy constant"
    annotation (Placement(transformation(extent={{360,-820},{380,-800}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or7 if have_frePro
    "Check if it should be in stage 3 mode"
