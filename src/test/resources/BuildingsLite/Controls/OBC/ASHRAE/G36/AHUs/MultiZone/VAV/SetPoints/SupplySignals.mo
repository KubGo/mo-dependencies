...
block SupplySignals
  ...
  parameter Real TdTSup(
    ...
    annotation(__cdl(ValueInReference=false),
                Dialog(enable=controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
                          or controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput uTSup(
    final max=1,
    final unit="1",
    final min=-1)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conTSup(
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant uHeaMaxCon(
    final k=uHea_max) if have_heaCoi
    "Constant signal to map control action"
    annotation (Placement(transformation(extent={{0,-20},{20,0}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant negOne(final k=-1)
    if have_heaCoi
    "Negative unity signal"
    annotation (Placement(transformation(extent={{0,18},{20,38}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant uCooMinCon(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line conSigCoo(
    final limitBelow=true,
    final limitAbove=false) if have_cooCoi
    "Cooling control signal"
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line conSigHea(
