...
model PlantRequests
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.PlantRequests plaReq
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.PlantRequests plaReq1(
    have_hotWatCoi=false)
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,-80},{80,-60}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.PlantRequests plaReq2(
    have_chiWatCoi=false)
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,-160},{80,-140}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse fanSpe(
    width=0.8,
    period=3600)
    "Fan speed signal"
    annotation (Placement(transformation(extent={{10,70},{30,90}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse fanSpe1(
    width=0.8,
    period=3600)
    "Fan speed signal"
    annotation (Placement(transformation(extent={{20,-30},{40,-10}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse fanSpe2(
    width=0.8,
    period=3600)
    "Fan speed signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTemSet(
    height=6,
    offset=273.15 + 14.5,
    duration=3600)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp heaCoi(
    height=-0.3,
    offset=0.96,
    duration=3600,
    startTime=1000)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTem1(
    height=8,
    offset=273.15 + 12,
    duration=3600)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTemSet1(
    height=25,
    offset=273.15 + 20,
    duration=3600)
    "Supply air temperature setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooCoi1(
    k=0)
    "Cooling coil position"
    annotation (Placement(transformation(extent={{-80,30},{-60,50}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTem3(
    height=8,
    offset=273.15 + 15,
    duration=3600)
    "Supply air temperature"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTemSet2(
    height=6,
    offset=273.15 + 14.5,
    duration=3600)
    "Supply air temperature setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp heaCoi2(
    height=-0.3,
    offset=0.96,
    duration=3600,
    startTime=1000)
