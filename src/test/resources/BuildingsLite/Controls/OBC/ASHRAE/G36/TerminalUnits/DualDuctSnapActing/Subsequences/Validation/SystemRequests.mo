...
model SystemRequests
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Subsequences.SystemRequests sysReq(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr(final t=0.01)
    "Check if damper is open"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr1(final t=0.01)
    "Check if damper is open"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Subsequences.SystemRequests\">
