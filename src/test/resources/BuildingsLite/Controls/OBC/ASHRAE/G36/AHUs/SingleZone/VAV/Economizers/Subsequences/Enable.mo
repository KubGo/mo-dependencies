...
block Enable
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TCut(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput hCut(
    final unit="J/kg",
    final quantity="SpecificEnergy") if use_enthalpy
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And andFrePro
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant entSubst(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retDamPhyMin(
    final k=retDamPhy_min)
    "Physically fixed minimum position of the return air damper"
    annotation (Placement(transformation(extent={{-140,-258},{-120,-238}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retDamPhyMax(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub2 if use_enthalpy
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch maxOutDam
    "Set maximum OA damper position to minimum at disable (after time delay)"
    annotation (Placement(transformation(extent={{40,-150},{60,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch minRetDam
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and1 "Logical and checks supply fan status"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ZoneStates.heating)
    "Heating zone state"
...
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ZoneStates\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ZoneStates</a>.
</li>
</ul>
<p>
