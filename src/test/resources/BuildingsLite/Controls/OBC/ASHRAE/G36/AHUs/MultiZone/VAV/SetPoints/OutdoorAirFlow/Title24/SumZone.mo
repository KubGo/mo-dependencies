...
block SumZone "Sum of the zone level setpoints calculation"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VZonAbsMin_flow[nZon](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VZonDesMin_flow[nZon](
    final min=fill(0,nZon),
    final unit=fill("m3/s",nZon),
    final quantity=fill("VolumeFlowRate",nZon))
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCO2[nZon](
    final unit=fill("1",nZon)) if have_CO2Sen
    "Zone CO2 control loop"
    annotation (Placement(transformation(extent={{-160,-120},{-120,-80}}),
        iconTransformation(extent={{-140,-100},{-100,-60}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VSumZonAbsMin_flow(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VSumZonDesMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yMaxCO2(
    final unit="1")
    if have_CO2Sen
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.Title24.Setpoints\">
BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.Title24.Setpoints</a> for the detailed
description.
</p>
</html>", revisions="<html>
<ul>
