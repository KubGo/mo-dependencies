within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences;
block Alarms "Generate alarms of terminal unit with reheat"
  ...
  parameter Real dTHys(
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Advanced", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VDis_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr(t=floHys,
      final h=0.5*floHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch lowFloAla
    "Low airflow alarm"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar1(
    final p=-8) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Setpoint temperature minus a threshold"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And fanHotPlaOn if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and14 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{40,-320},{60,-300}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and15 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
