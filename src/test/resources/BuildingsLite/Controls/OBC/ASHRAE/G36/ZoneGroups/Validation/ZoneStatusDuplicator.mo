...
model ZoneStatusDuplicator
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatusDuplicator zonStaDup(
    final nZon=5, final nZonGro=2) "Zone status duplicator"
    annotation (Placement(transformation(extent={{0,-40},{40,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant reaInp[6,5](
    final k=fill({1,2,3,4,5}, 6))
    "Real inputs"
    annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant booInp[9,5](
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatusDuplicator\">
BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatusDuplicator</a>
