...
model CoolingCoil "Validation of cooling coil model"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.CoolingCoil cooCoi(
    final controllerTypeCooCoi=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.P,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse zonSta(
    final offset=2,
    final period=3600*2)
    "Zone state"
