within BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences;
block PlantRequests
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uFan(
    final unit="1",
    final min=0,
    final max=1)
    "Fan speed signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yChiWatResReq if have_chiWatCoi
    "Chilled water reset request"
    annotation (Placement(transformation(extent={{200,220},{240,260}}),
        iconTransformation(extent={{100,40},{140,80}})));

  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yChiPlaReq if have_chiWatCoi
    "Chiller plant request"
    annotation (Placement(transformation(extent={{200,0},{240,40}}),
        iconTransformation(extent={{100,0},{140,40}})));

  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotWatResReq if have_hotWatCoi
    "Hot water reset request"
    annotation (Placement(transformation(extent={{200,-60},{240,-20}}),
        iconTransformation(extent={{100,-40},{140,0}})));

  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotWatPlaReq if have_hotWatCoi
    "Hot water plant request"
    annotation (Placement(transformation(extent={{200,-240},{240,-200}}),
        iconTransformation(extent={{100,-80},{140,-40}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysFanCoo(
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntHea if have_hotWatCoi
    "Output integer 1 when fan is at max heating mode speed"
    annotation (Placement(transformation(extent={{-90,-20},{-70,0}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Multiply mulIntHea if have_hotWatCoi
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch chiWatRes3 if have_chiWatCoi
    "Send 3 chilled water reset request"
    annotation (Placement(transformation(extent={{160,190},{180,210}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Switch chiWatRes2 if have_chiWatCoi
    "Send 2 chilled water reset request"
    annotation (Placement(transformation(extent={{120,140},{140,160}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Switch chiWatRes1 if have_chiWatCoi
    "Send 1 chilled water reset request"
    annotation (Placement(transformation(extent={{80,90},{100,110}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi3 if have_chiWatCoi
    "Send 1 chiller plant request"
    annotation (Placement(transformation(extent={{80,10},{100,30}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Subtract heaSupTemDif if have_hotWatCoi
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatRes3 if have_hotWatCoi
    "Send 3 hot water reset request"
    annotation (Placement(transformation(extent={{140,-70},{160,-50}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatRes2 if have_hotWatCoi
    "Send 2 hot water reset request"
    annotation (Placement(transformation(extent={{100,-120},{120,-100}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatRes1 if have_hotWatCoi
    "Send 1 hot water reset request"
    annotation (Placement(transformation(extent={{60,-150},{80,-130}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi1 if have_hotWatCoi
