within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Subsequences;
block Alarms "Generate alarms of snap-acting controlled dual-duct terminal unit"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not3 if have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and5 if have_duaSen
    "Check if the measured airflow is greater than the threshold and the supply fan is OFF"
    annotation (Placement(transformation(extent={{-20,-70},{0,-50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not4 if have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla if have_duaSen
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{-40,-200},{-20,-180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not5 if have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not6 if have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and6 if have_duaSen
    "Check if the measured airflow is greater than the threshold and the supply fan is OFF"
    annotation (Placement(transformation(extent={{-20,-300},{0,-280}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not7 if have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla1 if have_duaSen
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{-40,-430},{-20,-410}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not8 if have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooMaxFlo1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Greater gre3(
    final h=floHys)
    if not have_duaSen
    "Check if measured airflow is greater than threshold"
    annotation (Placement(transformation(extent={{-60,190},{-40,210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and7 if not have_duaSen
    "Check if the measured airflow is greater than the threshold and the supply fan is OFF"
    annotation (Placement(transformation(extent={{0,190},{20,210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not9 if not have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or or2 if not have_duaSen
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not10 if not have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla2 if not have_duaSen
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{0,20},{20,40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And cloBotDam if not have_duaSen
    "Both heating and cooling dampers are closed"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not11 if not have_duaSen
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add2 if have_duaSen
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla3 if not have_duaSen
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And  leaDamAla4 if have_duaSen
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{0,-200},{20,-180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla5 if have_duaSen
    "Check if generating leak damper alarms"
