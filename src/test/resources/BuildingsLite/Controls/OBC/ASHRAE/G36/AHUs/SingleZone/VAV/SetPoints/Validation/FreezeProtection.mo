...
model FreezeProtection
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.FreezeProtection
    frePro(final buiPreCon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper,
      freSta=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat)
