...
block GroupStatus "Block that outputs the zone group status"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput zonOcc[nBuiZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1Occ[nBuiZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput tNexOcc[nBuiZon](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1EndSetBac[nBuiZon]
    "True when the zone could end the setback mode"
    annotation (Placement(transformation(extent={{-160,-80},{-120,-40}}),
      iconTransformation(extent={{-140,-70},{-100,-30}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HigUnoCoo[nBuiZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TCooSetOff[nBuiZon](
    final unit=fill("K", nBuiZon),
    displayUnit=fill("degC", nBuiZon),
    final quantity=fill("ThermodynamicTemperature", nBuiZon))
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1EndSetUp[nBuiZon]
    "True when the zone could end the setup mode"
    annotation (Placement(transformation(extent={{-162,-200},{-122,-160}}),
      iconTransformation(extent={{-140,-150},{-100,-110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TZon[nBuiZon](
    final unit=fill("K", nBuiZon),
    displayUnit=fill("degC", nBuiZon),
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1Win[nBuiZon]
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput uGroOcc
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput nexOcc(
    final quantity="Time",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yCooTim(
    final unit="s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yWarTim(
    final unit="s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yOccHeaHig
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yHigOccCoo
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput TZonMin(
    final unit="K",
    displayUnit="degC",
    final quantity="ThermodynamicTemperature")
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMax maxTem(
    final nin=nGroZon)
    "Maximum zone temperature in the zone group"
    annotation (Placement(transformation(extent={{20,-230},{40,-210}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMin minTem(
    final nin=nGroZon)
    "Minimum zone temperature in the zone group"
    annotation (Placement(transformation(extent={{20,-270},{40,-250}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt[nGroZon]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{-60,10},{-40,30}})));
  BuildingsLite.Controls.OBC.CDL.Integers.MultiSum totColZon(
    final nin=nGroZon) "Total number of cold zone"
    annotation (Placement(transformation(extent={{60,10},{80,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd endSetBac(
    final nin=nGroZon)
    "Check if all zones have ended the setback mode"
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1[nGroZon]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{-60,-100},{-40,-80}})));
  BuildingsLite.Controls.OBC.CDL.Integers.MultiSum totHotZon(
    final nin=nGroZon) "Total number of hot zones"
    annotation (Placement(transformation(extent={{60,-100},{80,-80}})));
  BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd endSetUp(
    final nin=nGroZon)
    "Check if all zones have ended the setup mode"
    annotation (Placement(transformation(extent={{18,-190},{38,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum sumUnoHea(
    final nin=nGroZon)
    "Sum of all zones unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract difUnoHea
    "Difference between unoccupied heating setpoint and zone temperature"
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div1 "Average difference"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.IntegerToReal intToRea "Convert integer to real"
    annotation (Placement(transformation(extent={{-20,110},{0,130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum sumUnoCoo(
    final nin=nGroZon)
    "Sum of all zones unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-60,-160},{-40,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum sumTem(
    final nin=nGroZon)
    "Sum of all zones temperature"
    annotation (Placement(transformation(extent={{-60,-210},{-40,-190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract difUnoCoo
    "Difference between unoccupied cooling setpoint and zone temperature"
    annotation (Placement(transformation(extent={{-10,-130},{10,-110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div2 "Average difference"
    annotation (Placement(transformation(extent={{40,-140},{60,-120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hys(
    final uLow=uLow,
    final uHigh=uHigh)
    "Hysteresis that outputs if the group should run in setback mode"
    annotation (Placement(transformation(extent={{80,-30},{100,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hys1(
    final uLow=uLow,
    final uHigh=uHigh)
    "Hysteresis that outputs if the group should run in setup mode"
    annotation (Placement(transformation(extent={{80,-140},{100,-120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMin minToNexOcc(
    final nin=nGroZon)
    "Minimum time to next occupied period"
    annotation (Placement(transformation(extent={{-40,210},{-20,230}})));
  BuildingsLite.Controls.OBC.CDL.Logical.MultiOr schOcc(
    final nin=nGroZon)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.MultiOr oveRidOcc(
    final nin=nGroZon)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or groOcc
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt2[nGroZon]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{20,-310},{40,-290}})));
  BuildingsLite.Controls.OBC.CDL.Integers.MultiSum totOpeWin(
    final nin=nGroZon)
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter zonOccFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,290},{-80,310}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uOccFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,250},{-80,270}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorFilter tNexOccFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,210},{-80,230}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorFilter uCooTimFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,170},{-80,190}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorFilter uWarTimFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,130},{-80,150}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uOccHeaHigFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,90},{-80,110}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uHigOccCooFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,50},{-80,70}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uUnoHeaHigFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,10},{-80,30}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorFilter THeaSetOffFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uEndSetBacFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,-70},{-80,-50}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uHigUnoCooFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,-100},{-80,-80}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorFilter TCooSetOffFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,-160},{-80,-140}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uEndSetUpFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,-190},{-80,-170}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealVectorFilter TZonFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
    annotation (Placement(transformation(extent={{-100,-230},{-80,-210}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorFilter uWinFil(
    final nin=nBuiZon,
    final nout=nGroZon,
    final msk=zonGroMsk) "Zone group filter"
