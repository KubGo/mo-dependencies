within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints;
block FreezeProtection
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController heaCoiCon=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
    "Heating coil controller"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Heating coil controller", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uHeaCoi(
    final min=0,
    final max=1,
    final unit="1") if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased "Heating coil valve commanded position"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TAirMix(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and
    have_frePro
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatPlaReq
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID heaCoiCon1(
    ...
    final Td=Td,
    final yMax=yMax,
    final yMin=yMin) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con(final k=0.0)
               if have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con1(final k=1.0)
               if have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=0) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
    "Zero request"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retFan if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch outDam if not freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Outdoor air damper"
    annotation (Placement(transformation(extent={{320,-20},{340,0}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch cooCoi if not freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con4(
    final k=273.15 + 27) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
    "Setpoint temperature"
    annotation (Placement(transformation(extent={{-140,-530},{-120,-510}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch heaCoiPos if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.FallingEdge falEdg if have_frePro
    "Switch from stage 2 to stage 1"
    annotation (Placement(transformation(extent={{-140,620},{-120,640}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retDam if not freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Return air damper position"
    annotation (Placement(transformation(extent={{320,60},{340,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant supTemSet(
    final k=273.15+ 6) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.FallingEdge falEdg1 if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
    "Reset the freeze protection by the physical reset switch in freeze stat"
    annotation (Placement(transformation(extent={{-220,40},{-200,60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not norFal if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not norSta1 if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     and have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{120,-350},{140,-330}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and2 if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan)
     and not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Disable relief fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-330},{340,-310}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and1 if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Disable return fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-210},{340,-190}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not norSta2 if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{120,-230},{140,-210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not norSta3 if have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{120,-80},{140,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and3 if not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Disable supply fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-100},{340,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai4(final k=1)
 if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai1(final k=1)
 if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{320,-52},{340,-32}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or1 if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro
    "Dummy block for enabling and disabling conditional connection"
    annotation (Placement(transformation(extent={{320,-130},{340,-110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai2(final k=1)
 if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai3(final k=1) if (
    buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-300},{140,-280}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or5 if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan)
     and (freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro)
    "Dummy block for enabling and disabling conditional connection"
    annotation (Placement(transformation(extent={{320,-360},{340,-340}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai5(final k=1) if (
    buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan)
     and freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-420},{140,-400}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai6(final k=1)
 if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-500},{140,-480}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai7(final k=1)
 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and (freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro)
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{320,-600},{340,-580}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre if have_frePro
    "Break loop"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai10(final k=1)
    if not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-300,-190},{-280,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai11(final k=1) if (
    buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
     and not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-300,-310},{-280,-290}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai12(final k=1) if (
    buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan)
     and not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-300,-440},{-280,-420}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai13(final k=1)
    if not have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{-300,-510},{-280,-490}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or or6 if have_frePro
    "Check if it should be in stage 3 mode"
...
annotation (defaultComponentName="sinAHUFrePro",
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-200},{100,200}}),
        ...
        Text(
          ...
          textColor={0,0,127},
          visible=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased and have_frePro,
          textString="TAirMix"),
        Text(
        ...
        Text(
          extent={{-96,2},{-54,-18}},
          textColor={255,0,255},
          visible=not freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat,
          textString="u1SupFan"),
        Text(
          extent={{-96,-48},{-54,-68}},
          textColor={255,0,255},
