within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV;
block Controller "Multizone VAV air handling unit controller"

  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard eneStd
    "Energy standard, ASHRAE 90.1 or Title 24";
  parameter Types.VentilationStandard venStd
    "Ventilation standard, ASHRAE 62.1 or Title 24";
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone ashCliZon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Not_Specified
    "ASHRAE climate zone"
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=eneStd==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone tit24CliZon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.Title24ClimateZone.Not_Specified
    "California Title 24 climate zone"
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=eneStd==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24));
  parameter Boolean have_frePro=true
    "True: enable freeze protection"
    annotation (__cdl(ValueInReference=false));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat freSta=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment
    "Type of freeze stat"
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=have_frePro));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection minOADes=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
    "Type of outdoor air section"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Economizer design"));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl buiPreCon=
      BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
  ...
  parameter Boolean have_ahuRelFan=true
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Economizer design",
                       enable=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer ecoHigLimCon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.
      FixedDryBulb
    "Economizer high limit control device"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Economizer design"));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil cooCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Cooling coil type"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="System and building parameters"));
  parameter BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil heaCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Heating coil type"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="System and building parameters"));
  ...
  parameter Real VUncDesOutAir_flow(unit="m3/s")=0
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Minimum outdoor air setpoint",
                       enable=venStd==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1));
  ...
  parameter Real VAbsOutAir_flow(unit="m3/s")=0
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Minimum outdoor air setpoint",
                       enable=venStd==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24));
  ...
  parameter Real pMaxRes(
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(tab="Fan speed", group="Trim and respond for reseting duct static pressure setpoint"));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController fanSpeCon=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiFanSpe(unit="s")=60
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Fan speed", group="PID controller",
      enable=fanSpeCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
          or fanSpeCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdFanSpe(unit="s")=0.1
    "Time constant of derivative block for supply fan speed PID controller"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Fan speed", group="PID controller",
      enable=fanSpeCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or fanSpeCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  parameter Real supFanSpe_min=0.1
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Fan speed", group="PID controller"));
  parameter Real iniFanSpe(unit="1")=supFanSpe_min
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController valCon=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiVal(unit="s")=600
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Coils", group="Valves PID controller",
      enable=valCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
          or valCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdVal(unit="s")=0.1
    "Time constant of derivative block for valve control"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Coils", group="Valves PID controller",
      enable=valCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or valCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  // Limits
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController minOAConTyp=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
    "Type of minimum outdoor air controller"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Limits, separated with AFMS",
      enable=minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
           or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper));
  ...
  parameter Real TiMinOA(unit="s")=120
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
           or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper)
           and (minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
           or minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real TdMinOA(unit="s")=0.1
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
           or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper)
           and (minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
           or minOAConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Boolean have_CO2Sen=false
    "True: some zones have CO2 sensor"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
           and venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24)));
  parameter Real dpAbsMinOutDam=5
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=(venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
           and minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure)));
  parameter Real dpDesMinOutDam(unit="Pa")=20
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController dpConTyp=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiDp(unit="s")=0.5
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure)
           and (dpConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
           or dpConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real TdDp(unit="s")=0.1
    "Time constant of derivative block"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure)
           and (dpConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
           or dpConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real uRetDam_min(unit="1")=0.5
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper));
  // Enable
  ...
  parameter Real delEntHis(unit="J/kg")=1000
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Economizer", group="Enable",
                       enable=ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
                           or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb));
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController freProHeaCoiCon=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiFrePro(unit="s")=120
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=have_frePro and
             (freProHeaCoiCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
              or freProHeaCoiCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real TdFrePro(unit="s")=0.1
    "Time constant of derivative block"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Freeze protection", group="Heating coil PID Controller",
      enable=have_frePro and
             (freProHeaCoiCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
              or freProHeaCoiCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  ...
  parameter Real dpBuiSet(
    ...
    annotation (__cdl(ValueInReference=true),
      ...
      enable=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
           or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
           or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp));
...
//       enable=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan));
  parameter Real difFloSet(unit="m3/s")=0.1
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController retFanCon=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiRetFan(unit="s")=0.5
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=(buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
           or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
           and (retFanCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
           or retFanCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real TdRetFan(unit="s")=0.1
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=(buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
           or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
           and (retFanCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
           or retFanCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  ...
  parameter Real p_rel_RetFan_min(
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Pressure control", group="Return fan",
      enable=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uAhuOpeMod
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uZonPreResReq
    "Zone static pressure reset requests"
    annotation (Placement(transformation(extent={{-400,500},{-360,540}}),
        iconTransformation(extent={{-240,390},{-200,430}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput dpDuc(
    final unit="Pa",
    displayUnit="Pa",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TOut(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VSumAdjPopBreZon_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VSumAdjAreBreZon_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VSumZonPri_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uOutAirFra_max(
    final min=0,
    final unit="1")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VSumZonAbsMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VSumZonDesMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VAirOut_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if (minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
     or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCO2Loo_max(
    final unit="1")
    if (have_CO2Sen and venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput dpMinOutDam(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference")
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TAirRet(
    final unit="K",
    displayUnit="degC",
    final quantity="ThermodynamicTemperature") if (ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialDryBulb
     or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedDryBulbWithDifferentialDryBulb)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput hAirOut(
    final unit="J/kg",
    final quantity="SpecificEnergy")
    if (ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
     or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb)
    "Outdoor air enthalpy"
    annotation (Placement(transformation(extent={{-400,-130},{-360,-90}}),
        iconTransformation(extent={{-240,-120},{-200,-80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput hAirRet(
    final unit="J/kg",
    final quantity="SpecificEnergy")
    if (eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
     and ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb)
    "OA enthalpy high limit cutoff. For differential enthalpy use return air enthalpy measurement"
    annotation (Placement(transformation(extent={{-400,-160},{-360,-120}}),
        iconTransformation(extent={{-240,-140},{-200,-100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1FreSta
    if freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS and
    have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1SofSwiRes if (freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat or freSta ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1RelFan if buiPreCon ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan and not
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TAirMix(
    final unit="K",
    displayUnit="degC",
    final quantity="ThermodynamicTemperature")
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
       or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric
    "Measured mixed air temperature"
    annotation (Placement(transformation(extent={{-400,-330},{-360,-290}}),
        iconTransformation(extent={{-240,-300},{-200,-260}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput dpBui(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference")
    if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VAirSup_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VAirRet_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput TAirSupSet(
    final unit="K",
    displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VEffAirOut_flow_min(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yMinOutDam(
    final min=0,
    final max=1,
    final unit="1")
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1MinOutDam
    if minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRetDam(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRelDam(
    final min=0,
    final max=1,
    final unit="1")
    if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
       or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
       or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yOutDam(
    final min=0,
    final max=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1EneCHWPum
 if have_frePro
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1SupFan
    "Supply fan command on"
    annotation (Placement(transformation(extent={{360,-60},{400,-20}}),
        iconTransformation(extent={{200,-20},{240,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput ySupFan(
    final min=0,
    final max=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1RetFan if (buiPreCon ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)
    "Return fan commanded on"
    annotation (Placement(transformation(extent={{360,-120},{400,-80}}),
        iconTransformation(extent={{200,-70},{240,-30}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRetFan(
    final min=0,
    final max=1,
    final unit="1")
    if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1RelFan if buiPreCon ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRelFan(
    final min=0,
    final max=1,
    final unit="1")
    if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1RelDam if buiPreCon ==
    BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yCooCoi(
    final min=0,
    final max=1,
    final unit="1") if (cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
     or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yHeaCoi(
    final min=0,
    final max=1,
    final unit="1")
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yAla if have_frePro
    "Alarm level"
    annotation (Placement(transformation(extent={{360,-350},{400,-310}}),
        iconTransformation(extent={{200,-270},{240,-230}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yDpBui(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference")
    if (buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
        and have_ahuRelFan) or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput dpDisSet(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference")
    if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yChiWatResReq
    if cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yChiPlaReq
    if cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Chiller plant request"
    annotation (Placement(transformation(extent={{360,-510},{400,-470}}),
        iconTransformation(extent={{200,-390},{240,-350}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotWatResReq
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotWatPlaReq
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.GreaterThreshold freProMod
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if it is in freeze protection mode"
    annotation (Placement(transformation(extent={{180,-570},{200,-550}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch intSwi
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Hot water plant request"
    annotation (Placement(transformation(extent={{300,-580},{320,-560}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.FreezeProtection frePro(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.PlantRequests plaReq(
    final heaCoi=heaCoi,
    final cooCoi=cooCoi,
    final THys=THys,
    final posHys=posHys) "Plant requests"
    annotation (Placement(transformation(extent={{-20,-540},{0,-520}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller ecoCon(
    final minOADes=minOADes,
    final buiPreCon=buiPreCon,
    final eneStd=eneStd,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyFan conSupFan(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplySignals supSig(
    final have_heaCoi=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric,
    final have_cooCoi=cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
         or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyTemperature conTSupSet(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU ashOutAirSet(
    final minOADes=minOADes,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefDamper relDam(
    final dpBuiSet=dpBuiSet,
    final k=kRelDam) if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure retFanDpCon(
    final dpBuiSet=dpBuiSet,
    ...
    final k=kRetFan,
    final Ti=TiRetFan,
    final Td=TdRetFan) if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanAirflowTracking retFanAirTra(
    ...
    final minSpe=retFanSpe_min) if buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU tit24OutAirSet(
    final minOADes=minOADes,
    final have_CO2Sen=have_CO2Sen,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefFan relFanCon(
    final relFanSpe_min=relFanSpe_min,
    final dpBuiSet=dpBuiSet,
    final k=kRelFan,
    final hys=hys) if have_ahuRelFan and buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan
...
equation
  ...
  connect(frePro.yRetDam, yRetDam) annotation (Line(points={{202,-184},{250,-184},
          {250,90},{380,90}}, color={0,0,127}));
  connect(frePro.yOutDam, yOutDam) annotation (Line(points={{202,-186},{270,-186},
  ...
  connect(frePro.yMinOutDam, yMinOutDam) annotation (Line(points={{202,-189},{230,
          -189},{230,160},{380,160}}, color={0,0,127}));
  connect(frePro.ySupFan, ySupFan) annotation (Line(points={{202,-196},{300,-196},
          {300,-70},{380,-70}},   color={0,0,127}));
  connect(frePro.yRetFan, yRetFan) annotation (Line(points={{202,-201},{320,-201},
          {320,-132},{380,-132}}, color={0,0,127}));
  connect(frePro.yCooCoi, yCooCoi) annotation (Line(points={{202,-210},{310,-210},
          {310,-270},{380,-270}}, color={0,0,127}));
  connect(frePro.yHeaCoi, yHeaCoi) annotation (Line(points={{202,-212},{300,-212},
          {300,-300},{380,-300}}, color={0,0,127}));
  ...
  connect(frePro.yRelFan, yRelFan) annotation (Line(points={{202,-206},{340,-206},
  ...
  connect(frePro.y1MinOutDam, y1MinOutDam) annotation (Line(points={{202,-191},{
          240,-191},{240,130},{380,130}}, color={255,0,255}));
  ...
  connect(frePro.y1RetFan, y1RetFan) annotation (Line(points={{202,-199},{310,-199},
  ...
  connect(frePro.yHeaCoi, plaReq.uHeaCoiSet) annotation (Line(points={{202,-212},
          ...
          127}));
  connect(frePro.y1RelDam, y1RelDam) annotation (Line(points={{202,-208},{320,-208},
          {320,-230},{380,-230}}, color={255,0,255}));
annotation (
    ...
    graphics={
      Rectangle(extent={{200,440},{-200,-440}},
       ...
       Text(
          ...
          visible=venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1),
       ...
       Text(
          ...
          visible=venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24),
       Text(
       ...
       Text(
          ...
          visible=(minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow
     or minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.SingleDamper)),
       Text(
          extent={{-198,-40},{-116,-58}},
          textColor={0,0,0},
          textString="dpMinOutDam",
          visible=minOADes == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure),
       Text(
          extent={{-196,-70},{-160,-90}},
          textColor={0,0,0},
          textString="TAirRet",
          visible=(ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialDryBulb
                or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedDryBulbWithDifferentialDryBulb)),
       Text(
          extent={{-196,-90},{-160,-108}},
          textColor={0,0,0},
          textString="hAirOut",
          visible=(ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
               or ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb)),
       Text(
          extent={{-196,-110},{-160,-128}},
          textColor={0,0,0},
          visible=(eneStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
               and ecoHigLimCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb),
          textString="hAirRet"),
       Text(
          ...
          textColor={0,0,0},
          textString="TAirMix",
          visible=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
               or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric),
       ...
       Text(
          ...
          textColor={0,0,0},
          textString="yCooCoi",
          visible=(cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
               or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)),
       Text(
          extent={{142,-108},{204,-128}},
          textColor={0,0,0},
          textString="yRelFan",
          visible=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan),
       Text(
          extent={{144,-58},{200,-78}},
          textColor={0,0,0},
          textString="yRetFan",
          visible=(buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
               or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp)),
       ...
       Text(
          ...
          textColor={0,0,0},
          textString="yRelDam",
          visible=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefDamper
               or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir
               or buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp),
       ...
       Text(
          ...
          textColor={255,0,255},
          textString="u1FreSta",
          visible=freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_BAS
               and have_frePro),
       Text(
          extent={{-196,-188},{-122,-208}},
          textColor={255,0,255},
          textString="u1SofSwiRes",
          visible=(freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
               or freSta == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Hardwired_to_equipment)
               and have_frePro),
       Text(
       ...
       Text(
          ...
          textColor={0,0,0},
          visible=buiPreCon == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanDp,
          textString="dpDisSet"),
       Text(
       ...
       Text(
          ...
          textColor={0,0,0},
          visible=(have_CO2Sen and venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24),
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyFan\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyFan</a>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow</a>.
</p>
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller</a>
for more detailed description.
</p>
...
setpoint. See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyTemperature\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyTemperature</a>
for more detailed description.
</p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplySignals\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplySignals</a>
for more detailed description.
</p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.FreezeProtection\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.FreezeProtection</a>
for more detailed description.
</p>
...
<ul>
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefDamper\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefDamper</a>
</li>
<li> Relief fan control
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefFan\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefFan</a> is not
...
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanAirflowTracking\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanAirflowTracking</a>
</li>
<li>
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure</a>
</li>
</ul>
<h4>Plant request</h4>
<p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.PlantRequests\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.PlantRequests</a>
for more detailed description.
</p>
</html>",
revisions="<html>
