...
block DampersSingleSensors
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1CooDam
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1HeaDam
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch damPos "Output damper position"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch cooFloSet
    "Flow setpoint when it is in cooling state"
    annotation (Placement(transformation(extent={{-40,170},{-20,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch heaFloSet
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch cooDamPos "Cooling damper position"
