...
model ReliefFanGroup
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.ReliefFanGroup
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse supFan1(
    final width=1,
    final period=4000)
    "Supply fan status"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse supFan2(
    final width=1,
    final period=4000,
    shift=600) "Supply fan status"
    annotation (Placement(transformation(extent={{-120,90},{-100,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr[4](
    final t=fill(0.01, 4))
    "Check if the relief fan is proven on"
    annotation (Placement(transformation(extent={{60,100},{80,120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre[4] "Return relief fan status"
    annotation (Placement(transformation(extent={{100,100},{120,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr1[4](
    final t=fill(0.01, 4))
    "Check if the relief fan is proven on"
    annotation (Placement(transformation(extent={{60,0},{80,20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre1[4] "Return relief fan status"
    annotation (Placement(transformation(extent={{100,0},{120,20}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt[4](
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.ZeroOrderHold zerOrdHol[4](
    final samplePeriod=fill(20, 4))
    "Zero order hold"
    annotation (Placement(transformation(extent={{30,100},{50,120}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.ZeroOrderHold zerOrdHol1[4](
    final samplePeriod=fill(20, 4))
    "Zero order hold"
    annotation (Placement(transformation(extent={{30,0},{50,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr2[4](
    final t=fill(0.01, 4))
    "Check if the relief fan is proven on"
    annotation (Placement(transformation(extent={{60,-120},{80,-100}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre2[4] "Return relief fan status"
    annotation (Placement(transformation(extent={{100,-120},{120,-100}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.ZeroOrderHold zerOrdHol2[4](
    final samplePeriod=fill(20, 4))
    "Zero order hold"
    annotation (Placement(transformation(extent={{30,-120},{50,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp dpBui1(
    final height=-15,
    final offset=20,
    final duration=1800,
    startTime=1800)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHUs/SingleZone/VAV/SetPoints/Validation/ReliefFanGroup.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.ReliefFanGroup\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.ReliefFanGroup</a>
