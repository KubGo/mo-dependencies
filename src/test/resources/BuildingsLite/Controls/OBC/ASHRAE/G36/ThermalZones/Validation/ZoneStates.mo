...
model ZoneStates "Validation models of determining zone state"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse uCoo(
    final period=2,
    final shift=1,
    final offset=0,
    final amplitude=1) "Cooling control signal"
    annotation (Placement(transformation(extent={{-80,-40},{-60,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse uHea(
    final period=2,
    final shift=2,
    final offset=0,
...
BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.ZoneStates</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
