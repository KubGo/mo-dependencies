...
model Overrides "Validation of model that overrides control"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Subsequences.Overrides ove(
    final VMin_flow=0.1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp cooDamPos(
    final duration=3600,
    final height=0.5,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp heaDamPos(
    final duration=3600,
    final height=0.5,
    final offset=0.5) "Heating damper position setpoint"
    annotation (Placement(transformation(extent={{-40,-90},{-20,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp oveDam1(
    final height=2,
    final duration=2000,
    startTime=1000) "Override damper position"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnits/DualDuctMixConDischargeSensor/Subsequences/Validation/Overrides.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Subsequences.Overrides\">
