within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Validation;
model DamperValves
  "Validate model for controlling damper and valve position"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves damValFan1(
    final maxRat=0.1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp uCoo(
    final height=-1,
    final duration=3600,
    final offset=1,
    final startTime=900) "Cooling control signal"
    annotation (Placement(transformation(extent={{-100,90},{-80,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TZon(
    final k=273.15 + 22)
    "Zone temperature"
    annotation (Placement(transformation(extent={{-100,10},{-80,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VActMin_flow(
    final k=0.01) "Active minimum airflow setpoint"
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VActCooMax_flow(
    final k=0.075)
    "Active cooling maximum airflow setpoint"
    annotation (Placement(transformation(extent={{-60,70},{-40,90}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse terFan(
    final width=0.75,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp uHea(
    final height=1,
    final duration=3600,
    final offset=0,
    final startTime=5500) "Heating control signal"
    annotation (Placement(transformation(extent={{-60,-50},{-40,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp disAir(
    final duration=7200,
    final offset=0.01,
    final height=0.06)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant THeaSet(
    final k=273.15 + 20)
    "Zone heating setpoint"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin TDis(
    final offset=273.15 + 13,
    final amplitude=1.2,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VMinOut_flow(
    final k=0.005)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Round round1(final n=0)
    "Round real number to given digits"
...
equation
  ...
  connect(THeaSet.y, damValFan1.THeaSet) annotation (Line(points={{-78,-20},{36,
          -20},{36,-103},{78,-103}},   color={0,0,127}));
  ...
  connect(terFan.y, damValFan1.u1TerFan) annotation (Line(points={{-78,-140},{16,
          -140},{16,-117},{78,-117}}, color={255,0,255}));
  ...
  connect(booPul.y, damValFan1.u1Fan) annotation (Line(points={{42,-150},{60,
          -150},{60,-99},{78,-99}}, color={255,0,255}));
annotation (
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves\">
BBuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves</a>
