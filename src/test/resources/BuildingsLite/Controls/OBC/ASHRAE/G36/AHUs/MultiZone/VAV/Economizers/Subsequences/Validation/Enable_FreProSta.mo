...
model Enable_FreProSta
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant supFanSta(k=true)
    "Supply fan status"
    annotation (Placement(transformation(extent={{-140,-40},{-120,-20}})));

  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul1(period=1800)
    "Boolean pulse for generating freeze protection stage"
    annotation (Placement(transformation(extent={{-20,-160},{0,-140}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger freProSta1(
    integerTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage0,
    integerFalse=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage1)
