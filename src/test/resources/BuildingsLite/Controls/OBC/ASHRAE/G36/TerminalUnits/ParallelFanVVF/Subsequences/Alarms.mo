within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Subsequences;
block Alarms "Generate alarms of parallel fan-powered terminal unit with variable-volume fan"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and18 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{40,-390},{60,-370}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and19 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
