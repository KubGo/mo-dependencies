...
model Common_LoopDisable
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VOutMinSet1_flow(
    final k=VOutSet_flow)
    "Outdoor airflow rate setpoint, 15cfm/occupant and 100 occupants"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp VOut1_flow(
    final duration=1800,
    final offset=minVOutSet_flow,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Common damLim
    "Multi zone VAV AHU minimum outdoor air control - damper position limits"
    annotation (Placement(transformation(extent={{-40,-40},{-20,-20}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Common damLim1
    "Multi zone VAV AHU minimum outdoor air control - damper position limits"
