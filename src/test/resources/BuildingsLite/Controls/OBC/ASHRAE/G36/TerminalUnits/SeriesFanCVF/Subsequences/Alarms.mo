within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences;
block Alarms "Generate alarms of parallerl fan-powered terminal unit with constant-volume fan"
  ...
  parameter Real hotWatRes
    ...
    annotation (Dialog(enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  parameter Real lowTemTim(
    ...
    annotation (__cdl(ValueInReference=true), Dialog(enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VPri_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HotPla if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Hot water plant status"
    annotation (Placement(transformation(extent={{-280,-290},{-240,-250}}),
        iconTransformation(extent={{-140,-90},{-100,-50}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TDis(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TDisSet(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Discharge air temperature setpoint"
    annotation (Placement(transformation(extent={{-280,-370},{-240,-330}}),
        iconTransformation(extent={{-140,-130},{-100,-90}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yLowFloAla
    "Low airflow alarms"
    annotation (Placement(transformation(extent={{240,330},{280,370}}),
        iconTransformation(extent={{100,70},{140,110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yFloSenAla
    "Airflow sensor calibration alarm"
    annotation (Placement(transformation(extent={{240,180},{280,220}}),
        iconTransformation(extent={{100,40},{140,80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yFanStaAla
    "Fan status alarm"
    annotation (Placement(transformation(extent={{240,70},{280,110}}),
        iconTransformation(extent={{100,0},{140,40}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yLeaDamAla
    "Leaking damper alarm"
    annotation (Placement(transformation(extent={{240,-90},{280,-50}}),
        iconTransformation(extent={{100,-40},{140,0}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yLeaValAla
    "Leaking valve alarm"
    annotation (Placement(transformation(extent={{240,-200},{280,-160}}),
        iconTransformation(extent={{100,-70},{140,-30}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yLowTemAla
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Greater gre(
    final h=floHys)
    "Check if measured airflow is less than threshold"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel1(
    final delayTime=lowFloTim)
    "Check if the measured airflow has been less than threshold value for threshold time"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch lowFloAla "Low airflow alarm"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooMaxFlo(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel2(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Greater gre1(
    final h=floHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt2(
    final integerTrue=3)
    "Convert boolean true to level 3 alarm"
    annotation (Placement(transformation(extent={{140,190},{160,210}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel3(
    final delayTime=leaFloTim)
    "Check if the input has been true for more than threshold time"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold cloDam(
    final t=damPosHys,
    final h=0.5*damPosHys) "Check if damper position is near zero"
    annotation (Placement(transformation(extent={{-200,-130},{-180,-110}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{-40,-80},{-20,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not5 "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt3(
    final integerTrue=4)
    "Convert boolean true to level 4 alarm"
    annotation (Placement(transformation(extent={{140,-80},{160,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Less les1(
    final h=dTHys) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar(
    final p=-17) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Setpoint temperature minus a threshold"
    annotation (Placement(transformation(extent={{-180,-360},{-160,-340}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Less les2(
    final h=dTHys) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Discharge temperature lower than setpoint by a threshold"
    annotation (Placement(transformation(extent={{-120,-390},{-100,-370}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar1(final p=-8.3)
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Setpoint temperature minus a threshold"
    annotation (Placement(transformation(extent={{-180,-430},{-160,-410}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel4(
    final delayTime=lowTemTim) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel5(
    final delayTime=lowTemTim) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if the discharge temperature has been less than threshold value for threshold time"
    annotation (Placement(transformation(extent={{-40,-390},{-20,-370}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and6 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and7 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{0,-320},{20,-300}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not6 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical not"
    annotation (Placement(transformation(extent={{80,-360},{100,-340}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes4(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch lowTemAla if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=2) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Level 2 alarm"
    annotation (Placement(transformation(extent={{80,-280},{100,-260}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and8 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Discharge temperature has been less than threshold and the hot water plant is proven on"
    annotation (Placement(transformation(extent={{-80,-390},{-60,-370}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt4(
    final integerTrue=3) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Convert boolean true to level 3 alarm"
    annotation (Placement(transformation(extent={{80,-390},{100,-370}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and9 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{0,-390},{20,-370}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not7 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical not"
    annotation (Placement(transformation(extent={{80,-430},{100,-410}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes5(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conInt3(
    final k=hotWatRes) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Importance multiplier for hot water reset control"
    annotation (Placement(transformation(extent={{-120,-460},{-100,-440}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greThr2
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if the multiplier is greater than zero"
    annotation (Placement(transformation(extent={{-80,-460},{-60,-440}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt5
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Suppress the alarm when multiplier is zero"
    annotation (Placement(transformation(extent={{140,-460},{160,-440}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply proInt1 if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Low discharge air temperature alarms"
    annotation (Placement(transformation(extent={{200,-380},{220,-360}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel6(
    final delayTime=valCloTim)
    "Check if the input has been true for more than threshold time"
    annotation (Placement(transformation(extent={{80,-190},{100,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold cloVal(
    final t=valPosHys,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Greater gre2(
    final h=dTHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaValAla
    "Check if generating leak valve alarms"
    annotation (Placement(transformation(extent={{-40,-190},{-20,-170}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt6(
    final integerTrue=4)
    "Convert boolean true to level 4 alarm"
    annotation (Placement(transformation(extent={{140,-190},{160,-170}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not8 "Logical not"
    annotation (Placement(transformation(extent={{140,-230},{160,-210}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes6(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel7(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch fanStaAla
    "Fan status alarm"
    annotation (Placement(transformation(extent={{140,80},{160,100}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not9
    "Logical not"
    annotation (Placement(transformation(extent={{-180,-20},{-160,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel8(
    final delayTime=comChaTim)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt7(
    final integerTrue=4)
    "Convert boolean true to level 3 alarm"
    annotation (Placement(transformation(extent={{80,10},{100,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not10
    "Logical not"
    annotation (Placement(transformation(extent={{80,50},{100,70}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes7(
    final message="Warning: fan has been commanded ON but still OFF.")
    "Level 2 fan status alarm"
    annotation (Placement(transformation(extent={{140,50},{160,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not11
    "Logical not"
    annotation (Placement(transformation(extent={{80,-20},{100,0}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert assMes8(
    final message="Warning: fan has been commanded OFF but still ON.")
    "Level 4 fan status alarm"
    annotation (Placement(transformation(extent={{140,-20},{160,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not12
    "Logical not"
    annotation (Placement(transformation(extent={{-160,100},{-140,120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel9(
    final delayTime=lowFloTim)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay fanIni(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant occMod(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied)
    "Occupied mode"
    annotation (Placement(transformation(extent={{-160,-110},{-140,-90}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal isOcc
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla1
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And leaValAla1
    "Check if generating leak valve alarms"
    annotation (Placement(transformation(extent={{40,-190},{60,-170}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and18
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{40,-390},{60,-370}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and19
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Logical and"
...
equation
  ...
  connect(and2.y,and4. u1) annotation (Line(points={{-18,410},{-2,410}},
                          color={255,0,255}));
  connect(greThr1.y,and4. u2) annotation (Line(points={{-58,240},{-10,240},{-10,
          402},{-2,402}}, color={255,0,255}));
  connect(and1.y, and14.u1)
    annotation (Line(points={{-18,330},{-2,330}}, color={255,0,255}));
  connect(greThr1.y, and14.u2) annotation (Line(points={{-58,240},{-10,240},{-10,
  ...
  connect(uDam, cloDam.u)
    annotation (Line(points={{-260,-120},{-202,-120}}, color={0,0,127}));
  connect(u1Fan, leaDamAla.u2) annotation (Line(points={{-260,140},{-220,140},{-220,
          -78},{-42,-78}},     color={255,0,255}));
  ...
  connect(not11.y, assMes8.u)
    annotation (Line(points={{102,-10},{138,-10}}, color={255,0,255}));
  ...
  connect(truDel2.y, not4.u) annotation (Line(points={{22,200},{60,200},{60,170},
  ...
  connect(truDel3.y, booToInt3.u)
    annotation (Line(points={{102,-70},{138,-70}},color={255,0,255}));
  connect(truDel3.y, not5.u) annotation (Line(points={{102,-70},{120,-70},{120,-110},
          {138,-110}},color={255,0,255}));
  connect(gre1.y, leaDamAla.u1) annotation (Line(points={{-78,200},{-60,200},{-60,
          -70},{-42,-70}}, color={255,0,255}));
  connect(truDel6.y, not8.u) annotation (Line(points={{102,-180},{120,-180},{120,
          -220},{138,-220}}, color={255,0,255}));
  connect(truDel6.y, booToInt6.u)
    annotation (Line(points={{102,-180},{138,-180}},color={255,0,255}));
  ...
  connect(occMod.y, isOcc.u2) annotation (Line(points={{-138,-100},{-130,-100},{
          -130,-58},{-122,-58}}, color={255,127,0}));
  connect(gai.y, les.u2) annotation (Line(points={{-178,380},{-170,380},{-170,
          402},{-162,402}}, color={0,0,127}));
  connect(and4.y, and15.u1)
  ...
  connect(and3.y, not2.u) annotation (Line(points={{62,330},{70,330},{70,290},{78,
          290}}, color={255,0,255}));
  connect(isOcc.y, and15.u2) annotation (Line(points={{-98,-50},{30,-50},{30,402},
          {38,402}}, color={255,0,255}));
  connect(isOcc.y, and3.u2) annotation (Line(points={{-98,-50},{30,-50},{30,322},
  ...
  connect(and17.y, not11.u) annotation (Line(points={{22,20},{60,20},{60,-10},{78,
          -10}}, color={255,0,255}));
  connect(truDel7.y, and16.u2) annotation (Line(points={{-138,60},{-10,60},{-10,
          82},{-2,82}}, color={255,0,255}));
  connect(truDel8.y, and17.u2) annotation (Line(points={{-98,-10},{-10,-10},{-10,
  ...
  connect(leaValAla1.y, truDel6.u)
    annotation (Line(points={{62,-180},{78,-180}}, color={255,0,255}));
  connect(cloDam.y, leaDamAla1.u2) annotation (Line(points={{-178,-120},{0,-120},
          {0,-78},{38,-78}}, color={255,0,255}));
  connect(gre2.y, leaValAla1.u2) annotation (Line(points={{-118,-210},{0,-210},{
          0,-188},{38,-188}}, color={255,0,255}));
  ...
  connect(isOcc.y, and19.u2) annotation (Line(points={{-98,-50},{30,-50},{30,-318},
          {38,-318}}, color={255,0,255}));
  connect(isOcc.y, and18.u2) annotation (Line(points={{-98,-50},{30,-50},{30,-388},
