within BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.Validation;
model GroupStatus
  "Validate block for checking temperatures in the group"

  BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.GroupStatus zonGroSta(
    final nBuiZon=3,
    final nGroZon=2,
    final zonGroMsk={true,false,true}) "Calculate zone group status"
    annotation (Placement(transformation(extent={{120,-60},{140,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant warUpTim[3](
    final k={1800,1700,1900})
    "Warm-up time"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooDowTim[3](
    final k={1600,1700,1800})
    "Cooling down time"
    annotation (Placement(transformation(extent={{-140,-10},{-120,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse winSta[3](
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp2(
    final offset=0,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sin sin2
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Timer tim1 "Time after input becomes true"
    annotation (Placement(transformation(extent={{-20,130},{0,150}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Timer tim3 "Time after input becomes true"
    annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract addPar1
    "Time to occupied period"
    annotation (Placement(transformation(extent={{20,130},{40,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract addPar3
    "Time to occupied period"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse lowOccHea[3](
    final width=fill(0.5, 3),
    final period=fill(3600, 3),
    final shift=fill(1000, 3)) "Lower than occupied heating setpoint"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      origin={-130,-40})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant higOccCoo[3](
    final k=fill(false, 3))
    "Higher than occupied cooling setpoint"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-90,-60})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and2[3]
    "Lower than occupied heating setpoint when it is not occupied"
    annotation (Placement(transformation(extent={{-20,-50},{0,-30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse lowUnoHea1[3](
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaSetOff[3](
    final k={285.15,282.15,283.15})
    "Unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{-100,-110},{-80,-90}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse endSetBac[3](
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant higUnoCoo[3](
    final k=fill(false, 3))
    "HIgher than unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-90,-140})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooSetOff[3](
    final k={303.15,304.15,305.15})
    "Unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-140,-170},{-120,-150}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant endSetUp[3](
    final k=fill(false,3))
    "End setup mode"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-90,-180})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse zonTem3(
    final amplitude=7,
    final period=600,
    final offset=273.15 + 19) "Zone 3 temperature"
    annotation (Placement(transformation(extent={{-80,-280},{-60,-260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zonTem2(
    final k=273.15 + 20)
    "Zone 2 temperature"
    annotation (Placement(transformation(extent={{-120,-260},{-100,-240}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant zonOcc2(
    final k=true)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant tNexOcc2(
