within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Validation;
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanStatus1(
    final k=false) "Fan is off"
    annotation (Placement(transformation(extent={{-160,-40},{-140,-20}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant freProSta1(
    k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage1)
    "Freeze protection stage is 1"
    annotation (Placement(transformation(extent={{-160,-100},{-140,-80}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant operationMode1(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied)
    "AHU operation mode is Occupied"
    annotation (Placement(transformation(extent={{-160,-70},{-140,-50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanStatus2(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant operationMode2(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.warmUp)
    "AHU operation mode is NOT occupied"
    annotation (Placement(transformation(extent={{-40,-70},{-20,-50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanStatus3(
    final k=true) "Fan is on"
    annotation (Placement(transformation(extent={{80,-40},{100,-20}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant freProSta3(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage2)
    "Freeze protection stage is 2"
    annotation (Placement(transformation(extent={{80,-100},{100,-80}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant operationMode3(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied)
    "AHU operation mode is occupied"
