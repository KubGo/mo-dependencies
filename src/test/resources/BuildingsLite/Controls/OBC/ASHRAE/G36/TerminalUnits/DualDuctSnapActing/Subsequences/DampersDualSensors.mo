...
block DampersDualSensors
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VHotDucDis_flow_Set(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and1 "Logical and"
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler samHea(
    final samplePeriod=samplePeriod)
    "Sample the heating loop output"
    annotation (Placement(transformation(extent={{-220,-50},{-200,-30}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler samCoo(
    final samplePeriod=samplePeriod)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not2 "Not proven on"
