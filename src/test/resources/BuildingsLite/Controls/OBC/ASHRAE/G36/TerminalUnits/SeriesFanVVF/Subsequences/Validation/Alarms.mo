...
model Alarms "Validation of model that generates alarms"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms ala(
    final staPreMul=1,
    final hotWatRes=1,
...
equation
  ...
  connect(TDis.y, ala.TDis) annotation (Line(points={{-78,-120},{56,-120},{56,41},
          {78,41}}, color={0,0,127}));
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnits/SeriesFanVVF/Subsequences/Validation/Alarms.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms\">
