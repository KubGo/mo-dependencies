within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.Validation;
model ModeAndSetPoints
  "Validate block for specifying zone mode and setpoints"

  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.ModeAndSetPoints
    modSetPoi(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant cooDemLimLev(
    final k=0)
    "Cooling demand limit level"
    annotation (Placement(transformation(extent={{-120,-150},{-100,-130}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant heaDemLimLev(
    final k=0)
