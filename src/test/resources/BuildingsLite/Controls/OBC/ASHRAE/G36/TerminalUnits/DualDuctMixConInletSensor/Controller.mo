within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor;
block Controller "Controller for dual-duct terminal unit using mixing control with inlet flow sensor"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TColSup(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    final displayUnit="degC")
    ...
    annotation (Placement(transformation(extent={{-280,-10},{-240,30}}),
        iconTransformation(extent={{-140,-30},{-100,10}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VColDucDis_flow(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1CooAHU
    "Cooling air handler status"
    annotation (Placement(transformation(extent={{-280,-70},{-240,-30}}),
        iconTransformation(extent={{-140,-70},{-100,-30}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput THotSup(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    final displayUnit="degC")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VHotDucDis_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
    ...
    annotation (Placement(transformation(extent={{-280,-130},{-240,-90}}),
        iconTransformation(extent={{-140,-90},{-100,-50}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HeaAHU
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput oveCooDamPos
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput oveHeaDamPos
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yCooDam(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yHeaDam(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yColFloSenAla
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yColLeaDamAla
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotFloSenAla
    "Hot-duct airflow sensor calibration alarm"
    annotation (Placement(transformation(extent={{240,-290},{280,-250}}),
        iconTransformation(extent={{100,-190},{140,-150}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHotLeaDamAla
    "Leaking hot-duct damper alarm"
    annotation (Placement(transformation(extent={{240,-320},{280,-280}}),
        iconTransformation(extent={{100,-210},{140,-170}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.ActiveAirFlow
    actAirSet(
    final VCooMax_flow=VCooMax_flow,
    final VHeaMax_flow=VHeaMax_flow) "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests
    sysReq(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Alarms
    ala(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Overrides
    setOve(
    final VMin_flow=VMin_flow,
    final VCooMax_flow=VCooMax_flow,
    final VHeaMax_flow=VHeaMax_flow) "Override setpoints"
    annotation (Placement(transformation(extent={{60,-100},{80,-80}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupCoo(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Dampers
    damDuaSen(
    final VCooMax_flow=VCooMax_flow,
    final VHeaMax_flow=VHeaMax_flow,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupHea(
    final samplePeriod=samplePeriod,
    final chaRat=chaRat,
    final maxTim=maxSupTim,
    final dTHys=dTHys)
...
equation
  ...
  connect(u1CooAHU, damDuaSen.u1CooAHU) annotation (Line(points={{-260,-50},{-44,-50},
  ...
  connect(damDuaSen.yHeaDam, setOve.uHeaDam) annotation (Line(points={{22,6},{40,
          6},{40,-99},{58,-99}}, color={0,0,127}));
  ...
  connect(setPoi.VAdjAreBreZon_flow, VAdjAreBreZon_flow) annotation (Line(
        points={{-138,150},{260,150},{260,150}}, color={0,0,127}));
...
annotation (defaultComponentName="duaDucCon",
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-200},{100,200}}), graphics={
        ...
        Text(
          ...
          textString="TZon"),
        Text(
          extent={{-100,178},{-56,164}},
          textColor={0,0,127},
          textString="TCooSet"),
        Text(
          extent={{-100,158},{-56,144}},
          textColor={0,0,127},
          textString="THeaSet"),
        Text(
          visible=have_winSen,
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.ActiveAirFlow\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.ActiveAirFlow</a>.
</p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Dampers\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Dampers</a>.
</p>
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests</a>.
</p>
<h4>e. Alarms</h4>
<p>
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Alarms\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Alarms</a>.
</p>
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Overrides\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Overrides</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
