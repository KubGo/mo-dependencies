...
block SumZone "Calculate the sum of zone level setpoints"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uOpeMod[nGro]
    "Groups operation mode"
    annotation (Placement(transformation(extent={{-260,160},{-220,200}}),
        iconTransformation(extent={{-140,70},{-100,110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VAdjPopBreZon_flow[nZon](
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VAdjAreBreZon_flow[nZon](
    final min=fill(0,nZon),
    final unit=fill("m3/s",nZon),
    final quantity=fill("VolumeFlowRate", nZon))
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VZonPri_flow[nZon](
    final min=fill(0,nZon),
    final unit=fill("m3/s",nZon),
    final quantity=fill("VolumeFlowRate", nZon))
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VMinOA_flow[nZon](
    final min=fill(0,nZon),
    final unit=fill("m3/s",nZon),
    final quantity=fill("VolumeFlowRate", nZon))
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VSumAdjPopBreZon_flow(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VSumAdjAreBreZon_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VSumZonPri_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput uOutAirFra_max(
    final min=0,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MatrixGain groFlo(
    final K=zonGroMat)
    "Vector of total zone flow of each group"
    annotation (Placement(transformation(extent={{-140,90},{-120,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MatrixGain groFlo1(
    final K=zonGroMat)
    "Vector of total zone flow of each group"
    annotation (Placement(transformation(extent={{-140,30},{-120,50}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea[nGro]
    "Convert boolean to real"
    annotation (Placement(transformation(extent={{-40,170},{-20,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul[nGro]
    "Find the total flow of zone group"
    annotation (Placement(transformation(extent={{20,110},{40,130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul1[nGro]
    "Find the total flow of zone group"
    annotation (Placement(transformation(extent={{20,50},{40,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum(
    final nin=nGro)
    "Sum of the adjusted population component breathing zone flow rate"
    annotation (Placement(transformation(extent={{80,110},{100,130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum1(
    final nin=nGro)
    "Sum of the adjusted area component breathing zone flow rate"
    annotation (Placement(transformation(extent={{80,50},{100,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MatrixGain groFlo2(
    final K=zonGroMat)
    "Vector of total zone flow of each group"
    annotation (Placement(transformation(extent={{-140,-30},{-120,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul2[nGro]
    "Find the total flow of zone group"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum2(
    final nin=nGro)
    "Sum of the zone primary airflow rates for all zones in all zone groups that are in occupied mode"
    annotation (Placement(transformation(extent={{80,-10},{100,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div1[nZon]
    "Zone outdoor air fraction"
    annotation (Placement(transformation(extent={{-40,-110},{-20,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MatrixGain groFlo3(
    final K=zonGroMatTra)
    "Vector of zones in occupied mode"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul3[nZon]
    "Vector of zone outdoor air fraction"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMax mulMax(
    final nin=nZon)
    "Maximum zone outdoor air fraction"
    annotation (Placement(transformation(extent={{140,-80},{160,-60}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant occMod[nGro](
    final k=fill(BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied,nGro))
    "Occupied mode index"
    annotation (Placement(transformation(extent={{-180,130},{-160,150}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu1[nGro]
    "Check if operation mode is occupied"
    annotation (Placement(transformation(extent={{-100,170},{-80,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max max2[nZon] "Avoid devide by zero"
    annotation (Placement(transformation(extent={{-100,-150},{-80,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant neaZer[nZon](
    final k=fill(1E-4, nZon))
    "Near zero value"
    annotation (Placement(transformation(extent={{-160,-180},{-140,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Min min1[nZon] "Use smaller value"
...
<p>
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1.Setpoints\">
BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1.Setpoints</a> for the detailed
