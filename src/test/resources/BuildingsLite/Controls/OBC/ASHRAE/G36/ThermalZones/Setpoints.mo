within BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones;
block Setpoints
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1Occ if have_occSen
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput TCooSet(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput THeaSet(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yAla "Alarm level"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edg "If demand limit is imposed"
    annotation (Placement(transformation(extent={{-220,-10},{-200,10}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler cooSetFre
    "Freeze current cooling setpoint when demand limit is imposed"
    annotation (Placement(transformation(extent={{-160,140},{-140,160}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not3 "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not1 "Logic not"
    annotation (Placement(transformation(extent={{0,140},{20,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar3(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro6
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,140},{100,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,100},{100,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro1
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,60},{100,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro2
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,20},{100,40}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler heaSetFre
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not2 "Logical not"
    annotation (Placement(transformation(extent={{0,-80},{20,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro7
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar6(
    final p=-decTSetDem_1)
    "Decrease heating setpoint when at demand limit level 1"
    annotation (Placement(transformation(extent={{40,-120},{60,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar5(
    final p=-decTSetDem_2)
    "Decrease heating setpoint when at demand limit level 2"
    annotation (Placement(transformation(extent={{40,-160},{60,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter addPar4(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro5
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,-200},{100,-180}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro4
    "Output product of the two inputs"
    annotation (Placement(transformation(extent={{80,-160},{100,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro3
    "Output product of the two inputs"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truHol(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edg1
    "Instant when the zone becomes more than 5 minutes"
    annotation (Placement(transformation(extent={{-40,-280},{-20,-260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter heaSetDec(
    final p=-0.5)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.AddParameter cooSetInc(
    final p=0.5)
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler cooSetSam
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler heaSetSam
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add1 "Adjusted heating setpoint"
    annotation (Placement(transformation(extent={{140,240},{160,260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add2 "Adjusted cooling setpoint"
    annotation (Placement(transformation(extent={{-200,340},{-180,360}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Limiter cooSetLim(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Limiter heaSetLim(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.warmUp)
    "Warm-up mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.coolDown)
    "Cooldown mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant cooSetAdjCon(
    final k=have_locAdj)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant heaSetAdjCon(
    final k=have_locAdj)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea1
    "Convert boolean to real value"
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea6
    "Convert boolean to real value"
    annotation (Placement(transformation(extent={{40,140},{60,160}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea2
    "Convert boolean to real value"
    annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea3
    "Convert boolean to real value"
    annotation (Placement(transformation(extent={{-40,-120},{-20,-100}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea4
    "Convert boolean to real value"
    annotation (Placement(transformation(extent={{-40,-160},{-20,-140}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea5
    "Convert boolean to real value"
    annotation (Placement(transformation(extent={{-40,-200},{-20,-180}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea7
    "Convert boolean to real value"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not5  "Other than occupied mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi19
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi20
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi21
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi22
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu7
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt8(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.heating3)
    "Heat demand limit level 3"
    annotation (Placement(transformation(extent={{-160,-200},{-140,-180}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu8
    "Check if the heating demand limit level is level 3"
    annotation (Placement(transformation(extent={{-100,-200},{-80,-180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not4 "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt6(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.heating1)
    "Heat demand limit level 1"
    annotation (Placement(transformation(extent={{-160,-120},{-140,-100}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu6
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt7(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.heating2)
    "Heat demand limit level 2"
    annotation (Placement(transformation(extent={{-160,-160},{-140,-140}})));
  BuildingsLite.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr
    "Check if cooling demand limit level is higher than level zero"
    annotation (Placement(transformation(extent={{-340,-20},{-320,0}})));
  BuildingsLite.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr1
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt3(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.cooling1)
    "Cool demand limit level 1"
    annotation (Placement(transformation(extent={{-160,100},{-140,120}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu3
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt4(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.cooling2)
    "Cool demand limit level 2"
    annotation (Placement(transformation(extent={{-160,62},{-140,82}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu4
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt5(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.cooling3)
    "Cool demand limit level 3"
    annotation (Placement(transformation(extent={{-160,20},{-140,40}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Equal intEqu5
    "Check if the cooling demand limit level is level 3"
    annotation (Placement(transformation(extent={{-100,20},{-80,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add3 "Add real inputs"
    annotation (Placement(transformation(extent={{120,118},{140,138}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add4 "Add real inputs"
    annotation (Placement(transformation(extent={{120,40},{140,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add5 "Add real inputs"
    annotation (Placement(transformation(extent={{160,80},{180,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add6 "Add real inputs"
    annotation (Placement(transformation(extent={{120,-100},{140,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add7 "Add real inputs"
    annotation (Placement(transformation(extent={{120,-180},{140,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add8 "Add real inputs"
    annotation (Placement(transformation(extent={{160,-140},{180,-120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not winOpe if have_winSen "Window is open"
