...
block ReturnFanDirectPressure
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController conTyp=
  ...
  parameter Real Ti(
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Pressure controller",
      enable=conTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
          or conTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real Td(
    final unit="s",
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Pressure controller",
      enable=conTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or conTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1MinOutAirDam
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1RetFan
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line linExhAirDam
    "Exhaust air damper position"
    annotation (Placement(transformation(extent={{60,170},{80,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line linRetFanStaPre
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide div "Normalized the control error"
    annotation (Placement(transformation(extent={{-80,110},{-60,130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line linRetFanSpe "Return fan speed"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retFanDisPreMin(
    final k=p_rel_RetFan_min) "Return fan discharge static pressure minimum setpoint"
    annotation (Placement(transformation(extent={{0,40},{20,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retFanDisPreMax(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zer1(final k=0)
    "Zero constant"
    annotation (Placement(transformation(extent={{-40,112},{-20,132}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con(final k=0.5)
    "Constant 0.5"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conOne(final k=1)
    "Constant one"
    annotation (Placement(transformation(extent={{-100,170},{-80,190}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And enaDam
    "Check if the relief damper should be enabled"
    annotation (Placement(transformation(extent={{-40,80},{-20,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retFanSpeMin(
    final k=disSpe_min)
    "Return fan speed when discharge static pressure minimum setpoint"
    annotation (Placement(transformation(extent={{-40,-90},{-20,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retFanSpeMax(
    final k=disSpe_max)
