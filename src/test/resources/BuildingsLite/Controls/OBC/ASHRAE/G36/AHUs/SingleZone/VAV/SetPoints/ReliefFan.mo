...
block ReliefFan "Sequence for control of relief fan in AHU"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1RelFan
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or relDam
    "Open relief damper"
    annotation (Placement(transformation(extent={{100,30},{120,50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And relFan
    "Turn on relief fan"
    annotation (Placement(transformation(extent={{40,-70},{60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea2
    "Convert boolean to real"
    annotation (Placement(transformation(extent={{100,-70},{120,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply pro1 "Relief fan speed"
