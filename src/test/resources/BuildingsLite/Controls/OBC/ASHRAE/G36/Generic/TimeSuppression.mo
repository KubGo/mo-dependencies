...
block TimeSuppression
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSet(
    final unit="K",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yAftSup
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Min supTim
    "Calculated suppression time due to the setpoint change"
    annotation (Placement(transformation(extent={{80,0},{100,20}})));
protected
  BuildingsLite.Controls.OBC.CDL.Discrete.Sampler samSet(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxSupTim(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Pre pre1 "Use left-limit of signal to break algebraic loop"
    annotation (Placement(transformation(extent={{80,-160},{100,-140}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Switch pasSupTim
    "Check if suppression time has passed"
    annotation (Placement(transformation(extent={{140,-110},{160,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Greater pasSup
    "Check if the change has been suppressed by sufficient time"
    annotation (Placement(transformation(extent={{20,-160},{40,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract temDif
