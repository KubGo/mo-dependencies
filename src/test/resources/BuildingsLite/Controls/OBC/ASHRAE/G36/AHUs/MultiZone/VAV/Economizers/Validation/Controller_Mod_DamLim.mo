within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Validation;
model Controller_Mod_DamLim
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller
    eco(
    final minOADes=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersAirflow,

    final buiPreCon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReliefFan,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller
    eco1(
    final minOADes=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OutdoorAirSection.DedicatedDampersPressure,

    final buiPreCon=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.PressureControl.ReturnFanMeasuredAir,
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanSta(final k=true)
    "Fan is on"
    annotation (Placement(transformation(extent={{-80,-110},{-60,-90}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant freProSta(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TOutBelowCutoff(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp uTSup(
    final duration=1800,
    final height=2,
    final offset=-1)
    "Supply air temperature control signal"
    annotation (Placement(transformation(extent={{-120,-50},{-100,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supFanSpe(
    final duration=1800,
    final height=0.5,
...
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller</a> control loops:
