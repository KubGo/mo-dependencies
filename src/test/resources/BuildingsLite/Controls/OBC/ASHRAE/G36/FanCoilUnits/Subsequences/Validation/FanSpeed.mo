within BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.Validation;
block FanSpeed
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed fanSpe2(
    have_cooCoi=true,
    have_heaCoi=true)
    "Instance demonstrating variation of operating mode"
    annotation (Placement(transformation(extent={{80,120},{100,140}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed fanSpe1(
    have_cooCoi=true,
    have_heaCoi=true)
    "Instance demonstrating variation of cooling loop signal"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed fanSpe3(
    have_cooCoi=true,
    have_heaCoi=false)
    "Instance demonstrating variation of cooling loop signal with no heating coil"
    annotation (Placement(transformation(extent={{80,-10},{100,10}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed fanSpe4(
    have_cooCoi=false,
    have_heaCoi=true)
    "Instance demonstrating variation of heating loop signal with no cooling coil"
    annotation (Placement(transformation(extent={{-40,-140},{-20,-120}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed fanSpe5(
    have_cooCoi=false,
    have_heaCoi=false)
    "Instance demonstrating variation of operating mode with no heating and cooling coils"
    annotation (Placement(transformation(extent={{80,-140},{100,-120}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ram(
    height=6,
    duration=70,
    offset=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul(
    period=100)
    "Fan proven on signal"
    annotation (Placement(transformation(extent={{-100,130},{-80,150}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin(
    freqHz=1/50)
    "Heating loop signal"
    annotation (Placement(transformation(extent={{-100,100},{-80,120}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul1(
    period=100)
    "Fan proven on signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul2(
    period=100)
    "Fan proven on signal"
    annotation (Placement(transformation(extent={{-100,0},{-80,20}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin2(
    freqHz=1/50)
    "Cooling loop signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul3(
    period=100)
    "Fan proven on signal"
    annotation (Placement(transformation(extent={{20,0},{40,20}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin1(
    freqHz=1/50)
    "Cooling loop signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul4(
    period=100)
    "Fan proven on signal"
    annotation (Placement(transformation(extent={{-100,-130},{-80,-110}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sin3(
    freqHz=1/50)
    "Heating loop signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ram1(
    height=6,
    duration=70,
    offset=1)
    "Operating mode signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger reaToInt5
    "Real to Integer conversion"
    annotation (Placement(transformation(extent={{50,-100},{70,-80}})));

  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul5(
    period=100)
    "Fan proven on signal"
...
BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed</a>. 
