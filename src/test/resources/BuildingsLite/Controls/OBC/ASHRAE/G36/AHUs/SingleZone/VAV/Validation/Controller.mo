within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Validation;
model Controller "Validation of the top-level controller"
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Controller conVAV(
    ...
    final freSta=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TZon(
    final duration=86400,
    final height=6,
    final offset=273.15 + 16)
    "Measured zone temperature"
    annotation (Placement(transformation(extent={{-180,110},{-160,130}})));
  BuildingsLite.Controls.SetPoints.OccupancySchedule occSch(
    final occupancy=3600*{4,20})
    "Occupancy schedule"
    annotation (Placement(transformation(extent={{-140,130},{-120,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TOut(
    final k=273.15 +17)
    "Outdoor air dry bulb temperature"
    annotation (Placement(transformation(extent={{-180,190},{-160,210}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooDowTim(
    final k=1800)
    "Cooling down time"
    annotation (Placement(transformation(extent={{-140,170},{-120,190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant warUpTim(
    final k=1800)
    "Warm-up time"
    annotation (Placement(transformation(extent={{-180,150},{-160,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin cooSetAdj(
    final freqHz=1/28800)
    "Cooling setpoint adjustment"
    annotation (Placement(transformation(extent={{-150,-30},{-130,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin heaSetAdj(
    final freqHz=1/28800,
    final amplitude=0.5)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant zerAdj(
    final k=0)
    "Zero adjustment"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse occSta(
    final period=28800,
    final width=0.95)
    "Generate signal indicating occupancy status"
    annotation (Placement(transformation(extent={{-140,-70},{-120,-50}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant demLimLev(
    final k=0)
    "Demand limit level"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp mixTem(
    final height=-5,
    final offset=273.15 + 8,
    final duration=3600)
    "Mixed air temperature"
    annotation (Placement(transformation(extent={{-140,-150},{-120,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp outDam(
    final height=0.6,
    final offset=0.2,
    final duration=86400)
    "Outdoor damper position"
    annotation (Placement(transformation(extent={{-180,-170},{-160,-150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp cooCoi(
    final height=-0.3,
    final offset=0.96,
    final duration=86400,
    startTime=1000) "Cooling coil position"
    annotation (Placement(transformation(extent={{-140,-190},{-120,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaCoi(
    final k=0)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant THeaSetOcc(
    final k=293.15)
    "Occupied heating setpoint"
    annotation (Placement(transformation(extent={{-140,90},{-120,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TCooSetOcc(
    final k=297.15)
    "Occupied cooling setpoint"
    annotation (Placement(transformation(extent={{-180,70},{-160,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant THeaSetUno(
    final k=285.15)
    "Unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{-140,50},{-120,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TCooSetUno(
    final k=303.15)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
