within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF;
block Controller
  ...
  parameter Boolean permit_occStandby=true
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
                              and have_occSen));
  parameter Real VOccMin_flow(unit="m3/s")
    "Zone minimum outdoor airflow for occupants"
    annotation (Dialog(enable=venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24));
  ...
  parameter CDL.Types.SimpleController controllerTypeVal=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
    "Type of controller"
    annotation (__cdl(ValueInReference=false),
  ...
  parameter Real TiVal(unit="s")=300
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Damper and valve control", group="Valve",
      enable=controllerTypeVal == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
          or controllerTypeVal == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdVal(unit="s")=0.1
    "Time constant of derivative block for valve control"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Damper and valve control", group="Valve",
      enable=controllerTypeVal == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or controllerTypeVal == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter CDL.Types.SimpleController controllerTypeDam=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI "Type of controller"
    annotation (__cdl(ValueInReference=false),
  ...
  parameter Real TiDam(unit="s")=300
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Damper and valve control", group="Damper",
      enable=(controllerTypeDam == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
           or controllerTypeDam == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Real TdDam(unit="s")=0.1
    "Time constant of derivative block for damper control"
    annotation (__cdl(ValueInReference=false),
                Dialog(tab="Damper and valve control", group="Damper",
      enable=(controllerTypeDam == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
           or controllerTypeDam == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)));
  ...
  parameter Real thrTDis_1(unit="K")=17
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(tab="System requests", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  parameter Real durTimDisAir(unit="s")=300
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(tab="System requests", group="Duration time", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  parameter Real hotWatRes=1
    ...
    annotation (__cdl(ValueInReference=false), Dialog(tab="Alarms", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  parameter Real lowTemTim(unit="s")=600
    ...
    annotation (__cdl(ValueInReference=true), Dialog(tab="Alarms", enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TCooSet(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    final displayUnit="degC")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput THeaSet(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    final displayUnit="degC")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSupSet(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput oveFloSet
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput oveDamPos
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput oveFan
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput uHeaOff
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VSet_flow(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yDam(
    final min=0,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yVal(
    final min=0,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VFan_flow_Set(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y1Fan
    "Terminal fan command on"
    annotation (Placement(transformation(extent={{240,180},{280,220}}),
        iconTransformation(extent={{100,100},{140,140}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VAdjPopBreZon_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
    "Adjusted population component breathing zone flow rate"
    annotation (Placement(transformation(extent={{240,150},{280,190}}),
        iconTransformation(extent={{100,80},{140,120}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VAdjAreBreZon_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
    "Adjusted area component breathing zone flow rate"
    annotation (Placement(transformation(extent={{240,120},{280,160}}),
        iconTransformation(extent={{100,60},{140,100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VMinOA_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
    "Minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{240,90},{280,130}}),
        iconTransformation(extent={{100,40},{140,80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VZonAbsMin_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "Zone absolute minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{240,60},{280,100}}),
        iconTransformation(extent={{100,20},{140,60}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VZonDesMin_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "Zone design minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{240,30},{280,70}}),
        iconTransformation(extent={{100,0},{140,40}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yCO2(
    final unit="1") if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "CO2 control loop signal"
    annotation (Placement(transformation(extent={{240,0},{280,40}}),
        iconTransformation(extent={{100,-20},{140,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yZonTemResReq
    "Zone cooling supply air temperature reset request"
    annotation (Placement(transformation(extent={{240,-70},{280,-30}}),
        iconTransformation(extent={{100,-40},{140,0}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yZonPreResReq
    "Zone static pressure reset requests"
    annotation (Placement(transformation(extent={{240,-100},{280,-60}}),
        iconTransformation(extent={{100,-60},{140,-20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yHeaValResReq
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.ActiveAirFlow
    actAirSet(final VCooMax_flow=VCooMax_flow) "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-40,90},{-20,110}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.SystemRequests
    sysReq(
    final heaCoi=heaCoi,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.ControlLoops conLoo(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms
    ala(
    final heaCoi=heaCoi,
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Overrides
    setOve "Override setpoints"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSup(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1.Setpoints setPoi(
    ...
    final dTHys=dTHys) if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
    "Output the minimum outdoor airflow rate setpoint, when using ASHRAE 62.1"
    annotation (Placement(transformation(extent={{-120,160},{-100,180}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves
    damVal(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul1
...
equation
  ...
  connect(u1TerFan, ala.u1TerFan) annotation (Line(points={{-260,-300},{10,-300},
          {10,-247},{158,-247}}, color={255,0,255}));
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.ZoneStates\">
BuildingsLite.Controls.OBC.ASHRAE.G36.ThermalZones.ZoneStates</a> to generate the
...
airflow rate limits. 
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.ActiveAirFlow\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.ActiveAirFlow</a>.
</p>
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves</a>.
</p>
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.SystemRequests\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.SystemRequests</a>.
</p>
<h4>e. Alarms</h4>
<p>
...
alarm.
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms</a>.
</p>
...
See <a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Overrides\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Overrides</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
