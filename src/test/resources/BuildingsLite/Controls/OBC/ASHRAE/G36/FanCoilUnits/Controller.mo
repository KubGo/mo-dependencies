within BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits;
block Controller
  ...
  parameter Real heaDea(
    ...
    annotation (__cdl(ValueInReference=false),
      Dialog(enable=heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  parameter Real cooDea(
    ...
    annotation(__cdl(ValueInReference=false),
      Dialog(enable=cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
             or cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil));

  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController cooConTyp=
    ...
    annotation (Dialog(tab="PID parameters", group="Cooling loop control",
      enable=cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
             or cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil));
  ...
  parameter Real TiCoo(
    ...
    annotation(Dialog(tab="PID parameters", group="Cooling loop control",
      enable=(cooConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
              or cooConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
          and (cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
               or cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)));
  ...
  parameter Real TdCoo(
    ...
    annotation (Dialog(tab="PID parameters", group="Cooling loop control",
      enable=(cooConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
              or cooConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
          and (cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
               or cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)));

  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController heaConTyp=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiHea(
    ...
    annotation(Dialog(tab="PID parameters", group="Heating loop control",
      enable=(heaConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
             or heaConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
        and (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
             or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric)));
  ...
  parameter Real TdHea(
    ...
    annotation (Dialog(tab="PID parameters", group="Heating loop control",
      enable=(heaConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
              or heaConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
          and (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
              or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric)));

  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController cooCoiConTyp=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiCooCoi(
    ...
    annotation(Dialog(tab="PID parameters", group="Cooling coil control",
      enable=(cooCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
             or cooCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
        and (cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
             or cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)));
  ...
  parameter Real TdCooCoi(
    ...
    annotation (Dialog(tab="PID parameters", group="Cooling coil control",
      enable=(cooCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
              or cooCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
          and (cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
              or cooCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil)));

  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController heaCoiConTyp=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
  ...
  parameter Real TiHeaCoi(
    ...
    annotation(Dialog(tab="PID parameters", group="Heating coil control",
    enable=(heaCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
            or heaCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
        and (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
             or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric)));
  ...
  parameter Real TdHeaCoi(
    ...
    annotation (Dialog(tab="PID parameters", group="Heating coil control",
      enable=(heaCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
              or heaCoiConTyp == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID)
          and (heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
              or heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric)));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput nOcc if have_occSen
    "Number of occupants"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput TSupSet(
    final unit="K",
    displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yFan(
    final min=0,
    final max=1,
    final unit="1")
    "Fan command speed"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.PlantRequests fcuPlaReq(
    final have_hotWatCoi=heaCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased,
    final have_chiWatCoi=cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased,
    ...
    final dFanSpe=dFanSpe)
      if cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
      or heaCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Block for generating chilled water requests and hot water requests for their respective plants"
    annotation (Placement(transformation(extent={{120,-60},{140,-40}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant unOccMod(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed fanSpe(
    final have_cooCoi=cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
                   or cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.DXCoil,
    final have_heaCoi=heaCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
                   or heaCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.Electric,
...
protected
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant win(
...
equation
  ...
  connect(u1Win, modSetPoi.u1Win) annotation (Line(points={{-240,-260},{-150,-260},
          {-150,219},{-142,219}}, color={255,0,255}));
  connect(havOcc.y, modSetPoi.u1OccSen) annotation (Line(points={{-178,-200},{-164,
          -200},{-164,192},{-142,192}},                     color={255,0,255}));
  ...
  connect(modSetPoi.TCooSet,TSupAir.TZonCooSet)  annotation (Line(points={{-118,
          206},{-50,206},{-50,42},{38,42}},    color={0,0,127}));
  connect(modSetPoi.THeaSet,TSupAir.TZonHeaSet)  annotation (Line(points={{-118,
          198},{-54,198},{-54,55},{38,55}},    color={0,0,127}));
  ...
  connect(nOcc, havOcc.u) annotation (Line(points={{-240,-200},{-202,-200}},
          color={255,127,0}));
...
<code>yFanSpe</code>.
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed\">
BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.FanSpeed</a> for a detailed
description.
</p>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.SupplyAirTemperature\">
BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.SupplyAirTemperature</a>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.PlantRequests\">
BuildingsLite.Controls.OBC.ASHRAE.G36.FanCoilUnits.Subsequences.PlantRequests</a>
for a detailed description.
</p>
</html>",
revisions="<html>
