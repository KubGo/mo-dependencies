within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences;
...
equation
  ...
  connect(TSup, addPar2.u)
    annotation (Line(points={{-260,-240},{-202,-240}}, color={0,0,127}));
  connect(TDis, gre2.u1) annotation (Line(points={{-260,-310},{-220,-310},{-220,
          -210},{-142,-210}}, color={0,0,127}));
  connect(addPar2.y, gre2.u2) annotation (Line(points={{-178,-240},{-160,-240},{
  ...
  connect(booToInt.u, and3.y)
    annotation (Line(points={{78,330},{62,330}}, color={255,0,255}));
  ...
  connect(and16.y, not10.u) annotation (Line(points={{22,90},{40,90},{40,60},{58,
          60}}, color={255,0,255}));
  connect(and17.y, booToInt7.u)
    annotation (Line(points={{22,20},{78,20}}, color={255,0,255}));
  connect(and17.y, not11.u) annotation (Line(points={{22,20},{40,20},{40,-10},{58,
          -10}}, color={255,0,255}));
  ...
  connect(cloDam.y, leaDamAla1.u2) annotation (Line(points={{-178,-120},{-10,-120},
          {-10,-78},{-2,-78}}, color={255,0,255}));
...
<p>
This block outputs alarms of series fan-powered terminal unit with variable volume fan.
The implementation is according to the Section 5.10.6 of ASHRAE Guideline 36, May 2020.
</p>
<h4>Low airflow</h4>
<ol>
<li>
