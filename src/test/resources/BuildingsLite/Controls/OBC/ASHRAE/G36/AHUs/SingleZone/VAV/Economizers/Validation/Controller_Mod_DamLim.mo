within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Validation;
model Controller_Mod_DamLim
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Controller economizer(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Controller economizer1(
    final eneStd=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1,
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant zonSta(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.ZoneStates.deadband)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TSupSetSig(
    final k=TSupSet) "Heating supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-80,40},{-60,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TSupSig(
    final k=TSup) "Measured supply air temperature"
    annotation (Placement(transformation(extent={{-80,80},{-60,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TSupSig1(
    final duration=900,
    final height=2,
    final offset=TSupSet - 1) "Measured supply air temperature"
    annotation (Placement(transformation(extent={{40,80},{60,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp VOutMinSetSig(
    final duration=1800,
    final offset=VOutMin_flow,
    final height=VOutDes_flow - VOutMin_flow) "Minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{-40,80},{-20,100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp SupFanSpeSig(
    final duration=1800,
...
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Controller</a> control loops:
