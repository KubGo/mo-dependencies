...
block SupplyTemperature
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond maxSupTemRes(
    final delTim=delTim,
    final iniSet=iniSet,
    final minSet=minSet,
    final maxSet=maxSet,
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minOutTem(
    final k=TOut_min)
    "Lower value of the outdoor air temperature reset range"
    annotation (Placement(transformation(extent={{-60,130},{-40,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxOutTem(
    final k=TOut_max)
    "Higher value of the outdoor air temperature reset range"
    annotation (Placement(transformation(extent={{-60,90},{-40,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minSupTem(
    final k=TSupCoo_min)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant supTemWarUpSetBac(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.LessThreshold intLesThr1(
    final t=6)
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.LessThreshold intLesThr2(
    final t=3)
