...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VOutMinSetSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp VOutMinSetSig1(
    final duration=1800,
    final offset=VOutMin_flow,
    final height=VOutDes_flow - VOutMin_flow) "Constant minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant SupFanSpeSig1(
