...
model SupplySignals
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse supFanSta(period=7200)
    "Supply fan status"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse TSup(
    final amplitude=14,
    final period=7200,
    final offset=10 + 273.15)
    "Supply air temperature"
    annotation (Placement(transformation(extent={{-80,30},{-60,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TSupSet(
    final height=3,
    final duration=7200,
    final offset=15 + 273.15)
    "Supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplySignals supSig1
    "Output valve position and supply air temperature control loop signal"
    annotation (Placement(transformation(extent={{20,0},{40,20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanOn(
    final k=true) "Fan on"
