...
model ZoneGroupSystem
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneGroupSystem ahuMod(
    final nGro=3)
    "AHU operation mode selection"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));

  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Pulse groOne(
    final period=4,
    final offset=1)
    "Group 1 mode"
    annotation (Placement(transformation(extent={{-60,40},{-40,60}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Pulse groTwo(
    final amplitude=2,
    final period=10,
    final offset=1)
    "Group 2 mode"
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant groThr(
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneGroupSystem\">
BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneGroupSystem</a>
