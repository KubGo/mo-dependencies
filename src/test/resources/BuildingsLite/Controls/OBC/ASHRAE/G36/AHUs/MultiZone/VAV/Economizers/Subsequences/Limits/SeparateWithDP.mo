within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits;
block SeparateWithDP
  ...
  parameter Boolean have_CO2Sen=false
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=venStd==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24));
  ...
  parameter Real minSpe(unit="1")
     ...
     annotation (__cdl(ValueInReference=false));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController dpCon=
  ...
  parameter Real TiDp(unit="s")=0.5
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="DP control",
      enable=dpCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or
             dpCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdDp(unit="s")=0.1
    "Time constant of derivative block"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="DP control",
      enable=dpCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or
             dpCon == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCO2Loo_max(final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yOutDam_max(
    final min=outDamPhy_min,
    final max=outDamPhy_max,
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRetDam_min(
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRetDam_max(
    final min=retDamPhy_min,
    final max=retDamPhy_max,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yRetDamPhy_max(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply minDp if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1
    "Minimum pressure difference setpoint when complying with ASHRAE 62.1"
    annotation (Placement(transformation(extent={{-120,160},{-100,180}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset maxRetDam(
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minDesDp(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch enaDis
    "Enable or disable return air damper minimum outdoor air control"
    annotation (Placement(transformation(extent={{80,0},{100,20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And enaRetDamMin
    "Enable return air damper minimum outdoor air control"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Or disRetDamMin
    "Disable return air damper minimum outdoor air control"
    annotation (Placement(transformation(extent={{40,-70},{60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not disMinDam "Check if the minimum outdoor air damper is closed"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And enaMinDam1
    "Check if the minimum outdoor air damper should be enabled, one of two stacked And blocks"
    annotation (Placement(transformation(extent={{-100,60},{-80,80}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And enaMinDam2
    "Check if the minimum outdoor air damper should be enabled, one of two stacked And blocks"
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant one(
    final k=1) "Constant"
    annotation (Placement(transformation(extent={{-200,-130},{-180,-110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minFanSpe(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line moaP(
    final limitBelow=true,
    final limitAbove=true)
    "Linear mapping of the supply fan speed to the control signal"
    annotation (Placement(transformation(extent={{-120,-100},{-100,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outDamPhyPosMinSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant outDamPhyPosMaxSig(
    final k=outDamPhy_max)
    "Physically fixed maximum position of the outdoor air damper."
    annotation (Placement(transformation(extent={{-200,-220},{-180,-200}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retDamPhyPosMinSig(
    final k=retDamPhy_min)
    "Physically fixed minimum position of the return air damper"
    annotation (Placement(transformation(extent={{-200,-260},{-180,-240}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant retDamPhyPosMaxSig(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retDamPosMaxSwi
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch retDamPosMinSwi
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant minAbsDp(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line minDp1(
    final limitAbove=true)
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant one1(
    final k=1)
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "Design fan speed"
    annotation (Placement(transformation(extent={{-60,230},{-40,250}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant hal(
    final k=0.5)
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "Constant"
    annotation (Placement(transformation(extent={{-60,290},{-40,310}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant one2(
    final k=1)
    if not have_CO2Sen and venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "Design fan speed"
    annotation (Placement(transformation(extent={{-120,240},{-100,260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply actAbsMinDp
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
    "Active absolute minimum pressure difference setpoint"
    annotation (Placement(transformation(extent={{-120,300},{-100,320}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply actDesMinDp
    if venStd == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU</a>
if complying with ASHRAE 62.1 requirements. Otherwise, see the set points in
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU</a>
