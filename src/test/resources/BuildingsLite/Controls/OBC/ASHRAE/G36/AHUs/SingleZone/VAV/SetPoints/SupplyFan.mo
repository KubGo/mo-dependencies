...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxDewPoi(
    final k=TSupDew_max)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxCooFanSpe(
    final k=maxCooSpe)
    "Maximum fan speed for cooling"
    annotation (Placement(transformation(extent={{-120,70},{-100,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line medFanSpe
    "Medium fan speed"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line heaFanSpe
    "Fan speed when it is in heating state"
    annotation (Placement(transformation(extent={{80,30},{100,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant speOnePoi(
    final k=spePoiOne)
    "Speed control point one in x-axis of control map"
    annotation (Placement(transformation(extent={{-140,0},{-120,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxHeaFanSpe(
    final k=maxHeaSpe)
    "Maximum fan speed for heating"
    annotation (Placement(transformation(extent={{-180,70},{-160,90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant speTwoPoi(
    final k=spePoiTwo)
    "Speed control point two in x-axis of control map"
    annotation (Placement(transformation(extent={{-140,-40},{-120,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant speThrPoi(
    final k=spePoiThr)
    "Speed control point three in x-axis of control map"
    annotation (Placement(transformation(extent={{-140,-100},{-120,-80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant speFouPoi(
    final k=spePoiFou)
    "Speed control point four in x-axis of control map"
    annotation (Placement(transformation(extent={{-140,-160},{-120,-140}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line cooFanSpe1
    "Fan speed when it is in cooling state"
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line cooFanSpe2
    "Fan speed when it is in cooling mode"
    annotation (Placement(transformation(extent={{60,-190},{80,-170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max spe
    "Fan speed"
    annotation (Placement(transformation(extent={{180,-10},{200,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch cooFan
    "Fan speed when it is in cooling state"
