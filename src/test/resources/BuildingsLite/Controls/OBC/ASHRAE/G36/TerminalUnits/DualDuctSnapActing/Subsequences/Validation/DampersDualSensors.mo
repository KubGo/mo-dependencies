...
model DampersDualSensors
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Subsequences.DampersDualSensors dam1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TCooSup(
    final k=273.15 + 13)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin VColDuc(
    final offset=0.015,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant THeaSup(
    final k=273.15 + 25)
    "AHU supply air temperature"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse heaAhu(
    final width=0.75,
    final period=7200,
    final shift=5000)
    "Hot air handling unit status"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin VHotDuc(
    final offset=0.015,
    final amplitude=0.002,
    final freqHz=1/3600)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnits/DualDuctSnapActing/Subsequences/Validation/DampersDualSensors.mos"
        "Simulate and plot"),
...
BBuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Subsequences.DampersDualSensors</a>
