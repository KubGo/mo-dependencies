...
block PlantRequests "Output plant requests for multizone air handling unit"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TAirSupSet(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCooCoiSet(
    final unit="1",
    final min=0,
    final max=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uHeaCoiSet(
    final unit="1",
    final min=0,
    final max=1) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
...
protected
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract cooSupTemDif
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant thr(
    final k=3) "Constant 3"
    annotation (Placement(transformation(extent={{0,222},{20,242}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch chiWatRes3
    if cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Send 3 chilled water reset request"
    annotation (Placement(transformation(extent={{160,190},{180,210}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch chiWatRes2
    if cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Send 2 chilled water reset request"
    annotation (Placement(transformation(extent={{120,140},{140,160}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant two(
    final k=2)
    "Constant 2"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch chiWatRes1
    if cooCoi == BuildingsLite.Controls.OBC.ASHRAE.G36.Types.CoolingCoil.WaterBased
    "Send 1 chilled water reset request"
    annotation (Placement(transformation(extent={{80,90},{100,110}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant one(
    final k=1) "Constant 1"
    annotation (Placement(transformation(extent={{0,110},{20,130}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant zer(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract heaSupTemDif
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay truDel2(
    final delayTime=300) if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Check if the input has been true for a certain time"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatRes3
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Send 3 hot water reset request"
    annotation (Placement(transformation(extent={{160,-50},{180,-30}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatRes2
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Switch hotWatRes1
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat3
    if heaCoi==BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.WaterBased
    "Keep true signal until other condition becomes true"
