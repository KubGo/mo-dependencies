...
model Alarms "Validation of model that generates alarms"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.Alarms ala(
    final staPreMul=1,
    final hotWatRes=1,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.Alarms\">
