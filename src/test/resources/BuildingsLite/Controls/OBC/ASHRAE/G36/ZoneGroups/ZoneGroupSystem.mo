...
block ZoneGroupSystem
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.IntegerToReal intToRea[nGro]
    "Convert integer to real"
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiMin mulMin(nin=nGro)
    "Find the highest priotity operating mode"
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger ahuMod
    "Air handling operating mode"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yAhuOpeMod
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes</a> for the detailed
description.
</p>
</html>", revisions="<html>
<ul>
