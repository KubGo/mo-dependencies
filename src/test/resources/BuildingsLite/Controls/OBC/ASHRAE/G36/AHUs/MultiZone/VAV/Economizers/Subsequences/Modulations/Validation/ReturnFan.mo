...
model ReturnFan
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan ecoMod
    "Multi zone VAV AHU minimum outdoor air control - damper modulation"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));

  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan ecoMod1(
