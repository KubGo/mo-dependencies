...
block Dampers
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController damCon=
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal cooSta
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt5(final k=2)
    "Constant 2"
    annotation (Placement(transformation(extent={{-120,-290},{-100,-270}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal cloDam(
    final realTrue=0)
    "Full closed damper position"
    annotation (Placement(transformation(extent={{0,-230},{20,-210}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal opeDam(
    final realTrue=1)
    "Full open damper position"
    annotation (Placement(transformation(extent={{0,-270},{20,-250}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add3
    "Add up inputs"
