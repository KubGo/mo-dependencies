within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers;
block Controller "Single zone VAV AHU economizer control sequence"
  ...
  parameter Real uMax(
    ...
    annotation (__cdl(ValueInReference=false));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController controllerTypeMod=
  ...
  parameter Real TiMod(
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=controllerTypeMod == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
          or controllerTypeMod == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter Real TdMod(
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Modulation",
      enable=controllerTypeMod == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or controllerTypeMod == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TSupHeaEcoSet(
    final unit="K",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VOutMinSet_flow(
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uZonSta "Zone state signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput uOpeMod "AHU operation mode status signal"
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Enable
    enaDis(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Limits
    damLim(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Modulation
    mod(
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Limits\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Limits</a>
for a description.
</li>
<li>
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Enable\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Enable</a>
for a description.
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.AirEconomizerHighLimits\">
BuildingsLite.Controls.OBC.ASHRAE.G36.Generic.AirEconomizerHighLimits</a>
for a description.
</li>
<li>
...
See
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Modulation\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Modulation</a>
for a description.
</li>
</ul>
</html>", revisions="<html>
