within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24;
block AHU "AHU level setpoint calculation"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VEffAbsOutAir_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput effAbsOutAir_normalized(
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VEffDesOutAir_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput effDesOutAir_normalized(
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant absOutAir(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Min min2 "Effective outdoor air design minimum setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide norVOutMin1
    "Normalization for minimum outdoor air flow rate"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line effOutAir(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Divide norVOutMin2 if have_CO2Sen
    "Normalization for minimum outdoor air flow rate"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone\">
BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone</a> for the detailed
description.
</li>
<li>
