within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences;
block Alarms "Generate alarms of dual-duct terminal unit using mixing control with inlet sensor"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1CooFan
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCooDam(
    final min=0,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HeaFan
    "Heating air handler supply fan status"
    annotation (Placement(transformation(extent={{-280,-260},{-240,-220}}),
        iconTransformation(extent={{-140,-80},{-100,-40}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uHeaDam(
    final min=0,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not5
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaMaxFlo(
    final k=VHeaMax_flow)
     "Heating maximum airflow setpoint"
    annotation (Placement(transformation(extent={{-180,-210},{-160,-190}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai3(final k=0.1)
    "Percentage of the setpoint"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold cloDam1(
    final t=damPosHys,
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not8
    "Logical not"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Or fanOn
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla2
    "Check if generating leak damper alarms"
    annotation (Placement(transformation(extent={{20,-90},{40,-70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And leaDamAla3
    "Check if generating leak damper alarms"
...
equation
  ...
  connect(and2.y,and7. u1) annotation (Line(points={{-18,320},{-2,320}},
                          color={255,0,255}));
  connect(greThr1.y,and7. u2) annotation (Line(points={{-58,150},{-10,150},{-10,
          312},{-2,312}}, color={255,0,255}));
  connect(and1.y, and4.u1) annotation (Line(points={{-18,240},{-2,240}},
                    color={255,0,255}));
  connect(greThr1.y, and4.u2) annotation (Line(points={{-58,150},{-10,150},{-10,
          232},{-2,232}}, color={255,0,255}));
  ...
  connect(u1HeaFan, leaDamAla1.u2) annotation (Line(points={{-260,-240},{-220,-240},
          {-220,-318},{-22,-318}},color={255,0,255}));
  ...
  connect(and5.y, truDel2.u)
    annotation (Line(points={{2,50},{38,50}}, color={255,0,255}));
  connect(truDel2.y, booToInt2.u)
    annotation (Line(points={{62,50},{158,50}}, color={255,0,255}));
  connect(truDel2.y, not4.u) annotation (Line(points={{62,50},{70,50},{70,20},{78,
          20}}, color={255,0,255}));
  ...
  connect(gre2.y, leaDamAla1.u1) annotation (Line(points={{-58,-180},{-50,-180},
          {-50,-310},{-22,-310}},color={255,0,255}));
  ...
  connect(occMod.y, isOcc.u2) annotation (Line(points={{-138,-60},{-100,-60},{-100,
          -48},{-82,-48}}, color={255,127,0}));
  connect(uOpeMod, isOcc.u1)
    annotation (Line(points={{-260,-40},{-82,-40}}, color={255,127,0}));
  connect(gai.y, les.u2) annotation (Line(points={{-178,290},{-172,290},{-172,
          312},{-162,312}}, color={0,0,127}));
  connect(and3.y, lowFloAla.u2)
    annotation (Line(points={{62,320},{138,320}}, color={255,0,255}));
  connect(and3.y, not1.u) annotation (Line(points={{62,320},{70,320},{70,280},{78,
          280}}, color={255,0,255}));
  connect(and8.y, booToInt.u)
    annotation (Line(points={{62,240},{78,240}}, color={255,0,255}));
  connect(and8.y, not2.u) annotation (Line(points={{62,240},{70,240},{70,200},{78,
          200}}, color={255,0,255}));
  connect(and7.y, and3.u1)
    annotation (Line(points={{22,320},{38,320}}, color={255,0,255}));
  connect(and4.y, and8.u1)
    annotation (Line(points={{22,240},{38,240}}, color={255,0,255}));
  connect(isOcc.y, and3.u2) annotation (Line(points={{-58,-40},{30,-40},{30,312},
          {38,312}}, color={255,0,255}));
  connect(isOcc.y, and8.u2) annotation (Line(points={{-58,-40},{30,-40},{30,232},
          {38,232}}, color={255,0,255}));
  ...
  connect(cloDam.y, leaDamAla2.u2) annotation (Line(points={{-158,-120},{10,-120},
          {10,-88},{18,-88}}, color={255,0,255}));
  connect(leaDamAla1.y, leaDamAla3.u1)
    annotation (Line(points={{2,-310},{18,-310}}, color={255,0,255}));
  connect(leaDamAla3.y, truDel5.u)
    annotation (Line(points={{42,-310},{58,-310}}, color={255,0,255}));
  connect(cloDam1.y, leaDamAla3.u2) annotation (Line(points={{-158,-350},{10,-350},
          {10,-318},{18,-318}}, color={255,0,255}));
