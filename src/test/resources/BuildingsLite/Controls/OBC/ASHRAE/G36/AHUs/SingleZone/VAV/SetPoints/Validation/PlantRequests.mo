...
model PlantRequests
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests plaReq1(
    heaCoi=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.HeatingCoil.None)
    "Calculate plant request"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supTem2(
    final height=7,
