within BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Validation;
model SeparateWithDP
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP disMinCon(
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP disMinCon1(
    final venStd=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
  ...
  BuildingsLite.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP minCon(
    final venStd=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VOutMinSet_flow(
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanStatus(
    final k=true) "Fan is on"
    annotation (Placement(transformation(extent={{120,10},{140,30}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant operationMode(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant opeMod1(
    final k=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.warmUp)
    "AHU operation mode is Occupied"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VOutMinSet_flow1(
    final k=minVOutSet_flow)
    "Outdoor airflow rate setpoint, 15cfm/occupant and 100 occupants"
    annotation (Placement(transformation(extent={{-220,50},{-200,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanSta(
    final k=false)
    "Fan is off"
    annotation (Placement(transformation(extent={{-220,10},{-200,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp outDamPos(
    final duration=1800,
    final offset=0.1,
    final height=0.5) "Outdoor air damper position"
    annotation (Placement(transformation(extent={{-220,-70},{-200,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant supFanSpe(
    final k=0) "Supply fan speed"
    annotation (Placement(transformation(extent={{-220,-110},{-200,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VOutMinSet_flow2(
    final k=minVOutSet_flow)
    "Outdoor airflow rate setpoint, 15cfm/occupant and 100 occupants"
    annotation (Placement(transformation(extent={{-60,50},{-40,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fanSta1(
    final k=true)
    "Fan is on"
    annotation (Placement(transformation(extent={{-60,10},{-40,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp outDamPos1(
    final duration=1800,
    final offset=0.1,
    final height=0.5) "Outdoor air damper position"
    annotation (Placement(transformation(extent={{-60,-70},{-40,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant supFanSpe1(
    final k=0.2) "Supply fan speed"
    annotation (Placement(transformation(extent={{-60,-110},{-40,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp outDamPos2(
    final duration=1800,
    final offset=0.1,
    final height=0.5) "Outdoor air damper position"
    annotation (Placement(transformation(extent={{120,-70},{140,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp supFanSpe2(
    final height=0.5,
    final duration=1800,
    final offset=0.1)
    "Supply fan speed"
    annotation (Placement(transformation(extent={{120,-110},{140,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp dpDam(
    final duration=1800,
    final offset=250,
    final height=100) "Pressure accross outdoor air damper"
    annotation (Placement(transformation(extent={{-220,90},{-200,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp dpDam1(
    final duration=1800,
    final offset=250,
    final height=100) "Pressure accross outdoor air damper"
    annotation (Placement(transformation(extent={{-60,90},{-40,110}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp dpDam2(
    final duration=1800,
    final offset=120,
