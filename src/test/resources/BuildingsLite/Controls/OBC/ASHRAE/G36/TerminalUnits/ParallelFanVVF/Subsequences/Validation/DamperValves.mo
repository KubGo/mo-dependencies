within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Subsequences.Validation;
model DamperValves
  "Validate model for controlling damper and valve position"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Subsequences.DamperValves damValFan1(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant VOAMin_flow(
...
equation
  ...
  connect(TSupSet.y, damValFan1.TSupSet) annotation (Line(points={{-78,-20},{36,
          -20},{36,-73},{78,-73}}, color={0,0,127}));
  connect(TSup.y, damValFan1.TSup) annotation (Line(points={{-78,60},{52,60},{52,
          -63},{78,-63}}, color={0,0,127}));
  connect(THeaSet.y, damValFan1.THeaSet) annotation (Line(points={{-38,-40},{32,
          -40},{32,-75},{78,-75}},     color={0,0,127}));
  ...
  connect(booPul.y, damValFan1.u1Fan) annotation (Line(points={{-38,40},{40,40},
          {40,-71},{78,-71}}, color={255,0,255}));
annotation (
...
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Subsequences.DamperValves\">
BBuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Subsequences.DamperValves</a>
