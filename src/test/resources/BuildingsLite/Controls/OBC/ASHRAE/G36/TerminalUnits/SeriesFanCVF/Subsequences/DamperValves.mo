...
block DamperValves
  ...
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController controllerTypeVal=
  ...
  parameter Real TdVal(
    ...
    annotation (__cdl(ValueInReference=false),
      ...
      enable=controllerTypeVal == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD
          or controllerTypeVal == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID));
  parameter BuildingsLite.Controls.OBC.CDL.Types.SimpleController controllerTypeDam=
    BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI
    "Type of controller"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uCoo(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VActCooMax_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VActMin_flow(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1Fan
    ...
    annotation (Placement(transformation(extent={{-360,10},
            {-320,50}}), iconTransformation(extent={{-140,-20},{-100,20}})));
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput uHea(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput VPri_flow_Set(
    final min=0,
    final unit="m3/s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput yDam(
    ...
    annotation (Placement(transformation(extent={{320,-32},{360,8}}),
        iconTransformation(extent={{100,70},{140,110}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput THeaDisSet(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
...
protected
  BuildingsLite.Controls.OBC.CDL.Logical.And and4 "Logical and"
    annotation (Placement(transformation(extent={{-40,140},{-20,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line lin
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conZer(
    final k=0) "Constant zero"
    annotation (Placement(transformation(extent={{-280,220},{-260,240}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conOne(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conZer3(
    final k=0)
    "Constant zero"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conHal(
    final k=1)
    "Constant real value"
    annotation (Placement(transformation(extent={{-180,-80},{-160,-60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line conTDisHeaSet
    "Discharge air temperature for heating"
    annotation (Placement(transformation(extent={{-120,-50},{-100,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset conVal(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant unOcc(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch swi3 "Air damper position"
    annotation (Placement(transformation(extent={{240,0},{260,20}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat "Close damper"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant occ(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Multiply mul
    "Ensure damper is fully closed before turning on the fan"
    annotation (Placement(transformation(extent={{280,-22},{300,-2}})));
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal minFlo(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add2 "Add up two inputs"
    annotation (Placement(transformation(extent={{20,310},{40,330}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Add add1 "Add up inputs"
...
equation
  ...
  connect(isUno.y, swi3.u2) annotation (Line(points={{122,-170},{140,-170},{140,
          10},{238,10}}, color={255,0,255}));
  connect(conZer3.y, swi3.u1) annotation (Line(points={{-238,0},{40,0},{40,18},
          {238,18}}, color={0,0,127}));
  connect(conDam.y, swi3.u3) annotation (Line(points={{282,170},{300,170},{300,
          80},{220,80},{220,2},{238,2}},color={0,0,127}));
  ...
  connect(greThr1.y,or5. u1) annotation (Line(points={{-198,170},{-80,170},{-80,
          -250},{-62,-250}}, color={255,0,255}));
  connect(greThr2.y,or5. u2) annotation (Line(points={{-238,-110},{-100,-110},{-100,
          -258},{-62,-258}}, color={255,0,255}));
  connect(edg.y, lat.u)
  ...
  connect(booToRea.y, mul.u2) annotation (Line(points={{202,-270},{240,-270},{240,
          -18},{278,-18}}, color={0,0,127}));
  connect(swi3.y, mul.u1) annotation (Line(points={{262,10},{270,10},{270,-6},{
          278,-6}}, color={0,0,127}));
  connect(mul.y, yDam)
    annotation (Line(points={{302,-12},{340,-12}}, color={0,0,127}));
  ...
  connect(u1Fan, conDam.trigger) annotation (Line(points={{-340,30},{264,30},{264,
          158}}, color={255,0,255}));
  connect(or2.y, swi8.u2)
    annotation (Line(points={{102,270},{138,270}}, color={255,0,255}));
  connect(forMinFlo.y, or2.u1) annotation (Line(points={{-98,300},{-80,300},{-80,
          270},{78,270}}, color={255,0,255}));
  connect(or1.y, or2.u2) annotation (Line(points={{42,250},{60,250},{60,262},{78,
          262}}, color={255,0,255}));
  connect(isOcc.y, or4.u2) annotation (Line(points={{-178,-230},{-120,-230},{-120,
          -278},{-22,-278}}, color={255,0,255}));
  connect(or5.y, or4.u1) annotation (Line(points={{-38,-250},{-30,-250},{-30,-270},
          {-22,-270}}, color={255,0,255}));
  connect(or4.y, edg.u)
    annotation (Line(points={{2,-270},{38,-270}}, color={255,0,255}));
  connect(or4.y, and2.u2) annotation (Line(points={{2,-270},{20,-270},{20,-348},
          {38,-348}}, color={255,0,255}));
  connect(or4.y, falEdg.u) annotation (Line(points={{2,-270},{20,-270},{20,-380},
