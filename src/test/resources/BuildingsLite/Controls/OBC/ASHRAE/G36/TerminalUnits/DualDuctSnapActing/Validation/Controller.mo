within BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Validation;
model Controller
  "Validation of model that controls dual-duct unit with snap-acting control"

  BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Controller duaDucCon(
    final venStd=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin TZon(
    final freqHz=1/86400,
    final amplitude=4,
    final offset=299.15)
    "Zone temperature"
    annotation (Placement(transformation(extent={{-120,210},{-100,230}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp disAirTem(
    final height=2,
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse winSta(
    final width=0.05,
    final period=43200,
    final shift=43200)
    "Window opening status"
    annotation (Placement(transformation(extent={{-80,150},{-60,170}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooSet(
    final k=273.15 + 24)
    "Zone cooling setpoint temperature"
    annotation (Placement(transformation(extent={{-80,190},{-60,210}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaSet(
    final k=273.15 + 20)
    "Zone heating setpoint temperature"
    annotation (Placement(transformation(extent={{-120,170},{-100,190}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse occ(
    final width=0.75,
    final period=43200,
    final shift=28800) "Occupancy status"
    annotation (Placement(transformation(extent={{-120,130},{-100,150}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp opeMod(
    final offset=1,
    final height=2,
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger reaToInt2
    "Convert real to integer"
    annotation (Placement(transformation(extent={{-40,100},{-20,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round2(
    final n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-80,100},{-60,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin CO2(
    final amplitude=400,
    final freqHz=1/28800,
    final offset=600) "CO2 concentration"
    annotation (Placement(transformation(extent={{-80,50},{-60,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp colSupAirTem(
    final height=2,
    final duration=43200,
    final offset=273.15 + 14)
    "Cold-duct supply air temperature from air handling unit"
    annotation (Placement(transformation(extent={{-80,10},{-60,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin VColDis_flow(
    final offset=1.2,
    final amplitude=0.6,
    final freqHz=1/28800) "Cold duct airflow rate"
    annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp oveFlo(
    final height=2,
    final duration=10000,
    final startTime=35000)
    "Override flow setpoint"
    annotation (Placement(transformation(extent={{-120,-120},{-100,-100}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger reaToInt1
    "Convert real to integer"
    annotation (Placement(transformation(extent={{-40,-120},{-20,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round1(
    final n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-80,-120},{-60,-100}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp oveColDam(
    final height=2,
    final duration=5000,
    startTime=60000) "Override cold-duct damper position"
    annotation (Placement(transformation(extent={{-120,-150},{-100,-130}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger reaToInt3
    "Convert real to integer"
    annotation (Placement(transformation(extent={{-40,-150},{-20,-130}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round3(
    final n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-80,-150},{-60,-130}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse cooSupFanSta(
    final width=0.9,
    final period=73200,
    final shift=18800) "Cooling supply fan status"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp oveHotDam(
    final height=2,
    final duration=5000,
    final startTime=60000) "Override hot-duct damper position"
    annotation (Placement(transformation(extent={{-120,-180},{-100,-160}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger reaToInt4
    "Convert real to integer"
    annotation (Placement(transformation(extent={{-40,-180},{-20,-160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Round round4(
    final n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-80,-180},{-60,-160}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse heaSupFanSta(
    final width=0.9,
    final period=73200,
    final shift=18800) "Heating supply fan status"
    annotation (Placement(transformation(extent={{-120,-90},{-100,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin VHotDis_flow(
    final offset=1.2,
    final amplitude=0.6,
    final freqHz=1/28800) "Hot duct airflow rate"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp hotSupAirTem(
    final height=2,
    final duration=43200,
    final offset=273.15 + 24)
    "Hot-duct supply air temperature from air handling unit"
    annotation (Placement(transformation(extent={{-120,-50},{-100,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant CO2Set(
    final k=894)
...
equation
  connect(TZon.y,duaDucCon. TZon) annotation (Line(points={{-98,220},{60,220},{
          60,79},{98,79}}, color={0,0,127}));
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnits/DualDuctSnapActing/Validation/Controller.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Controller\">
BuildingsLite.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
