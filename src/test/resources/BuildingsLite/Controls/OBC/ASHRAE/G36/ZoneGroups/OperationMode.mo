within BuildingsLite.Controls.OBC.ASHRAE.G36.ZoneGroups;
block OperationMode "Block that outputs the operation mode"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput maxCooDowTim(
    final unit="s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1HigOccCoo
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput maxWarUpTim(
    final unit="s",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1OccHeaHig
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1EndSetBac
    "True when the setback mode could end"
    annotation (Placement(transformation(extent={{-400,-70},{-360,-30}}),
        iconTransformation(extent={{-140,-60},{-100,-20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput TZonMin(
    final unit="K",
    displayUnit="degC",
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput totHotZon
    "Total number of hot zone"
    annotation (Placement(transformation(extent={{-400,-210},{-360,-170}}),
      iconTransformation(extent={{-140,-140},{-100,-100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1SetUp
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u1EndSetUp
    "True when the setup mode could end"
    annotation (Placement(transformation(extent={{-400,-290},{-360,-250}}),
        iconTransformation(extent={{-140,-200},{-100,-160}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput yOpeMod
    "Operation mode"
    annotation (Placement(transformation(extent={{360,-18},{400,22}}),
      iconTransformation(extent={{100,-20},{140,20}})));

protected
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant occModInd(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant unoPerInd(final k=0.0)
    "Index to indicate unoccupied period"
    annotation (Placement(transformation(extent={{0,340},{20,360}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch corCooDowTim "Corrected cool down period"
    annotation (Placement(transformation(extent={{-220,240},{-200,260}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch corWarUpTim "Corrected warm-up period"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat1
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Latch lat2
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hys2(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hys3(
    final pre_y_start=true,
    final uHigh=0,
    final uLow=-60)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub5
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hys4(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant maxWarCooTime(
    final k=preWarCooTim)
    "Allowed maximum warm-up or cool-down time"
    annotation (Placement(transformation(extent={{-340,190},{-320,210}})));
  BuildingsLite.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr2(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt "Sum of two integer inputs"
    annotation (Placement(transformation(extent={{240,280},{260,300}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt1 "Sum of two integer inputs"
    annotation (Placement(transformation(extent={{276,304},{296,324}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt2 "Sum of two integer inputs"
    annotation (Placement(transformation(extent={{140,-50},{160,-30}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt3 "Sum of two integer inputs"
    annotation (Placement(transformation(extent={{200,-180},{220,-160}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt4 "Sum of two integer inputs"
    annotation (Placement(transformation(extent={{260,-320},{280,-300}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt5 "Sum of two integer inputs"
    annotation (Placement(transformation(extent={{320,-8},{340,12}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger occMod
    "Convert Real number to Integer number"
    annotation (Placement(transformation(extent={{200,310},{220,330}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger setBacMod
    "Convert Real number to Integer number"
    annotation (Placement(transformation(extent={{100,20},{120,40}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger freProSetBacMod
    "Convert Real number to Integer number"
    annotation (Placement(transformation(extent={{100,-100},{120,-80}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger setUpMod
    "Convert Real number to Integer number"
    annotation (Placement(transformation(extent={{100,-200},{120,-180}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edg
    "Get the moment when the warm up time starts "
    annotation (Placement(transformation(extent={{-50,150},{-30,170}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol(
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol1(
    final trueHoldDuration=preWarCooTim)
    "Hold the start time true signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea1(
    final realTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.warmUp)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(
    final realTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.coolDown)
    "Convert Boolean to Integer number"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt3(
    final integerTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.unoccupied)
    "Convert Boolean to Integer "
    annotation (Placement(transformation(extent={{160,-370},{180,-350}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea6(
    final realTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.setUp)
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea4(
    final realTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.freezeProtection)
    "Convert Boolean to Real "
    annotation (Placement(transformation(extent={{-20,-100},{0,-80}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal booToRea3(
    final realTrue=BuildingsLite.Controls.OBC.ASHRAE.G36.Types.OperationModes.setBack)
    "Convert Boolean to Real "
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And and1 "Warm-up period"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.GreaterThreshold notOcc(
    final t=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not not1 "Logical not"
    annotation (Placement(transformation(extent={{200,80},{220,100}})));
  BuildingsLite.Controls.OBC.CDL.Utilities.Assert winOpe(
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger setBacMod1
    "Convert Real number to Integer number"
  ...
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger setBacMod2
    "Convert Real number to Integer number"
    annotation (Placement(transformation(extent={{180,180},{200,200}})));
  BuildingsLite.Controls.OBC.CDL.Logical.And and4 "Cool-down period"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub1
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub3
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract sub4
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge endSetBac
    "End setback mode when the input becomes true"
    annotation (Placement(transformation(extent={{-160,-60},{-140,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Edge endSetUp
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt6
    "Total cold zone and zones with opening window"
    annotation (Placement(transformation(extent={{-330,-10},{-310,10}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Add addInt7
...
equation
  ...
  connect(not2.y,booToInt3. u)
    annotation (Line(points={{142,-360},{158,-360}},
      color={255,0,255}));
  connect(and1.y,booToRea1. u)
    annotation (Line(points={{42,180},{78,180}}, color={255,0,255}));
  connect(and1.y,or9. u1)
    annotation (Line(points={{42,180},{68,180},{68,112},{-190,112},{-190,70},{-142,
          70}},   color={255,0,255}));
  ...
  connect(booToInt3.y, addInt4.u2) annotation (Line(points={{182,-360},{200,-360},
          {200,-316},{258,-316}},       color={255,127,0}));
  ...
  connect(and4.y,or9. u2) annotation (Line(points={{42,270},{60,270},{60,120},{-200,
          120},{-200,62},{-142,62}},     color={255,0,255}));
  ...
  connect(lat2.y, or5.u1) annotation (Line(points={{-78,-190},{-40,-190},{-40,-320},
          {-22,-320}},       color={255,0,255}));
  connect(lat1.y, or5.u2) annotation (Line(points={{-78,-90},{-50,-90},{-50,-328},
  ...
  connect(u1Occ, or8.u2) annotation (Line(points={{-380,370},{-350,370},{-350,52},
          {-102,52}}, color={255,0,255}));
  connect(or8.y, or6.u2) annotation (Line(points={{-78,60},{-70,60},{-70,-368},{
          78,-368}}, color={255,0,255}));
  connect(or8.y, swi5.u2) annotation (Line(points={{-78,60},{40,60},{40,-190},{58,
          -190}}, color={255,0,255}));
  connect(or8.y, swi4.u2) annotation (Line(points={{-78,60},{40,60},{40,-90},{58,
          -90}}, color={255,0,255}));
  connect(or8.y, swi3.u2) annotation (Line(points={{-78,60},{40,60},{40,30},{58,
          30}}, color={255,0,255}));
  connect(or9.y, or8.u1) annotation (Line(points={{-118,70},{-110,70},{-110,60},
          {-102,60}}, color={255,0,255}));
  connect(or10.y, or6.u1) annotation (Line(points={{62,-340},{70,-340},{70,-360},
          {78,-360}}, color={255,0,255}));
  connect(or5.y, or10.u1) annotation (Line(points={{2,-320},{20,-320},{20,-340},
          {38,-340}}, color={255,0,255}));
  connect(lat.y, or10.u2) annotation (Line(points={{-78,30},{-60,30},{-60,-348},
