...
block DamperValves
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VActCooMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VActHeaMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput VActHeaMax_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate")
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput TDisSet(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line lin3
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Switch watValPosUno "Output hot water valve position"
    annotation (Placement(transformation(extent={{280,-110},{300,-90}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Switch damPosUno "Output damper position"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lowMin(
    final t=TDisMin,
    final h=dTHys)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conZer2(
    final k=0)
    "Constant zero"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant conOne2(
    final k=1)
    "Constant real value"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant lowDisAirTem(
    final k=TDisMin)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add1
    "Add up inputs"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal forMinFlo1
    "Check if forcing zone airflow setpoint to minimum flow"
    annotation (Placement(transformation(extent={{-140,330},{-120,350}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal heaMax(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add4
    "Add up two inputs"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cooMax1(
    final k=VCooMax_flow)
    "Cooling maximum flow"
    annotation (Placement(transformation(extent={{120,140},{140,160}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant heaMax1(
    final k=VHeaMax_flow)
    "Heating maximum flow"
    annotation (Placement(transformation(extent={{120,100},{140,120}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Max max2 "Nominal flow"
