...
model BooleanExtractSignal
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanExtractSignal extBooSig(
    final nin=4,
    final nout=3,
    final extract={3,2,4})
    "Block that extracts signal from a boolean input signal vector"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanExtractSignal extBooSig1(
    final nin=4,
    final nout=5,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.BooleanExtractSignal\">
BuildingsLite.Controls.OBC.CDL.Routing.BooleanExtractSignal</a>.
</p>
<p>
