...
model IntegerExtractSignal
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.IntegerExtractSignal extIntSig(
    final nin=4,
    final nout=3,
    final extract={3,2,4})
    "Block that extracts signal from an integer input signal vector"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  BuildingsLite.Controls.OBC.CDL.Routing.IntegerExtractSignal extIntSig1(
    final nin=4,
    final nout=5,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.IntegerExtractSignal\">
BuildingsLite.Controls.OBC.CDL.Routing.IntegerExtractSignal</a>.
</p>
<p>
