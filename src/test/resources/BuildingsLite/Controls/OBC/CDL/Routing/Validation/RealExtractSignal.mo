...
model RealExtractSignal
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.RealExtractSignal extSig(
    final nin=5,
    final nout=3,
    final extract={1,2,5})
    "Block that extracts signals from an input signal vector"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  BuildingsLite.Controls.OBC.CDL.Routing.RealExtractSignal extSig1(
    final nin=5,
    final nout=6,
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.RealExtractSignal\">
BuildingsLite.Controls.OBC.CDL.Routing.RealExtractSignal</a>.
</p>
<p>
