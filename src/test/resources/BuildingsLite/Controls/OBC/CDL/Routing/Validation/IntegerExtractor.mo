...
model IntegerExtractor
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Pulse intPul1(
    final period=0.3,
    final amplitude=2,
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt1(k=6)
    "Index to extract input signal"
    annotation (Placement(transformation(extent={{0,20},{20,40}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt4(k=0)
    "Index to extract input signal"
    annotation (Placement(transformation(extent={{0,-20},{20,0}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Pulse intPul2(
    final period=1,
    final amplitude=3,
    final offset=-1)
    "Generate pulse signal of type Integer"
    annotation (Placement(transformation(extent={{0,-60},{20,-40}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Pulse intPul3(
    final period=1,
    final amplitude=-3,
    final offset=3)
    "Generate pulse signal of type Integer"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.IntegerExtractor\">
BuildingsLite.Controls.OBC.CDL.Routing.IntegerExtractor</a>.
</p>
<p>
