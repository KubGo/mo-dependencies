...
model IntegerVectorReplicator
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.IntegerVectorReplicator
    intRep(nin=2, nout=3)
    "Block that outputs the vector replicating input value"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ram[2](
    height=fill(5,2),
    duration=fill(1,2),
    offset=fill(-2,2)) "Block that outputs ramp signal"
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.RealToInteger reaToInt[2]
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.IntegerVectorReplicator\">
BuildingsLite.Controls.OBC.CDL.Routing.IntegerVectorReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
