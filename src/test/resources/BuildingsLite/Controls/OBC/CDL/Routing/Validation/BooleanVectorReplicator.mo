...
model BooleanVectorReplicator
  ...
  BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator booRep(nin=2, nout=3)
    "Block that outputs the vector replicating input value"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul[2](period=fill(0.2,2))
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator\">
BuildingsLite.Controls.OBC.CDL.Routing.BooleanVectorReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
