...
model RealExtractor
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ram2(
    final duration=1,
    final height=3,
    final offset=-2)
    "Block that outputs ramp signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse pul1(
    final period=0.2,
    final amplitude=1.5,
    final offset=-0.2)
    "Generate pulse signal of type Real"
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Sources.Constant conInt2(k=0)
    "Index to extract input signal"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Routing.RealExtractor\">
BuildingsLite.Controls.OBC.CDL.Routing.RealExtractor</a>.
</p>
<p>
