...
block Line
  ...
  parameter Boolean limitAbove=true
    ...
    annotation (Evaluate=true);
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput x1
    "Input for support point x1, with x1 < x2"
    annotation (Placement(transformation(extent={{-140,60},{-100,100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput f1
    "Input for support point f(x1)"
    annotation (Placement(transformation(extent={{-140,20},{-100,60}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput x2
    "Input for support point x2, with x2 > x1"
    annotation (Placement(transformation(extent={{-140,-60},{-100,-20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput f2
