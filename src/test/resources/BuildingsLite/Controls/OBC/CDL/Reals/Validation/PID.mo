...
model PID
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID limPID(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID limPI(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID limPD(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID limP(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID noLimPID(
    Ti=1,
    Td=1,
    yMax=1e15,
    yMin=-1e15,
