...
model CalendarTimeMonths
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.CalendarTime calTim(
    zerTim=BuildingsLite.Controls.OBC.CDL.Types.ZeroTime.NY2017)
  ...
  annotation (
    experiment(
      ...
      StopTime=345600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Sources/Validation/CalendarTimeMonths.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
