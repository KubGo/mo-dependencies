...
model IntegratorWithReset
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intDef(final
      y_start=-2)
    "Integrator with default values"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes1(final
      y_start=-2,
    final k=0.5)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant cons(
    final k=10)
    "Constant as source term"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booleanPulse(
    final width=0.5,
    final period=0.2)
    "Boolean pulse"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.SampleTrigger sampleTrigger(
    final period=0.2)
    "Sample trigger"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset\">
BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset</a>
