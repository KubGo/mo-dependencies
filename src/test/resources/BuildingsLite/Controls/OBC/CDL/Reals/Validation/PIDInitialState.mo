...
model PIDInitialState
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant ySet(
    k=0.75)
    "Set point"
    annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant yMea(
    k=0.5)
    "Measured value"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PIDInitialState.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
