within BuildingsLite.Controls.OBC.CDL.Reals;
block PID
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Subtract controlError "Control error (set point - measurement)"
    annotation (Placement(transformation(extent={{-200,-16},{-180,4}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter P(final k=k)
...
protected
  final parameter Real revAct= if reverseActing then 1 else -1
    ...
    final parameter Boolean with_I =
      controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI or
    ...
    final parameter Boolean with_D =
      controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PD or
      controllerType == BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant Dzero(final k=0)
    if not with_D
    "Zero input signal"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter antWinGai(k=1/(k*Ni))
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant Izero(final k=0)
    if not with_I
    "Zero input signal"
    annotation (Placement(transformation(extent={{-50,20},{-30,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant con(final k=0)
    if with_I
    "Constant zero"
    annotation (Placement(transformation(extent={{-100,-50},{-80,-30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant con1(final k=false)
    if with_I
    "Constant false"
