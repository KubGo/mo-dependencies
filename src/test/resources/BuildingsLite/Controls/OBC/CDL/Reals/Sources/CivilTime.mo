...
block CivilTime "Civil time"
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput y(final unit="s")
    "Civil time"
...
Moved block from
<code>BuildingsLite.Utilities.SimulationTime</code>
to
<code>BuildingsLite.Utilities.Time.ModelTime</code>.
</li>
<li>
