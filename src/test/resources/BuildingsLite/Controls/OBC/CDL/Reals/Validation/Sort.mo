...
model Sort
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sort sorAsc(
    nin=5)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sort sorDes(
    nin=5,
    ascending=false)
    "Block that sorts signals in ascending order"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Sort.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Sort\">
BuildingsLite.Controls.OBC.CDL.Reals.Sort</a>.
</p>
<p>
