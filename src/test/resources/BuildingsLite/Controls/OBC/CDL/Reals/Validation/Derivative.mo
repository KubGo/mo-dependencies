...
model Derivative
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Derivative der1(y_start=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes(y_start=1)
    "Integration of input"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  Logical.Sources.Constant booSig(k=false) "Contant boolean signal"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Cos cos "Cosine of model time"
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Derivative der2(y_start=0)
    "Derivative block with input gains"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Abs abs "Absolute difference"
    annotation (Placement(transformation(extent={{110,26},{130,46}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesThr(t=0.1, h=0.01)
    "Output true if difference is within expected accuracy"
    annotation (Placement(transformation(extent={{140,26},{160,46}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai(final k=1)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Derivative\">
BuildingsLite.Controls.OBC.CDL.Reals.Derivative</a>.
