within BuildingsLite.Controls.OBC.CDL.Reals.Validation;
model PIDWithReset
  "Test model for LimPID controller with reset trigger"
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToReal setPoi
    "Set point"
    annotation (Placement(transformation(extent={{-20,-40},{0,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.CivilTime modTim
    "Civil time"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greEquThr(
    t=1)
    "Outputs true after t=1"
    annotation (Placement(transformation(extent={{-52,-70},{-32,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset limPIDPar(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes1
    "Integrator whose output should be brought to the set point"
    annotation (Placement(transformation(extent={{60,60},{80,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset limPIDInp(
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID,
    k=1,
    Ti=1,
    Td=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes2
    "Integrator whose output should be brought to the set point"
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant resVal(
    k=0)
    "Reset value"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset limPIPar(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes3
    "Integrator whose output should be brought to the set point"
    annotation (Placement(transformation(extent={{60,-40},{80,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.PIDWithReset limPIInp(
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PI,
    k=1,
    Ti=1,
    Td=1,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes4
    "Integrator whose output should be brought to the set point"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.PID\">
BuildingsLite.Controls.OBC.CDL.Reals.PID</a>.
</p>
<p>
