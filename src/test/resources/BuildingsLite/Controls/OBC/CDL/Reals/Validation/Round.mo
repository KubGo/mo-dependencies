...
model Round
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai(k=0.1) "Gain"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai1(k=10) "Gain"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Round\">
BuildingsLite.Controls.OBC.CDL.Reals.Round</a>.
</p>
<p>
