...
block MultiSum
  ...
  parameter Real k[nin]=fill(1, nin)
    "Input gains";
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealInput u[nin]
...
<p>
See
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Validation.MultiSum\">
BuildingsLite.Controls.OBC.CDL.Reals.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
