...
model MultiSum
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum_5(
    nin=5,
    k={1,0.5,0.1,1,2})
    "Sum of Reals, y = k[1]*u[1] + k[2]*u[2] + ... + k[5]*u[5]"
    annotation (Placement(transformation(extent={{40,-40},{60,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum_2(
    nin=2,
    k={1,0.5})
    "Sum of Reals, y = k[1]*u[1] + k[2]*u[2]"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum_1(
    nin=1,
    k={1})
    "Sum of Reals, y = k[1]*u[1]"
    annotation (Placement(transformation(extent={{40,40},{60,60}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiSum mulSum_3(
    nin=3)
    "Sum of Reals, y = k[1]*u[1] + k[2]*u[2]"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.MultiSum\">
BuildingsLite.Controls.OBC.CDL.Reals.MultiSum</a>.
</p>
<p>
