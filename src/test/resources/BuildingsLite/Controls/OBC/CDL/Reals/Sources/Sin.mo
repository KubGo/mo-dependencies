  ...
  y=offset+(
    if time < startTime then
      ...
      amplitude*Modelica.Math.sin(
        2*BuildingsLite.Controls.OBC.CDL.Constants.pi*freqHz*(time-startTime)+phase));
  annotation (
...
<p>
<img src=\"modelica://Buildings/Resources/Images/Controls/OBC/CDL/Reals/Sources/Sin.png\"
     alt=\"Sin.png\"/>
</p>
</html>",
      revisions="<html>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Sin\">
BuildingsLite.Controls.OBC.CDL.Reals.Sin</a>.<br/>
This is for
