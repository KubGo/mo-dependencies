...
model Hysteresis
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysteresis(
    final uLow=0,
    final uHigh=1)
    "Transform Real to Boolean signal with Hysteresis"
    annotation (Placement(transformation(extent={{50,30},{70,50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysteresis1(
    final uLow=0,
    final uHigh=1,
    final pre_y_start=true)
    "Transform Real to Boolean signal with Hysteresis"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis hysteresis2(
    final uLow=0+0.01,
    final uHigh=1-0.01)
    "Transform Real to Boolean signal with Hysteresis"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gain1(
    final k=2.5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Hysteresis.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis\">
BuildingsLite.Controls.OBC.CDL.Reals.Hysteresis</a>.
</p>
</html>",
      revisions="<html>
<ul>
