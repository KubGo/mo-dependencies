...
model PIDScale
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID pidSca(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset pla1(
    k=1000)
    "Plant model"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.PID pidNoSca(
    controllerType=BuildingsLite.Controls.OBC.CDL.Types.SimpleController.PID,
    k=2,
    Ti=1,
    Td=2,
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai(k=1/1000)
    "Gain to scale setpoint"
    annotation (Placement(transformation(extent={{-40,-60},{-20,-40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MultiplyByParameter gai1(k=1/1000)
    "Gain to scale measured value"
    annotation (Placement(transformation(extent={{52,-90},{32,-70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.IntegratorWithReset pla2(
    k=1000)
    "Plant model"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PIDScale.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
