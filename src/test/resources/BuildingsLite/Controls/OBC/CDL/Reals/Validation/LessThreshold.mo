...
model LessThreshold
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold les(t=2)
    "Less block, without hysteresis"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold lesHys(t=2, h=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/LessThreshold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold\">
BuildingsLite.Controls.OBC.CDL.Reals.LessThreshold</a>.
