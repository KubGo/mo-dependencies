...
model MovingAverage "Validation model for the MovingAverage block"
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sinInpNoDel(
    freqHz=1/80) "Start from zero second"
    annotation (Placement(transformation(extent={{-90,50},{-70,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve1(delta=100)
    "Moving average with 100 s sliding window"
    annotation (Placement(transformation(extent={{-40,50},{-20,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve2(delta=200)
    "Moving average with 200 s sliding window"
    annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve3(delta=300)
    "Moving average with 300 s sliding window"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve4(delta=400)
    "Moving average with 400 s sliding window"
    annotation (Placement(transformation(extent={{-40,-40},{-20,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve5(delta=500)
    "Moving average with 500 s sliding window"
    annotation (Placement(transformation(extent={{-40,-70},{-20,-50}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sinInp50sDel(
    freqHz=1/80,
    startTime=50)
    "Start from 50 seconds"
    annotation (Placement(transformation(extent={{0,50},{20,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve6(delta=100)
    "Moving average with 100 s sliding window"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve7(delta=200)
    "Moving average with 200 s sliding window"
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Sin sinInp100sDel(
    freqHz=1/80,
    startTime=100)
    "Start from 100 seconds"
    annotation (Placement(transformation(extent={{0,-30},{20,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve8(delta=100)
    "Moving average with 100 s sliding window"
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage movAve9(delta=200)
    "Moving average with 200 s sliding window"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/MovingAverage.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage\">
BuildingsLite.Controls.OBC.CDL.Reals.MovingAverage</a>.
</p>
<p>
