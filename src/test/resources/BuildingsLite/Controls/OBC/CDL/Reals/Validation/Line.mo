...
model Line
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line line1
    "Block that out the value of the input x along a line specified by two points"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant x1(
    k=1.0)
    "Block that generate x1"
    annotation (Placement(transformation(extent={{-60,52},{-40,72}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant f1(
    k=0.5)
    "Block that generate f(x1)"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant x2(
    k=2.0)
    "Block that generate x2"
    annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant f2(
    k=1.5)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Line line2(
    limitAbove=true,
    limitBelow=false)
    "Block that out the value of the input x along a line specified by two points"
    annotation (Placement(transformation(extent={{-10,-40},{10,-20}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Line line3(
    limitBelow=true,
    limitAbove=false)
    "Block that out the value of the input x along a line specified by two points"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Line\">
BuildingsLite.Controls.OBC.CDL.Reals.Line</a>.
</p>
<p>
