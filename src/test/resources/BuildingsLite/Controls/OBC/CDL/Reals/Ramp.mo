...
block Ramp "Limit the changing rate of the input"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput active
...
way as <a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.LimitSlewRate\">
BuildingsLite.Controls.OBC.CDL.Reals.LimitSlewRate</a>. However, the
