...
model GreaterThreshold
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold gre(t=2)
    "Greater block, without hysteresis"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold greHys(t=2, h=1)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold\">
BuildingsLite.Controls.OBC.CDL.Reals.GreaterThreshold</a>.
