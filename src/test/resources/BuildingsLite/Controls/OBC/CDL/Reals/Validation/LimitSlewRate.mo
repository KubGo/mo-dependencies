...
model LimitSlewRate "Validation model for the LimitSlewRate block"
  BuildingsLite.Controls.OBC.CDL.Reals.LimitSlewRate sleRatLim(
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp3(
    offset=0,
    height=-1.5,
    duration=30,
    startTime=120+60)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp4(
    offset=0,
    height=1.5,
    duration=30,
    startTime=120)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp5(
    offset=0,
    height=-1.5,
    startTime=240+60,
    duration=40)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp6(
    offset=0,
    height=1.5,
    startTime=240,
    duration=40)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp7(
    offset=0,
    height=-1.5,
    duration=50,
    startTime=360+60)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp8(
    offset=0,
    height=1.5,
    duration=50,
    startTime=360)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Add add6
    "Signal adder"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.LimitSlewRate\">
BuildingsLite.Controls.OBC.CDL.Reals.LimitSlewRate</a>.
</p>
<p>
