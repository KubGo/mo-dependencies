...
model Ramp "Validation model for the Ramp block"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse pul2(
    final width=0.3,
    final period=12.0,
    final shift=3.0)
    "Boolean pulse"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Ramp.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Reals.Ramp\">
BuildingsLite.Controls.OBC.CDL.Reals.Ramp</a>.
</p>
<ul>
<li>
