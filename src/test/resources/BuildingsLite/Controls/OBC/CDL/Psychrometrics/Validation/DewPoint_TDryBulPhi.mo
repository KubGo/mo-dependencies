...
model DewPoint_TDryBulPhi
  ...
  BuildingsLite.Controls.OBC.CDL.Psychrometrics.DewPoint_TDryBulPhi dewBulPhi
    "Model for dew point temperature"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  BuildingsLite.Controls.OBC.CDL.Psychrometrics.DewPoint_TDryBulPhi dewBulPhi1
    "Model for dew point temperature"
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TDryBul2(
    duration=1,
    height=35,
    offset=273.15+2.0)
    "Dry bulb temperature"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant phi2(
    k=0.4)
    "Relative humidity"
...
equation
  ...
  annotation (
    ...
    Documentation(
      info="<html>
<p>
This examples is a unit test for the dew point temperature computation <a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Psychrometrics.DewPoint_TDryBulPhi\">
BuildingsLite.Controls.OBC.CDL.Psychrometrics.DewPoint_TDryBulPhi</a>.
</p>
</html>",
      revisions="<html>
<ul>
