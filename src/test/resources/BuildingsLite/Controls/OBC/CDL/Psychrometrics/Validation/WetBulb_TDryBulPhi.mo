within BuildingsLite.Controls.OBC.CDL.Psychrometrics.Validation;
model WetBulb_TDryBulPhi
  "Model to test the wet bulb temperature computation"

  BuildingsLite.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi wetBulPhi
    "Model for wet bulb temperature"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  BuildingsLite.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi wetBulPhi1
    "Model for wet bulb temperature"
    annotation (Placement(transformation(extent={{20,-50},{40,-30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp phi(
    duration=1,
    height=0.95,
    offset=0.05) "Relative humidity"
    annotation (Placement(transformation(extent={{-40,10},{-20,30}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TDryBul(
    k=273.15+29.4) "Dry bulb temperature"
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp TDryBul1(
    duration=1,
    height=40,
    offset=273.15) "Dry bulb temperature"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant phi2(k=0.6)
    "Relative humidity"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi\">
BuildingsLite.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi</a>.
</p>
</html>",
      revisions="<html>
<ul>
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL\">BuildingsLite.Controls.OBC.CDL</a> package.<br/>
This is for
...
See  <a href=\"https://github.com/ibpsa/modelica/issues/474\">Buildings, issue 474</a>
for a discussion.
</li>
<li>
