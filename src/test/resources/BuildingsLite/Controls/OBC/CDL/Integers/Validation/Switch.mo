...
model Switch "Validation model for the Switch block"
  BuildingsLite.Controls.OBC.CDL.Integers.Switch integerSwitch
    "Integer switch"
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply proInt "Product"
    annotation (Placement(transformation(extent={{0,40},{20,60}})));
  BuildingsLite.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1
    "Type converter"
    annotation (Placement(transformation(extent={{-40,-80},{-20,-60}})));
  BuildingsLite.Controls.OBC.CDL.Integers.Multiply proInt1 "Product"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Integers.Switch\">
BuildingsLite.Controls.OBC.CDL.Integers.Switch</a>.
</p>
<p>
