...
block Change
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput u
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput up
    "Output that is true when the input increased its value"
    annotation (Placement(transformation(extent={{100,40},{140,80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput down
