...
block Switch
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput u1
    "Input u1"
    annotation (Placement(transformation(extent={{-140,60},{-100,100}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u2
    "Boolean switch input signal, if true, y=u1, else y=u3"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput u3
    "Input u3"
