...
model OnCounter
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.OnCounter onCounter
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse reset(
    width=0.5,
    period=1.0)
    "Block that outputs cyclic on and off"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Integers.OnCounter\">
BuildingsLite.Controls.OBC.CDL.Integers.OnCounter</a>.
</p>
</html>",
      revisions="<html>
<ul>
