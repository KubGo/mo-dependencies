within BuildingsLite.Controls.OBC.CDL.Integers;
block MultiSum
  ...
  parameter Integer k[nin]=fill(1, nin)
    "Input gains";
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerInput u[nin]
    "Inputs to be multipled with gain and added"
    annotation (Placement(transformation(extent={{-140,70},{-100,-70}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.IntegerOutput y
...
<p>
See
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Integers.Validation.MultiSum\">
BuildingsLite.Controls.OBC.CDL.Integers.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
