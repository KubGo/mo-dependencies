within BuildingsLite.Controls.OBC.CDL.Discrete.Validation;
model TriggeredMovingMean
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea(
    n=3)
    "Triggered moving mean with 3 samples to average"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea1(
    n=1)
    "Triggered moving mean with 1 sample to average"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea2(
    n=3)
...
BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredMovingMean</a>.
</p>
</html>",
      revisions="<html>
<ul>
