...
equation
  ...
  connect(booPul.y,triSam.trigger)
    annotation (Line(points={{11,-40},{50,-40},{50,-12},{50,-11.8}},color={255,0,255}));
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler\">
BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler</a>.
</p>
</html>",
      revisions="<html>
<ul>
