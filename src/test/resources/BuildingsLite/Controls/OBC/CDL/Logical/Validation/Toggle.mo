...
model Toggle
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse togInp(
    final width=0.5,
    final period=2)
    "Block that outputs cyclic on and off"
    annotation (Placement(transformation(extent={{-160,150},{-140,170}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant tru(
    final k=true)
    "True clear input"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Constant fal(
    final k=false)
    "False clear input"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.Toggle\">
BuildingsLite.Controls.OBC.CDL.Logical.Toggle</a>. Following tests are implemented:
</p>
<ul>
<li>
