within BuildingsLite.Controls.OBC.CDL.Logical.Validation;
model TrueFalseHold
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol2(
    trueHoldDuration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol3(
    trueHoldDuration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol4(
    trueHoldDuration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol5(
    trueHoldDuration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
    annotation (Placement(transformation(extent={{120,20},{140,40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul6(
    shift=100,
    period=1500)
    "Boolean pulse input signal"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol6(
    trueHoldDuration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
    annotation (Placement(transformation(extent={{120,-20},{140,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse booPul7(
    shift=100,
    period=1000,
    width=0.25)
    "Boolean pulse input signal"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol7(
    trueHoldDuration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
    annotation (Placement(transformation(extent={{120,-60},{140,-40}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not2 "Negation of input signal"
    annotation (Placement(transformation(extent={{70,-20},{90,0}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Not not4
    "Negation of input signal"
    annotation (Placement(transformation(extent={{70,-60},{90,-40}})));

  BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol8(trueHoldDuration=
        0, falseHoldDuration=1000)
    "Hold only false value of unit impulse signal"
    annotation (Placement(transformation(extent={{120,-90},{140,-70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edg "Generate unit impulse signal"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold\">
BuildingsLite.Controls.OBC.CDL.Logical.TrueFalseHold</a>.
</p>
<p>
