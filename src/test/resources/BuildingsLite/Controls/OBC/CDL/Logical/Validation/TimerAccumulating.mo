...
model TimerAccumulating
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TimerAccumulating noThr
    "Accumulating timer that do not compare threshold"
    annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TimerAccumulating thrTim(
    final t=1)
    "Accumulating timer that compares threshold"
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TimerAccumulating noThrWitRes
    "Accumulating timer that could reset the output"
    annotation (Placement(transformation(extent={{40,10},{60,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TimerAccumulating thrTimWitRes(
    final t=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse resTim(
    final width=0.5,
    final period=3.5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/TimerAccumulating.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.TimerAccumulating\">
BuildingsLite.Controls.OBC.CDL.Logical.TimerAccumulating</a>.
</p>
</html>",
      revisions="<html>
<ul>
