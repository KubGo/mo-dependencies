...
model Latch
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.Pulse latInp(
    final width=0.5,
    final period=2)
    "Block that outputs cyclic on and off"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.Latch\">
BuildingsLite.Controls.OBC.CDL.Logical.Latch</a>. Following tests are implemented:
</p>
<ul>
<li>
