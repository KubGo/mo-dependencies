within BuildingsLite.Controls.OBC.CDL.Logical;
block Proof "Verify two boolean inputs"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u_s
    "Commanded status setpoint"
    annotation (Placement(transformation(extent={{-300,-20},{-260,20}}),
        iconTransformation(extent={{-140,-20},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u_m
    "Measured status"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yLocFal
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput yLocTru
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Switch valFal
    "Output false if measured input is stable and changed from true to false"
    annotation (Placement(transformation(extent={{-140,100},{-120,120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Switch cheDif1
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Not notBotFal "Not both false inputs"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And falTru
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay delChe1(
  ...
  BuildingsLite.Controls.OBC.CDL.Integers.Equal equSta
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.And botFal
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Switch cheStaMea
    "Output true if there is no stable measured input"
    annotation (Placement(transformation(extent={{160,110},{180,130}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay delChe2(
    final delayTime=feedbackDelay + debounce)
    "Delay the difference check"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Utilities.Assert\">
BuildingsLite.Controls.OBC.CDL.Utilities.Assert</a>
