...
model TrueDelay
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay0(
    final delayTime=0)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{0,130},{20,150}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay1(
    final delayTime=0.5)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,130},{80,150}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay2(
    final delayTime=0.8)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{0,100},{20,120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay4(
    final delayTime=0)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{0,40},{20,60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay5(
    final delayTime=0.5)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,40},{80,60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay6(
    final delayTime=0.8)
    "Delay a rising edge of the input, but do not delay a falling edge."
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay3(
    final delayTime=1.8)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,100},{80,120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay7(
    final delayTime=1.8)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,10},{80,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay00(
    final delayTime=0,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{0,-50},{20,-30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay11(
    final delayTime=0.5,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,-50},{80,-30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay22(
    final delayTime=0.8,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{0,-80},{20,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay44(
    final delayTime=0,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{0,-140},{20,-120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay55(
    final delayTime=0.5,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,-140},{80,-120}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay66(
    final delayTime=0.8,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay33(
    final delayTime=1.8,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
    annotation (Placement(transformation(extent={{60,-80},{80,-60}})));
  BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay onDelay77(
    final delayTime=1.8,
    final delayOnInit=true)
    "Delay a rising edge of the input, but do not delay a falling edge."
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay\">
BuildingsLite.Controls.OBC.CDL.Logical.TrueDelay</a>.
</p>
</html>",
      revisions="<html>
<ul>
