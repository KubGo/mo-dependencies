...
model MultiOr
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.MultiOr mulOr0
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.MultiOr mulOr2(
    nin=2)
    "Logical 'MultiOr': 2 input connections y=and(u1, u2)"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.MultiOr mulOr5(
    nin=5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/MultiOr.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.MultiOr\">
BuildingsLite.Controls.OBC.CDL.Logical.MultiOr</a>.
</p>
<p>
