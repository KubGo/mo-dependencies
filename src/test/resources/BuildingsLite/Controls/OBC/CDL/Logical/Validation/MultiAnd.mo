...
model MultiAnd
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd mulAnd0
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd mulAnd5(
    nin=5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/MultiAnd.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd\">
BuildingsLite.Controls.OBC.CDL.Logical.MultiAnd</a>.
</p>
<p>
