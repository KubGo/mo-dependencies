...
model SampleTriggerPositiveStartTime
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Ramp ramp(
    duration=5,
    offset=0,
    height=20,
    startTime=1)
  ...
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler triggeredSampler
    "Triggered sampler"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Sources.SampleTrigger samTri1(
    period=0.5,
    shift=0.3)
    "Block that generates sample trigger signal"
    annotation (Placement(transformation(extent={{-30,-80},{-10,-60}})));
  BuildingsLite.Controls.OBC.CDL.Discrete.TriggeredSampler triggeredSampler1(
    y_start=-2)
    "Triggered sampler"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Sources/Validation/SampleTriggerPositiveStartTime.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.Sources.SampleTrigger\">
BuildingsLite.Controls.OBC.CDL.Logical.Sources.SampleTrigger</a>
