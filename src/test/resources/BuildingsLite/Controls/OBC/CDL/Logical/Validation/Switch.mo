...
model Switch "Validation model for the Switch block"
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Switch logicalSwitch
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Switch.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.Switch\">
BuildingsLite.Controls.OBC.CDL.Logical.Switch</a>.
</p>
<p>
