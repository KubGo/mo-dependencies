...
block VariablePulse "Generate boolean pulse with the width specified by input"
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput y
...
protected
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Edge edg2
    "Rising edge when there is a width change"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Pre preBre
    "Break loop"
  ...
  block Cycle
    ...
    BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput go
  ...
  equation
    ...
    t_sta = t0 + BuildingsLite.Utilities.Math.Functions.round(
