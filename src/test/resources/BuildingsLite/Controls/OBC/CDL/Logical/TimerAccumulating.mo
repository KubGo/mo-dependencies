...
block TimerAccumulating
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput u
    "Input that switches timer on if true, and off if false"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanInput reset
  ...
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput passed
...
equation
  // The when constructs below are identical to the ones in BuildingsLite.Controls.OBC.CDL.Logical.Timer
  when reset then
    entryTime=time;
    passed=t <= 0;
    yAcc=0;
