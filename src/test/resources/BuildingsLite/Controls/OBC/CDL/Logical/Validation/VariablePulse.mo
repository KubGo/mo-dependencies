...
model VariablePulse
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse conTru(
    period=900) "Variable pulse with constant pulse width"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse fal(
    period=900)
    "Variable pulse with the zero width input"
    annotation (Placement(transformation(extent={{-40,50},{-20,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse truFal(
    period=900)
    "Variable pulse with width input changing from positive value to zero"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse falTru(
    period=900)
    "Variable pulse with width input changing from zero to positive value"
    annotation (Placement(transformation(extent={{60,10},{80,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse tru(
    period=900)
    "Variable pulse with the constant width input"
    annotation (Placement(transformation(extent={{-40,10},{-20,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse falTru1(
    period=900)
    "Variable pulse with width input changing between different positive values"
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse conPul(
    amplitude=0.65,
    width=0.8,
    period=4000)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse conPul1(
    amplitude=0.65,
    width=0.85,
    period=3600,
    shift=360)
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Pulse conPul2(
    amplitude=0.5,
    width=0.5,
    period=3600,
    shift=360,
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse conChaWid(
    period=900)
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse\">
BuildingsLite.Controls.OBC.CDL.Logical.VariablePulse</a>.
</p>
<ul>
<li>
