...
model Timer
  ...
  BuildingsLite.Controls.OBC.CDL.Logical.Timer noThr
    "Timer that do not compare threshold"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Timer thrTim(
    final t=0.3)
    "Timer that compares threshold"
    annotation (Placement(transformation(extent={{20,-30},{40,-10}})));
  BuildingsLite.Controls.OBC.CDL.Logical.Timer thrTim1(
    final t=0.3)
    "Timer that compares threshold"
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Logical.Timer\">
BuildingsLite.Controls.OBC.CDL.Logical.Timer</a>.
</p>
</html>",
      revisions="<html>
<ul>
