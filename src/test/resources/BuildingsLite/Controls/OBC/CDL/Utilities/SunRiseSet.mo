within BuildingsLite.Controls.OBC.CDL.Utilities;
block SunRiseSet
  ...
  parameter Real timZon(
    ...
    displayUnit="h")
    "Time zone";
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput nextSunRise(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
    "Time of next sunrise"
    annotation (Placement(transformation(extent={{100,40},{140,80}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.RealOutput nextSunSet(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
    "Time of next sunset"
    annotation (Placement(transformation(extent={{100,-20},{140,20}})));
  BuildingsLite.Controls.OBC.CDL.Interfaces.BooleanOutput sunUp
...
<a href=\"modelica://BuildingsLite.Controls.OBC.CDL.Utilities.Validation.SunRiseSet\">
BuildingsLite.Controls.OBC.CDL.Utilities.Validation.SunRiseSet</a>.
</p>
</html>",
      revisions="<html>
<ul>
