within BuildingsLite.Controls.OBC.RadiantSystems.Cooling.Validation;
model HighMassSupplyTemperature_TSurRelHum
  ...
  BuildingsLite.Controls.OBC.CDL.Reals.Sources.TimeTable TPhiRooMea(
    table=[0.0, 18, 0.5;
           0.5, 28, 0.5;
           1.0, 18, 0.5;
           1.0, 18, 0.9;
  ...
  BuildingsLite.Controls.OBC.RadiantSystems.Cooling.HighMassSupplyTemperature_TSurRelHum
                                                                            conCoo(
      TSupSet_min=291.15) "Controller"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));

  BuildingsLite.Controls.OBC.CDL.Reals.Sources.Constant TSurSet(final k(
      final unit="K",
...
<a href=\"modelica://BuildingsLite.Controls.OBC.RadiantSystems.Cooling.HighMassSupplyTemperature_TSurRelHum\">
BuildingsLite.Controls.OBC.RadiantSystems.Cooling.HighMassSupplyTemperature_TSurRelHum</a>
