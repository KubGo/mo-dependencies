within BuildingsLite.Controls.Continuous.Validation;
model LimPIDReset
  ...
  BuildingsLite.Controls.Continuous.LimPID limPIDPar(
    yMax=1,
    yMin=-1,
    reset=BuildingsLite.Types.Reset.Parameter,
    y_reset=0.2,
    Ti=20,
    Td=10,
    k=0.2,
  ...
  BuildingsLite.Controls.Continuous.LimPID limPIDDef(
  ...
  BuildingsLite.Controls.Continuous.LimPID limPIDInp(
    y_reset=0.2,
    Td=10,
    reset=BuildingsLite.Types.Reset.Input,
    yMax=1,
    yMin=-1,
    k=0.2,
    Ti=20,
  ...
  BuildingsLite.Utilities.Diagnostics.AssertEquality assEqu
...
<a href=\"Modelica://BuildingsLite.Controls.Continuous.LimPID\">BuildingsLite.Controls.Continuous.LimPID</a>
