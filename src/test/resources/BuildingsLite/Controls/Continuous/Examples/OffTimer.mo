...
model OffTimer "Example model for off timer"
  ...
  BuildingsLite.Controls.Continuous.OffTimer offTim1
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  BuildingsLite.Controls.Continuous.OffTimer offTim2
...
<a href=\"modelica://BuildingsLite.Controls.Continuous.OffTimer\">
BuildingsLite.Controls.Continuous.OffTimer</a>.
