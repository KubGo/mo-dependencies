within BuildingsLite.Controls.Continuous.Examples;
model LimPIDWithReset
  ...
  Controller conWitRes(reset=BuildingsLite.Types.Reset.Parameter)
  ...
  Controller conNoRes(reset=BuildingsLite.Types.Reset.Disabled)
...
protected
  model Plant
    ...
    BuildingsLite.HeatTransfer.Sources.FixedTemperature TBou(T=293.15)
      "Boundary condition"
...
<p>
Plant model for
<a href=\"modelica://BuildingsLite.Controls.Continuous.Examples.LimPIDWithReset\">
BuildingsLite.Controls.Continuous.Examples.LimPIDWithReset</a>.
...
First implementation.
  ...
  model Controller "PID controller with optional output reset"
    ...
    parameter BuildingsLite.Types.Reset reset=BuildingsLite.Types.Reset.Disabled
    ...
    BuildingsLite.Controls.Continuous.LimPID conPID(
      final reset=reset,
      yMax=1,
      yMin=0,
      Ti=1,
