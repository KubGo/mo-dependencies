...
model LimPID "Test model for PID controller with optional reverse action"
  ...
  BuildingsLite.Controls.Continuous.LimPID limPID(
  ...
  BuildingsLite.Controls.Continuous.LimPID limPIDRev(
    controllerType=Modelica.Blocks.Types.SimpleController.PID,
    reverseActing=false,
    Ti=1,
    Td=1,
  ...
  BuildingsLite.Utilities.Diagnostics.AssertEquality assertEquality(
    threShold=1e-3)
  ...
  BuildingsLite.Utilities.Diagnostics.AssertEquality assertEquality1(
    threShold=1e-3)
