within BuildingsLite.Controls.Sources.Examples;
model DayType "Example model for the source that outputs the type of the day"
  extends Modelica.Icons.Example;
  BuildingsLite.Controls.Sources.DayType dayTypMon
    "Model that outputs the type of the day, starting with Monday"
    annotation (Placement(transformation(extent={{-60,40},{-40,60}})));
  BuildingsLite.Controls.Sources.DayType dayTypSat(iStart=6)
    "Model that outputs the type of the day, starting with Saturday"
    annotation (Placement(transformation(extent={{-60,0},{-40,20}})));
  BuildingsLite.Controls.Sources.DayType dayTypTwoWeeks(
    days={
        BuildingsLite.Controls.Types.Day.WorkingDay,
        BuildingsLite.Controls.Types.Day.WorkingDay,
        BuildingsLite.Controls.Types.Day.WorkingDay,
        BuildingsLite.Controls.Types.Day.WorkingDay,
        BuildingsLite.Controls.Types.Day.WorkingDay,
        BuildingsLite.Controls.Types.Day.WorkingDay,
        BuildingsLite.Controls.Types.Day.NonWorkingDay,BuildingsLite.Controls.Types.Day.NonWorkingDay,
        BuildingsLite.Controls.Types.Day.NonWorkingDay,BuildingsLite.Controls.Types.Day.NonWorkingDay,
        BuildingsLite.Controls.Types.Day.NonWorkingDay,BuildingsLite.Controls.Types.Day.NonWorkingDay,
        BuildingsLite.Controls.Types.Day.NonWorkingDay,BuildingsLite.Controls.Types.Day.NonWorkingDay},
    nout=14)
  ...
  BuildingsLite.Controls.Sources.DayType dayTypMonThr(nout=3)
