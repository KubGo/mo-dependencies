within BuildingsLite.Controls.Predictors.Validation;
model LinearInput
  ...
  extends
    BuildingsLite.Controls.Predictors.Validation.BaseClasses.PartialSimpleTestCase(
     baseLoad(predictionModel=BuildingsLite.Controls.Predictors.Types.PredictionModel.WeatherRegression));
...
<a href=\"modelica://BuildingsLite.Controls.Predictors.Validation.SineInput\">
BuildingsLite.Controls.Predictors.Validation.SineInput</a>,
