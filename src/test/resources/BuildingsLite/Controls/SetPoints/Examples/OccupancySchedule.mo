...
model OccupancySchedule "Test model for occupancy schedule with look-ahead"
  ...
  BuildingsLite.Controls.SetPoints.OccupancySchedule occSchDay "Day schedule"
    annotation (Placement(transformation(extent={{-60,0},{-40,20}})));
  BuildingsLite.Controls.SetPoints.OccupancySchedule occSchWee(occupancy=3600*{7,19,
