within BuildingsLite.Controls.SetPoints.Examples;
model Table "Test model for table that determines set points"
  extends Modelica.Icons.Example;
  BuildingsLite.Controls.SetPoints.Table tabConExt(table=[20,0; 22,0.5; 25,0.5; 26,1])
  ...
  BuildingsLite.Controls.SetPoints.Table tabLinExt(constantExtrapolation=false, table=[
...
<a href=\"modelica://BuildingsLite.Controls.SetPoints.Table\">
BuildingsLite.Controls.SetPoints.Table</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
