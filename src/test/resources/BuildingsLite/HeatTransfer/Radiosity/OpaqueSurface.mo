within BuildingsLite.HeatTransfer.Radiosity;
model OpaqueSurface "Model for an opaque surface"
  extends BuildingsLite.HeatTransfer.Radiosity.BaseClasses.RadiosityOneSurface;
  extends BuildingsLite.HeatTransfer.Radiosity.BaseClasses.ParametersOneSurface(
