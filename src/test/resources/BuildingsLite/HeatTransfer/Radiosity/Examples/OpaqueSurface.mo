within BuildingsLite.HeatTransfer.Radiosity.Examples;
model OpaqueSurface "Test model for indoor source as an opaque surface"
  extends Modelica.Icons.Example;

  BuildingsLite.HeatTransfer.Sources.FixedTemperature T2(T=303.15)
    "Boundary condition for surface 2"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));

  BuildingsLite.HeatTransfer.Radiosity.OpaqueSurface bod1( absIR=0.3, A=1)
    "Surface 1"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  BuildingsLite.HeatTransfer.Sources.FixedTemperature T1(T=293.15)
    "Boundary condition for surface 1"
    annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
  BuildingsLite.HeatTransfer.Radiosity.OpaqueSurface bod2( absIR=0.3, A=1)
    "Surface 2"
    annotation (Placement(transformation(extent={{60,20},{40,40}})));
equation
