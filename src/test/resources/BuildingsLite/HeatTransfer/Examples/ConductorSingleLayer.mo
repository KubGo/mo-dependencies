...
model ConductorSingleLayer "Test model for heat conductor"
  ...
  BuildingsLite.HeatTransfer.Conduction.SingleLayer con(A=1, material=concrete200,
  ...
  parameter BuildingsLite.HeatTransfer.Data.Solids.Concrete concrete200(x=0.2, nSta=4)
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  parameter BuildingsLite.HeatTransfer.Data.Solids.Concrete concrete100(x=0.1, nSta=2)
