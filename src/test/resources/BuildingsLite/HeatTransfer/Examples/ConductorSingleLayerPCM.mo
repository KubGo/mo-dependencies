...
model ConductorSingleLayerPCM "Test model for heat conductor"
  ...
  parameter BuildingsLite.HeatTransfer.Data.Solids.Concrete concrete100(x=0.1, nStaRef=4)
    "Non-PCM material"
    annotation (Placement(transformation(extent={{62,70},{82,90}})));
  BuildingsLite.HeatTransfer.Convection.Interior conv1(      A=1, til=BuildingsLite.Types.Tilt.Wall)
    "Convective heat transfer"
    annotation (Placement(transformation(extent={{-12,0},{-32,20}})));
  BuildingsLite.HeatTransfer.Convection.Interior conv2(      A=1, til=BuildingsLite.Types.Tilt.Wall)
    "Convective heat transfer"
    annotation (Placement(transformation(extent={{-12,-40},{-32,-20}})));
  BuildingsLite.HeatTransfer.Conduction.SingleLayer conPCM(
    A=1,
    material=matPCM,
  ...
  parameter BuildingsLite.HeatTransfer.Data.SolidsPCM.Generic matPCM(
    x=0.2,
    k=1.4,
    c=840,
    d=2240,
  ...
  BuildingsLite.HeatTransfer.Convection.Interior conv3(      A=1, til=BuildingsLite.Types.Tilt.Wall)
    "Convective heat transfer"
    annotation (Placement(transformation(extent={{-12,34},{-32,54}})));
  BuildingsLite.HeatTransfer.Conduction.SingleLayer conPCM2(
    A=1,
    material=matPCM2,
  ...
  parameter BuildingsLite.HeatTransfer.Data.SolidsPCM.Generic matPCM2(
    x=0.2,
    k=1.4,
    c=840,
    d=2240,
