...
model ConductorMultiLayer "Test model for heat conductor"
  ...
  BuildingsLite.HeatTransfer.Conduction.MultiLayer con(
    steadyStateInitial=false,
    redeclare
      BuildingsLite.HeatTransfer.Data.OpaqueConstructions.Insulation100Concrete200
      layers,
    A=0.1,
    stateAtSurface_b=false)
    annotation (Placement(transformation(extent={{20,0},{40,20}})));
  BuildingsLite.HeatTransfer.Convection.Interior conv(
    A=0.1,
