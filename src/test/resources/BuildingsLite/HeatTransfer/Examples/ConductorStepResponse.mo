...
model ConductorStepResponse "Test model for heat conductor"
  ...
  parameter BuildingsLite.HeatTransfer.Data.Solids.Concrete concrete(x=0.12, nStaRef=4)
    annotation (Placement(transformation(extent={{40,60},{60,80}})));
  parameter BuildingsLite.HeatTransfer.Data.Resistances.Carpet carpet "carpet"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  parameter BuildingsLite.HeatTransfer.Data.OpaqueConstructions.Generic composite(
      nLay=2,
  ...
  BuildingsLite.HeatTransfer.Convection.Interior conv1(
                                          A=2, til=BuildingsLite.Types.Tilt.Wall)
    "Convective heat transfer"
    annotation (Placement(transformation(extent={{-10,-20},{-30,0}})));
  BuildingsLite.HeatTransfer.Convection.Interior conv2(
                                          A=2, til=BuildingsLite.Types.Tilt.Wall)
    "Convective heat transfer"
