...
<p>
This example is similar to <a href=\"modelica://BuildingsLite.HeatTransfer.Examples.ConductorMultiLayer\">
BuildingsLite.HeatTransfer.Examples.ConductorMultiLayer</a>. The main difference
