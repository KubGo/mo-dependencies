...
<p>
This example is similar to <a href=\"modelica://BuildingsLite.HeatTransfer.Examples.ConductorSingleLayer\">
BuildingsLite.HeatTransfer.Examples.ConductorSingleLayer</a>. The main difference
