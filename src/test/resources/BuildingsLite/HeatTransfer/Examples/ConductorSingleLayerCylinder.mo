...
model ConductorSingleLayerCylinder
  ...
  BuildingsLite.HeatTransfer.Conduction.SingleLayerCylinder
  ...
  BuildingsLite.HeatTransfer.Sources.PrescribedHeatFlow Qa
    annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  parameter BuildingsLite.HeatTransfer.Data.Soil.Concrete concrete
