within BuildingsLite.HeatTransfer.Conduction;
model SingleLayer "Model for single layer heat conductance"
  extends BuildingsLite.HeatTransfer.Conduction.BaseClasses.PartialConductor(
...
protected
  ...
  parameter Modelica.Units.SI.SpecificInternalEnergy ud[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    (each fixed=false) "Support points for derivatives (used for PCM)";
  parameter Modelica.Units.SI.Temperature Td[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    (each fixed=false) "Support points for derivatives (used for PCM)";
  parameter Real dT_du[BuildingsLite.HeatTransfer.Conduction.nSupPCM](
    each fixed=false,
    each unit="kg.K2/J")
...
initial equation
  // The initialization is only done for materials that store energy.
   ...
   if material.phasechange then
     (ud, Td, dT_du) = BuildingsLite.HeatTransfer.Conduction.BaseClasses.der_temperature_u(
       c =  material.c,
       TSol=material.TSol,
       TLiq=material.TLiq,
       LHea=material.LHea,
     ...
     ud    = zeros(BuildingsLite.HeatTransfer.Conduction.nSupPCM);
     Td    = zeros(BuildingsLite.HeatTransfer.Conduction.nSupPCM);
     dT_du = zeros(BuildingsLite.HeatTransfer.Conduction.nSupPCM);
   end if;
equation
    ...
    if material.steadyState then
      ...
      for i in 1:nSta loop
        if material.phasechange then
          ...
          T[i]=BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u(
                    ud=ud,
                    Td=Td,
                    dT_du=dT_du,
                    u=u[i]);
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Data.Solids\">
BuildingsLite.HeatTransfer.Data.Solids</a> and its
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Data.SolidsPCM\">
BuildingsLite.HeatTransfer.Data.SolidsPCM</a>, the heat transfer
in a phase change material is computed.
The record <a href=\"modelica://BuildingsLite.HeatTransfer.Data.SolidsPCM\">
BuildingsLite.HeatTransfer.Data.SolidsPCM</a>
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u\">
BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u</a> by using
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Data.Resistances\">
BuildingsLite.HeatTransfer.Data.Resistances</a>,
...
use
<a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.MultiLayer\">
BuildingsLite.HeatTransfer.Conduction.MultiLayer</a> instead of this model.
</p>
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Sources.FixedTemperature\">
BuildingsLite.HeatTransfer.Sources.FixedTemperature</a> as this would
...
See the examples in
<a href=\"modelica://BuildingsLite.HeatTransfer.Examples\">
BuildingsLite.HeatTransfer.Examples</a>.
</p>
</html>",
revisions="<html>
<ul>
...
<code>BuildingsLite.HeatTransfer.Conduction.BaseClasses.der_temperature_u</code>
from type
<code>BuildingsLite.HeatTransfer.Data.BaseClasses.Material</code>
