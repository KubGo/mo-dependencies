...
function temperature_u
  ...
  input Modelica.Units.SI.SpecificInternalEnergy ud[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    "Support points for derivatives";
  input Modelica.Units.SI.Temperature Td[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    "Support points for derivatives";
...
algorithm
  ...
  T :=  BuildingsLite.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
     x=u,
     x1=ud[i],
     x2=ud[i + 1],
     y1=Td[i],
