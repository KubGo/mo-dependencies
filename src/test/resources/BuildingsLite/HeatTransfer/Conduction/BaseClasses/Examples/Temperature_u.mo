within BuildingsLite.HeatTransfer.Conduction.BaseClasses.Examples;
model Temperature_u
  "Approximation of specific internal energy versus temperature curve with cubic hermite cubic spline"
  extends Modelica.Icons.Example;
  // Phase-change properties
  parameter BuildingsLite.HeatTransfer.Data.SolidsPCM.Generic
      materialMonotone(
               TSol=273.15+30.9,
               TLiq=273.15+40.0,
               LHea=1000000,
  ...
  parameter Modelica.Units.SI.SpecificInternalEnergy udMonotone[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    (each fixed=false) "Support points";
  parameter Modelica.Units.SI.Temperature Td[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    (each fixed=false) "Support points";
  parameter Modelica.Units.SI.Temperature TdMonotone[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    (each fixed=false) "Support points";
  parameter Real dT_du[BuildingsLite.HeatTransfer.Conduction.nSupPCM](each fixed=false, each unit="kg.K2/J")
    "Derivatives at the support points - non-monotone, default in Modelica PCM";
  parameter Real dT_duMonotone[BuildingsLite.HeatTransfer.Conduction.nSupPCM](each fixed=false, each unit="kg.K2/J")
...
initial equation
  ...
  (ud, Td, dT_du) =
    BuildingsLite.HeatTransfer.Conduction.BaseClasses.der_temperature_u(
...
equation
  ...
  T = BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u(
       ud=ud,
       Td=Td,
       dT_du=dT_du,
       u=u);
  // Calculate T based on monotone interpolation
  TMonotone = BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u(
       ud=udMonotone,
       Td=TdMonotone,
       dT_du=dT_duMonotone,
       u=u);
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.BaseClasses.der_temperature_u\">
BuildingsLite.HeatTransfer.Conduction.BaseClasses.der_temperature_u</a>
and
<a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u\">
BuildingsLite.HeatTransfer.Conduction.BaseClasses.temperature_u</a>.
