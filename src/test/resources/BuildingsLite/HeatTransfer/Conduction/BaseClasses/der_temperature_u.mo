within BuildingsLite.HeatTransfer.Conduction.BaseClasses;
function der_temperature_u
  ...
  output Modelica.Units.SI.SpecificInternalEnergy ud[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    "Support points for derivatives";
  output Modelica.Units.SI.Temperature Td[BuildingsLite.HeatTransfer.Conduction.nSupPCM]
    "Support points for derivatives";
  output Real dT_du[BuildingsLite.HeatTransfer.Conduction.nSupPCM](
    each fixed=false,
    each unit="kg.K2/J")
...
protected
  ...
  Modelica.Units.SI.Temperature Tm2
    "Support point";
algorithm
  assert(BuildingsLite.HeatTransfer.Conduction.nSupPCM == 6,
  ...
  Td:={scale*TSol,
       ...
       TLiq,
       TLiq + TSol*(1 - scale)};
  dT_du := BuildingsLite.Utilities.Math.Functions.splineDerivatives(
      x=ud,
      y=Td,
...
<code>BuildingsLite.HeatTransfer.Data.BaseClasses.Material</code> rather than
<code>BuildingsLite.HeatTransfer.Data.Solids.Generic</code>.
</li>
<li>
