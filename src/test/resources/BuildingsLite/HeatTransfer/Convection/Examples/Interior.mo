within BuildingsLite.HeatTransfer.Convection.Examples;
model Interior "Test model for convective heat transfer coefficients"
  ...
  BuildingsLite.HeatTransfer.Convection.Interior conCon(
                                           A=1,
  til=BuildingsLite.Types.Tilt.Wall)    annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-30,10})));
  BuildingsLite.HeatTransfer.Convection.Interior conVer(
                                           A=1,
  til=BuildingsLite.Types.Tilt.Wall,
  conMod=BuildingsLite.HeatTransfer.Types.InteriorConvection.Temperature)
                                                               annotation (
  ...
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TA3
    annotation (Placement(transformation(extent={{20,40},{40,60}})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TA4
    annotation (Placement(transformation(extent={{60,40},{80,60}})));
  BuildingsLite.HeatTransfer.Convection.Interior conHorFluTop(
    A=1,
    til=BuildingsLite.Types.Tilt.Floor,
    conMod=BuildingsLite.HeatTransfer.Types.InteriorConvection.Temperature)
    "Convection model with fluid on top"        annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={50,10})));
  BuildingsLite.HeatTransfer.Convection.Interior conHorSolTop(
    A=1,
    til=BuildingsLite.Types.Tilt.Ceiling,
    conMod=BuildingsLite.HeatTransfer.Types.InteriorConvection.Temperature)
  ...
  BuildingsLite.HeatTransfer.Sources.FixedTemperature TB3(T=293.15)
