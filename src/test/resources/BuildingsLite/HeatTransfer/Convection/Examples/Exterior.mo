...
model Exterior "Test model for exterior heat transfer coefficients"
  ...
  BuildingsLite.HeatTransfer.Convection.Exterior nor(
    A=1,
    azi=BuildingsLite.Types.Azimuth.N,
    til=BuildingsLite.Types.Tilt.Wall,
    conMod=BuildingsLite.HeatTransfer.Types.ExteriorConvection.TemperatureWind)
    "North-facing wall"                       annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        origin={30,30})));
  BuildingsLite.HeatTransfer.Convection.Exterior wes(
    A=1,
    azi=BuildingsLite.Types.Azimuth.W,
    til=BuildingsLite.Types.Tilt.Wall,
    conMod=BuildingsLite.HeatTransfer.Types.ExteriorConvection.TemperatureWind)
  ...
  BuildingsLite.HeatTransfer.Convection.Exterior sou(
    A=1,
    ...
    "South facing wall"                         annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={30,-30})));
  BuildingsLite.HeatTransfer.Convection.Exterior eas(
    A=1,
    azi=BuildingsLite.Types.Azimuth.E,
    til=BuildingsLite.Types.Tilt.Wall,
    conMod=BuildingsLite.HeatTransfer.Types.ExteriorConvection.TemperatureWind)
