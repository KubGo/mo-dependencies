...
model BeamDepthInRoom "Test model for the depth of the solar beam in the room"
  ...
  BuildingsLite.HeatTransfer.Windows.BeamDepthInRoom winEas(
  ...
  BuildingsLite.HeatTransfer.Windows.BeamDepthInRoom winSou(
  ...
  BuildingsLite.HeatTransfer.Windows.BeamDepthInRoom winWes(
  ...
  BuildingsLite.HeatTransfer.Windows.BeamDepthInRoom winNor(
