...
model BoundaryHeatTransfer
  ...
  parameter
    BuildingsLite.HeatTransfer.Data.GlazingSystems.TripleClearAir13ClearAir13Clear
    glaSys3(UFra=1) "Parameters for glazing system"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  parameter BuildingsLite.HeatTransfer.Data.GlazingSystems.DoubleClearAir13Clear glaSys(
  ...
  parameter BuildingsLite.HeatTransfer.Data.GlazingSystems.SingleClear3 glaSys1(UFra=2)
    "Parameters for glazing system"
    annotation (Placement(transformation(extent={{0,-80},{20,-60}})));
  parameter BuildingsLite.HeatTransfer.Data.GlazingSystems.DoubleClearAir13Clear glaSys2(
    shade=BuildingsLite.HeatTransfer.Data.Shades.Gray(),
    UFra=2,
  ...
  BuildingsLite.HeatTransfer.Windows.ExteriorHeatTransfer extCon(A=A, fFra=fFra,
  ...
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TRAir
    "Room air temperature"
    annotation (Placement(transformation(extent={{60,60},{80,80}})));

 BuildingsLite.HeatTransfer.Radiosity.IndoorRadiosity radIn(
...
public
  BuildingsLite.HeatTransfer.Windows.BaseClasses.ShadingSignal shaSig(haveShade=true)
    "Conversion for shading signal"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TRAir1
    "Room air temperature"
    annotation (Placement(transformation(extent={{60,30},{80,50}})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TRAir2
    "Room air temperature"
    annotation (Placement(transformation(extent={{60,0},{80,20}})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TRAir3
    "Room air temperature"
