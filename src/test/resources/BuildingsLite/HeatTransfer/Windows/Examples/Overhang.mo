...
model Overhang "This example tests the window overhang model"
  ...
  BuildingsLite.HeatTransfer.Windows.Overhang ove(
    dep=1.2,
    gap=0.1,
    hWin=1.0,
    wWin=1.0,
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Windows.BaseClasses.Examples.Overhang\">
BuildingsLite.HeatTransfer.Windows.BaseClasses.Examples.Overhang</a>.
</p>
</html>",
revisions="<html>
<ul>
