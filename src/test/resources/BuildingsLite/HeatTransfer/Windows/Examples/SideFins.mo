...
model SideFins "This example demonstrates the use of side fins for a window"
  ...
  BuildingsLite.HeatTransfer.Windows.SideFins fin(
    h=0.2,
    hWin=1.0,
    wWin=1.0,
    dep=0.5,
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Windows.SideFins\">BuildingsLite.HeatTransfer.Windows.SideFins</a>.
A similar example of can be found in
<a href=\"modelica://BuildingsLite.HeatTransfer.Windows.BaseClasses.Examples.SideFins\">BuildingsLite.HeatTransfer.Windows.BaseClasses.Examples.SideFins</a>.
</p>
</html>",
revisions="<html>
<ul>
