...
model InteriorHeatTransferConvective
  ...
  parameter Types.InteriorConvection conMod=BuildingsLite.HeatTransfer.Types.InteriorConvection.Fixed
 ...
 Modelica.Blocks.Interfaces.RealInput QRadAbs_flow(final unit="W")
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.InteriorConvectionCoefficient
