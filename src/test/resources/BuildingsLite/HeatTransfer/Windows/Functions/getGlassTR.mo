within BuildingsLite.HeatTransfer.Windows.Functions;
function getGlassTR "Transmittance and reflectance of glass"
  extends
    BuildingsLite.HeatTransfer.Windows.Functions.BaseClasses.partialGlassRadiation;
...
algorithm
  traRef :=
      BuildingsLite.HeatTransfer.Windows.Functions.glassTRExteriorIrradiationNoShading(
      N=N,
      NSta=NSta,
      HEM=HEM,
      layer=layer) "property for exterior irradiation";
  traRefIntIrr :=
      BuildingsLite.HeatTransfer.Windows.Functions.glassTRInteriorIrradiationNoShading(
      N=N,
      NSta=NSta,
      HEM=HEM,
