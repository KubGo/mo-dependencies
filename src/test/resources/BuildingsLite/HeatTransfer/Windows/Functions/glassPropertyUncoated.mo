...
function glassPropertyUncoated
  ...
  extends
    BuildingsLite.HeatTransfer.Windows.Functions.BaseClasses.partialSingleGlassRadiation;
...
algorithm
  ...
  for k in TRA:Rb loop
    layer[k, HEM] := BuildingsLite.Utilities.Math.Functions.trapezoidalIntegration(
      NDIR,
      f[k, :],
      deltaX)
