...
model GasConvection
  ...
  parameter BuildingsLite.HeatTransfer.Data.Gases.Generic gas
...
initial equation
  ...
  // in BuildingsLite.HeatTransfer.Data.Gases.Generic is overwritten.
  ...
  Ra0 = BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.rayleigh(
    x=gas.x,
    rho=BuildingsLite.HeatTransfer.Data.Gases.density(gas=gas, T=T0),
    c_p=BuildingsLite.HeatTransfer.Data.Gases.specificHeatCapacity(gas=gas, T=T0),
    mu=BuildingsLite.HeatTransfer.Data.Gases.dynamicViscosity(gas=gas, T=T0),
    k=BuildingsLite.HeatTransfer.Data.Gases.thermalConductivity(gas=gas, T=T0),
    T_a=T0-5,
    T_b=T0+5,
    Ra_min=100);
  (Nu0, hCon0) = BuildingsLite.HeatTransfer.Windows.BaseClasses.convectionVerticalCavity(
...
equation
  ...
  if linearize then
    ...
    Ra = BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.rayleigh(
      x=gas.x,
      rho=BuildingsLite.HeatTransfer.Data.Gases.density(gas, T_m),
      c_p=BuildingsLite.HeatTransfer.Data.Gases.specificHeatCapacity(gas, T_m),
      mu=BuildingsLite.HeatTransfer.Data.Gases.dynamicViscosity(gas, T_m),
      k=BuildingsLite.HeatTransfer.Data.Gases.thermalConductivity(gas, T_m),
      T_a=T_a,
      T_b=T_b,
      Ra_min=100);
    if isVertical then
       (Nu, hCon, q_flow) = BuildingsLite.HeatTransfer.Windows.BaseClasses.convectionVerticalCavity(
              gas=gas, Ra=Ra, T_m=T_m, dT=dT, h=h, deltaNu=deltaNu, deltaRa=deltaRa);
    elseif isHorizontal then
       (Nu, hCon, q_flow) = BuildingsLite.HeatTransfer.Windows.BaseClasses.convectionHorizontalCavity(
...
<a href=\"modelica://BuildingsLite.Types.Tilt\">
BuildingsLite.Types.Tilt</a>.
</p>
<br/>
