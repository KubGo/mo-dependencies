within BuildingsLite.HeatTransfer.Windows.BaseClasses;
model InteriorConvection
  "Model for a interior (room-side) convective heat transfer with variable surface area"
  extends BuildingsLite.HeatTransfer.Convection.BaseClasses.PartialConvection;

  constant Boolean homotopyInitialization = true "= true, use homotopy method"
    annotation(HideResult=true);

  parameter BuildingsLite.HeatTransfer.Types.InteriorConvection conMod=
    BuildingsLite.HeatTransfer.Types.InteriorConvection.Fixed
  ...
  parameter Modelica.Units.SI.Angle til(displayUnit="deg") "Surface tilt"
    annotation (Dialog(enable=(conMod <> BuildingsLite.HeatTransfer.Types.InteriorConvection.Fixed)));
...
equation
  if (conMod == BuildingsLite.HeatTransfer.Types.InteriorConvection.Fixed) then
    q_flow = u*hFixed * dT;
  else
    ...
    if homotopyInitialization then
      if is_ceiling then
         q_flow = u*homotopy(actual=BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.ceiling(dT=dT),
                      simplified=dT/dT0*BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.ceiling(dT=dT0));
      elseif is_floor then
         q_flow = u*homotopy(actual=BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.floor(dT=dT),
                      simplified=dT/dT0*BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.floor(dT=dT0));
      else
         q_flow = u*homotopy(actual=BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.wall(dT=dT),
                      simplified=dT/dT0*BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.wall(dT=dT0));
      end if;
    else
      if is_ceiling then
         q_flow = u*BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.ceiling(dT=dT);
      elseif is_floor then
         q_flow = u*BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.floor(dT=dT);
      else
         q_flow = u*BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.wall(dT=dT);
      end if;
    end if;
...
<ul>
<li>If <code>conMod=<a href=\"modelica://BuildingsLite.HeatTransfer.Types.InteriorConvection\">
BuildingsLite.HeatTransfer.Types.InteriorConvection.Fixed</a></code>, then
the convective heat transfer coefficient is set to the value specified by the parameter
<code>hFixed</code>.
</li>
<li>
If <code>conMod=<a href=\"modelica://BuildingsLite.HeatTransfer.Types.InteriorConvection\">
BuildingsLite.HeatTransfer.Types.InteriorConvection.Temperature</a></code>, then
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.floor\">
BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.floor</a>
</li>
<li>
for ceilings the function
<a href=\"modelica://BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.ceiling\">
BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.ceiling</a>
</li>
<li>
for walls the function
<a href=\"modelica://BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.wall\">
BuildingsLite.HeatTransfer.Convection.Functions.HeatFlux.wall</a>
</li>
</ul>
</li>
</ul>
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Convection.Interior\">
BuildingsLite.HeatTransfer.Convection.Interior</a>
