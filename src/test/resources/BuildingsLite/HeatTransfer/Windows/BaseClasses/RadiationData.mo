...
record RadiationData "Radiation data of a window"
  ...
  extends BuildingsLite.HeatTransfer.Windows.BaseClasses.RadiationBaseData;
  ...
  final parameter Modelica.Units.SI.Angle psi[NDIR]=
      BuildingsLite.HeatTransfer.Windows.Functions.getAngle(NDIR)
    "Incident angles used for solar radiation calculation";
  final parameter Real layer[3, N, HEM, NSta]=
    BuildingsLite.HeatTransfer.Windows.Functions.glassProperty(
      N=N,
      NSta=NSta,
      HEM=HEM,
      glass=glass,
  ...
  final parameter Real traRef[3, N, N, HEM, NSta]=
    BuildingsLite.HeatTransfer.Windows.Functions.getGlassTR(
      N=N,
      NSta=NSta,
      HEM=HEM,
  ...
  final parameter Real absExtIrrNoSha[N, HEM, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.glassAbsExteriorIrradiationNoShading(
      traRef=traRef,
      N=N,
      NSta=NSta,
  ...
  final parameter Real absIntIrrNoSha[N, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.glassAbsInteriorIrradiationNoShading(
      traRef=traRef,
      N=N,
      NSta=NSta,
  ...
  final parameter Real winTraExtIrrExtSha[HEM, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.winTExteriorIrradiatrionExteriorShading(
      traRef=traRef,
  ...
  final parameter Real absExtIrrExtSha[N, HEM, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.glassAbsExteriorIrradiationExteriorShading(
  ...
  final parameter Real winTraExtIrrIntSha[HEM, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.winTExteriorIrradiationInteriorShading(
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
      NSta=NSta,
  ...
  final parameter Real absExtIrrIntSha[N, HEM, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.glassAbsExteriorIrradiationInteriorShading(
      absExtIrrNoSha=absExtIrrNoSha,
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
  ...
  final parameter Real devAbsExtIrrIntShaDev[HEM, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.devAbsExteriorIrradiationInteriorShading(
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
      NSta=NSta,
  ...
  final parameter Real winTraRefIntIrrExtSha[3, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.winTRInteriorIrradiationExteriorShading(
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
      NSta=NSta,
  ...
  final parameter Real absIntIrrExtSha[N, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.glassAbsInteriorIrradiationExteriorShading(
  ...
  final parameter Real absIntIrrIntSha[N, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.glassAbsInteriorIrradiationInteriorShading(
      absIntIrrNoSha=absIntIrrNoSha,
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
  ...
  final parameter Real winTraRefIntIrrIntSha[3, NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.winTRInteriorIrradiationInteriorShading(
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
      NSta=NSta,
  ...
  final parameter Real devAbsIntIrrIntSha[NSta]=
      BuildingsLite.HeatTransfer.Windows.Functions.devAbsInteriorIrradiationInteriorShading(
      traRef=traRef,
      traRefShaDev=traRefShaDev,
      N=N,
      NSta=NSta,
...
Replaced record
<a href=\"modelica://BuildingsLite.HeatTransfer.Data.GlazingSystems\">
BuildingsLite.HeatTransfer.Data.GlazingSystems</a> with the
