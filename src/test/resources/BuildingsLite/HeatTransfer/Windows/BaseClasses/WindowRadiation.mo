...
block WindowRadiation "Calculation radiation for window"
  ...
  extends BuildingsLite.HeatTransfer.Windows.BaseClasses.PartialRadiation;
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.TransmittedRadiation tra(
    final N=N,
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.AbsorbedRadiation abs(
    final N=N,
    final tauGlaSol=tauGlaSol,
    final rhoGlaSol_a=rhoGlaSol_a,
    final rhoGlaSol_b=rhoGlaSol_b,
