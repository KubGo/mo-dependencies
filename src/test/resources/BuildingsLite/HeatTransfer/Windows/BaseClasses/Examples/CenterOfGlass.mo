...
model CenterOfGlass "Test model for center of glas heat transfer"
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.CenterOfGlass sha(
    A=A,
    linearize=linearize,
    til=1.5707963267949,
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.CenterOfGlass nonSha(
    A=A,
    linearize=linearize,
    til=1.5707963267949,
  ...
  BuildingsLite.HeatTransfer.Radiosity.OutdoorRadiosity radOut(A=A,
