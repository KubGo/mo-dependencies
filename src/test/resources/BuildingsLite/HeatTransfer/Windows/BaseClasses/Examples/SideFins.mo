...
model SideFins "Test model for side fins"
  ...
  BuildingsLite.BoundaryConditions.SolarGeometry.ZenithAngle zen
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.SideFins fin(
    gap=0.1,
    h=0.7,
    dep=1.0,
    hWin=1.5,
  ...
  BuildingsLite.BoundaryConditions.SolarGeometry.BaseClasses.AltitudeAngle
