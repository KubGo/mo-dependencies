...
model Overhang "Test model for the overhang"
  ...
  BuildingsLite.BoundaryConditions.SolarGeometry.IncidenceAngle incAng(
    azi=BuildingsLite.Types.Azimuth.S,
    til=BuildingsLite.Types.Tilt.Wall) "Solar incidence angle on a tilted surface"
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  BuildingsLite.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos"))
    "Weather data"
    annotation (Placement(transformation(extent={{-100,20},{-80,40}})));
  BuildingsLite.HeatTransfer.Windows.BaseClasses.Overhang ove(
    gap=0.1,
    azi=BuildingsLite.Types.Azimuth.S,
    wL=0,
    wR=0.95,
  ...
  BuildingsLite.BoundaryConditions.SolarGeometry.BaseClasses.WallSolarAzimuth walSolAzi
    "Angle measured in horizontal plane between projection of sun's rays and normal to vertical surface"
     annotation (Placement(transformation(extent={{0,20},{20,40}})));
  BuildingsLite.BoundaryConditions.WeatherData.Bus weaBus
...
<a href=\"modelica://BuildingsLite.BoundaryConditions.SolarGeometry\">BuildingsLite.BoundaryConditions.SolarGeometry</a>.
For a detailed description of the overhang block, see
<a href=\"modelica://BuildingsLite.HeatTransfer.Windows.BaseClasses.Overhang\">BuildingsLite.HeatTransfer.Windows.BaseClasses.Overhang</a>.
...
<ul>
<li>
<a href=\"modelica://BuildingsLite.BoundaryConditions.SolarGeometry.ZenithAngle\">BuildingsLite.BoundaryConditions.SolarGeometry.ZenithAngle</a>:
Angle between sun ray and normal to horizontal surface
</li>
<li>
<a href=\"modelica://BuildingsLite.BoundaryConditions.SolarGeometry.IncidenceAngle\">BuildingsLite.BoundaryConditions.SolarGeometry.IncidenceAngle</a>:
Solar incidence angle on a tilted surface
</li>
<li>
<a href=\"modelica://BuildingsLite.BoundaryConditions.SolarGeometry.BaseClasses.AltitudeAngle\">BuildingsLite.BoundaryConditions.SolarGeometry.BaseClasses.AltitudeAngle</a>:
Angle between Sun ray and horizontal surface
</li>
<li>
<a href=\"modelica://BuildingsLite.BoundaryConditions.SolarGeometry.BaseClasses.WallSolarAzimuth\">BuildingsLite.BoundaryConditions.SolarGeometry.BaseClasses.WallSolarAzimuth</a>:
Angle measured in horizontal plane between projection of sun's rays and normal to vertical surface
</li>
</ul>
