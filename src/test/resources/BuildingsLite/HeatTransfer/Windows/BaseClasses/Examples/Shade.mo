...
model Shade "Test model for exterior shade heat transfer"
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.ShadeRadiation extShaRad(
    A=A,
    linearize=false,
    absIR_air=0.3,
    absIR_glass=0.3,
  ...
  BuildingsLite.HeatTransfer.Radiosity.OpaqueSurface radOut(A=A, absIR=0.8,
    linearize=false) "Model for outside radiosity"
    annotation (Placement(transformation(extent={{-104,-72},{-84,-52}})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TRadOut
    "Outside radiative temperature"
    annotation (Placement(transformation(extent={{-114,-100},{-94,-80}})));

  BuildingsLite.HeatTransfer.Radiosity.OpaqueSurface radIn(A=A, absIR=0.8,
  ...
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TRadRoo
  ...
  BuildingsLite.HeatTransfer.Radiosity.RadiositySplitter radShaInt
    "Radiosity that strikes shading device"
    annotation (Placement(transformation(extent={{60,-22},{40,-2}})));

  BuildingsLite.HeatTransfer.Windows.BaseClasses.ShadeRadiation extNonShaRad(
    A=A,
    linearize=false,
  ...
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TAirOut
    "Outside air temperature"
    annotation (Placement(transformation(extent={{-120,10},{-100,30}})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature TAirRoo
    "Room-side air temperature"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=180,
        origin={110,20})));
  BuildingsLite.HeatTransfer.Windows.BaseClasses.ShadingSignal shaCon(haveShade=
        true)
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.ShadeConvection extShaCon(A=A,
      thisSideHasShade=true) "Convection model of exterior shade"
    annotation (Placement(transformation(extent={{0,40},{20,60}})));
  BuildingsLite.HeatTransfer.Windows.BaseClasses.ShadeConvection extNonShaCon(A=A,
      thisSideHasShade=false)
