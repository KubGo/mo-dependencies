...
model GasConvection "Test problem for convection in the gas layer"
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.GasConvection conVer(
    A=1,
    linearize=false,
    gas=BuildingsLite.HeatTransfer.Data.Gases.Air(x=0.1),
    til=BuildingsLite.Types.Tilt.Wall) "Model for gas convection in vertical gap"
  ...
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature T_a1
    "Exterior-side temperature"
    annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  BuildingsLite.HeatTransfer.Sources.FixedTemperature T_b1(T=293.15)
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.GasConvection conCei(
    A=1,
    linearize=false,
    gas=BuildingsLite.HeatTransfer.Data.Gases.Air(x=0.1),
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=270,
        origin={10,-30})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature T_a2
    "Exterior-side temperature"
    annotation (Placement(transformation(extent={{-40,-20},{-20,0}})));
  BuildingsLite.HeatTransfer.Sources.FixedTemperature T_b2(T=293.15)
    "Room-side temperature"
                       annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={50,-50})));
  BuildingsLite.HeatTransfer.Windows.BaseClasses.GasConvection conFlo(
    A=1,
    linearize=false,
    gas=BuildingsLite.HeatTransfer.Data.Gases.Air(x=0.1),
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={10,-110})));
  BuildingsLite.HeatTransfer.Sources.PrescribedTemperature T_a3
    "Exterior-side temperature"
    annotation (Placement(transformation(extent={{-40,-140},{-20,-120}})));
  BuildingsLite.HeatTransfer.Sources.FixedTemperature T_b3(T=293.15)
    "Room-side temperature"
                       annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
