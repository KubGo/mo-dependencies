...
model InteriorConvection
  ...
  BuildingsLite.HeatTransfer.Windows.BaseClasses.InteriorConvection con(til=
        BuildingsLite.Types.Tilt.Wall, conMod=BuildingsLite.HeatTransfer.Types.InteriorConvection.Temperature,
    A=1)
