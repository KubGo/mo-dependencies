within BuildingsLite.HeatTransfer;
package UsersGuide "User's Guide"
  extends Modelica.Icons.Information;
  annotation (preferredView="info",
  Documentation(info="<html>
The package <code>BuildingsLite.HeatTransfer</code> consists of models
for heat transfer.
...
BuildingsLite.HeatTransfer.Data.Solids</a>)
...
(<a href=\"modelica://BuildingsLite.HeatTransfer.Data.OpaqueConstructions\">
BuildingsLite.HeatTransfer.Data.OpaqueConstructions</a>).
</p>
<p>
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.SingleLayer\">
BuildingsLite.HeatTransfer.Conduction.SingleLayer</a>
...
<p>
The model <a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.SingleLayer\">
BuildingsLite.HeatTransfer.Conduction.SingleLayer</a>
is then used to construct the heat conductor
<a href=\"modelica://BuildingsLite.HeatTransfer.Conduction.MultiLayer\">
BuildingsLite.HeatTransfer.Conduction.MultiLayer</a>
...
<a href=\"modelica://BuildingsLite.HeatTransfer.Convection\">
BuildingsLite.HeatTransfer.Convection</a> are used, which allow
...
<pre>
  BuildingsLite.HeatTransfer.Data.Solids.InsulationBoard insulation(x=0.1, nStaRef=4);
  BuildingsLite.HeatTransfer.Data.Solids.Concrete concrete(x=0.2, nStaRef=4);
</pre>
<p>
...
<pre>
  BuildingsLite.HeatTransfer.Data.Solids.InsulationBoard insulation(c=0, x=0.1, nStaRef=4);
</pre>
<p>
Instead of specifying a material with specific heat capacity and setting <code>c=0</code>,
materials from the library
<a href=\"modelica://BuildingsLite.HeatTransfer.Data.Resistances\">
BuildingsLite.HeatTransfer.Data.Resistances</a> can be used.
For example, for a floor with carpet, the declaration would be
</p>
<pre>
  BuildingsLite.HeatTransfer.Data.Resistances.Carpet carpet;
  BuildingsLite.HeatTransfer.Data.Solids.Concrete    concrete(x=0.2, nStaRef=4);
  BuildingsLite.HeatTransfer.Data.OpaqueConstructions.Generic
...
<pre>
  BuildingsLite.HeatTransfer.Data.Resistances.Carpet carpet(R=0.3);
</pre>
<p>
or
</p>
<pre>
  BuildingsLite.HeatTransfer.Data.Resistances.Generic carpet(R=0.3);
</pre>
<p>
