...
package GlazingSystems
  ...
  //    annotation (Evaluate=true);
    ...
    parameter Gases.Generic gas[:] = {BuildingsLite.HeatTransfer.Data.Gases.Air(x=-1)}
      "Layer by layer declaration of glass layers, starting from outside to room-side"
...
First implementation.
  ...
  record SingleClear3 =
      BuildingsLite.HeatTransfer.Data.GlazingSystems.Generic (
         glass={Glasses.ID102()},
  ...
  record DoubleElectrochromicAir13Clear =
      ...
      final glass={Glasses.Electrochromic(),
                   BuildingsLite.HeatTransfer.Data.Glasses.Generic(
                     x=0.006,
                     k=0.9,
                     tauSol={0.775, 0.775},
...
In <a href=\"modelica://BuildingsLite.HeatTransfer.Data.GlazingSystems.DoubleClearAir13Clear\">
BuildingsLite.HeatTransfer.Data.GlazingSystems.DoubleClearAir13Clear</a>,
