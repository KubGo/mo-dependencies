...
First implementation.
  ...
  record PCM020 =BuildingsLite.HeatTransfer.Data.SolidsPCM.Generic (
      k=0.204,
      d=800,
      c=1341,
      TSol=273.15+23,
...
First implementation.
  ...
  record PCM030 =BuildingsLite.HeatTransfer.Data.SolidsPCM.Generic (
      k=0.232,
      d=998,
      c=1467,
      TSol=273.15+24,
...
First implementation.
  ...
  record MicronalSmartBoard23 =
    BuildingsLite.HeatTransfer.Data.SolidsPCM.Generic (
      k=0.18,
      d=767,
      c=1200,
      TSol=273.15+22.99,
