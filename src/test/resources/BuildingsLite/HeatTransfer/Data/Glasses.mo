within BuildingsLite.HeatTransfer.Data;
...
See
<a href=\"modelica://BuildingsLite.HeatTransfer.Data.Glasses\">
BuildingsLite.HeatTransfer.Data.Glasses</a>
for instructions.
</p>
</html>",
  revisions="<html>
...
First implementation.
  ...
  record ID100 = BuildingsLite.HeatTransfer.Data.Glasses.Generic (
      x=0.0031,
      k=1.0,
      tauSol={0.646},
      rhoSol_a={0.062},
  ...
  record ID101 = BuildingsLite.HeatTransfer.Data.Glasses.Generic (
      x=0.0057,
      k=1.0,
      tauSol={0.486},
      rhoSol_a={0.053},
  ...
  record ID102 = BuildingsLite.HeatTransfer.Data.Glasses.Generic (
      x=0.003,
      k=1.0,
      tauSol={0.834},
      rhoSol_a={0.075},
  ...
  record ID103 = BuildingsLite.HeatTransfer.Data.Glasses.Generic (
      x=0.0057,
      k=1.0,
      tauSol={0.771},
      rhoSol_a={0.070},
  ...
  record Electrochromic = BuildingsLite.HeatTransfer.Data.Glasses.Generic (
      x=0.006,
      k=0.9,
      tauSol={0.814, 0.111},
...
<p>
The example
<a href=\"modelica://BuildingsLite.ThermalZones.Detailed.Examples.ElectroChromicWindow\">
BuildingsLite.ThermalZones.Detailed.Examples.ElectroChromicWindow</a> shows
...
model
<a href=\"modelica://BuildingsLite.HeatTransfer.Windows.BaseClasses.StateInterpolator\">
BuildingsLite.HeatTransfer.Windows.BaseClasses.StateInterpolator</a>.
</p>
</html>",
revisions="<html>
<ul>
