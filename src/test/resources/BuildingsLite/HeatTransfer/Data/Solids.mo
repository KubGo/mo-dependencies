...
package Solids
  ...
  record Generic "Thermal properties of solids with heat storage"
      extends BuildingsLite.HeatTransfer.Data.BaseClasses.Material(final R=x/k,
                                                               final TSol=293.15,
                                                               final TLiq=293.15,
                                                               final LHea=0,
...
First implementation.
  ...
  record Brick = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=0.89,
      d=1920,
      c=790) "Brick (k=0.89)"
    annotation (
  ...
  record Concrete = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=1.4,
      d=2240,
  ...
  record InsulationBoard = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=0.03,
      d=40,
  ...
  record Glass = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=1.0,
      d=2500,
      c=700) "Glass"
    annotation (
  ...
  record GypsumBoard = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=0.16,
      d=800,
  ...
  record Plywood = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=0.12,
      d=540,
  ...
  record Steel = BuildingsLite.HeatTransfer.Data.Solids.Generic (
      k=50.2,
      d=7850,
      c=450,
