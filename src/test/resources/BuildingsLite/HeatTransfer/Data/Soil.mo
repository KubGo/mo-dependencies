...
package Soil
  ...
  record Generic "Thermal properties of solids with heat storage"
      extends BuildingsLite.HeatTransfer.Data.BaseClasses.ThermalProperties;
    annotation (
...
First implementation.
  ...
  record Granite = BuildingsLite.HeatTransfer.Data.Soil.Generic (
      k=1.9,
      d=1920,
      c=790) "Granite (k=1.9)"
    annotation (
  ...
  record Concrete = BuildingsLite.HeatTransfer.Data.Soil.Generic (
      k=3.1,
      d=2000,
  ...
  record Basalt =
      BuildingsLite.HeatTransfer.Data.Soil.Generic (
      k=2.3,
      d=1140,
      c=1200) "Basalt (k=2.3)"
    annotation (
  ...
  record Sandstone = BuildingsLite.HeatTransfer.Data.Soil.Generic (
      k=2.8,
      d=540,
