...
First implementation.
  ...
  record Black=BuildingsLite.HeatTransfer.Data.OpaqueSurfaces.Generic (absIR=1.0,
        absSol=1.0) "Black surface with absIR=1.0, absSol=1.0"
    annotation (
      defaultComponentPrefixes="parameter",
      defaultComponentName="datOpaSur");

  record Gray=BuildingsLite.HeatTransfer.Data.OpaqueSurfaces.Generic (absIR=0.5,
        absSol=0.5) "Gray surface with absIR=0.5, absSol=0.5"
    annotation (
      defaultComponentPrefixes="parameter",
      defaultComponentName="datOpaSur");

  record White=BuildingsLite.HeatTransfer.Data.OpaqueSurfaces.Generic (absIR=0.0,
